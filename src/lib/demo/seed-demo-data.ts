...
const CARD_PAD_Y = 32;
const CARD_PAD_X = 36;
const CARD_STYLE = `font-family: ${FONT_STACK}; font-size: 15px; line-height: 1.55; color: #1f1f1f; max-width: 640px; margin: 0 auto; padding: ${CARD_PAD_Y}px ${CARD_PAD_X}px; background: #ffffff; border: 1px solid #ececec; border-radius: 14px; box-shadow: 0 1px 0 rgba(0,0,0,0.03);`;
...
const BRANDS: Record<string, Brand> = {
  Stripe: {
    ...
    text: "#ffffff",
    accent: "#635bff",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 22px; letter-spacing: -0.02em; color: #ffffff;">stripe</span>`,
    footerNote:
  ...
  Google: {
    ...
    text: "#202124",
    accent: "#1a73e8",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 500; font-size: 22px; letter-spacing: -0.5px;"><span style="color: #4285f4;">G</span><span style="color: #ea4335;">o</span><span style="color: #fbbc05;">o</span><span style="color: #4285f4;">g</span><span style="color: #34a853;">l</span><span style="color: #ea4335;">e</span></span>`,
    footerNote:
  ...
  Calendar: {
    ...
    text: "#ffffff",
    accent: "#1a73e8",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 28px; height: 28px; background: #ffffff; border-radius: 6px; color: #1a73e8; font-weight: 700; font-size: 13px; text-align: center; line-height: 28px; font-family: ${FONT_STACK};">31</span><span style="font-family: ${FONT_STACK}; font-size: 16px; color: #ffffff; font-weight: 500; letter-spacing: -0.2px;">Google Calendar</span></span>`,
    footerNote:
      "Google LLC · 1600 Amphitheatre Parkway, Mountain View, CA 94043",
  },
  GitHub: {
  ...
  LinkedIn: {
    ...
    text: "#ffffff",
    accent: "#0a66c2",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 26px; height: 26px; background: #ffffff; border-radius: 4px; color: #0a66c2; font-weight: 900; font-size: 14px; text-align: center; line-height: 26px; font-family: ${FONT_STACK};">in</span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">LinkedIn</span></span>`,
    footerNote: "LinkedIn Corporation · 1000 W Maude Ave, Sunnyvale, CA 94085",
  },
  YC: {
    primary: "#ff6600",
    text: "#ffffff",
    accent: "#ff6600",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 28px; height: 28px; background: #ffffff; border-radius: 4px; color: #ff6600; font-weight: 700; font-size: 18px; text-align: center; line-height: 28px; font-family: ${FONT_STACK};">Y</span><span style="font-family: ${FONT_STACK}; font-size: 16px; color: #ffffff; font-weight: 600; letter-spacing: -0.3px;">Y Combinator</span></span>`,
  ...
  "Startup School": {
    ...
    text: "#ffffff",
    accent: "#ff6600",
    logo: `<span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">Startup School</span>`,
    footerNote: "Y Combinator · 320 Pioneer Way, Mountain View, CA 94041",
  },
  Vercel: {
    primary: "#000000",
    text: "#ffffff",
    accent: "#000000",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px; color: #ffffff;"><svg width="22" height="20" viewBox="0 0 24 22" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"><path d="M12 1.6L24 21.6H0L12 1.6z"/></svg><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; letter-spacing: -0.4px;">Vercel</span></span>`,
  ...
  Notion: {
    ...
    text: "#000000",
    accent: "#000000",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 28px; height: 28px; background: #ffffff; border: 1px solid #e8e8e8; border-radius: 5px; color: #000000; font-weight: 900; font-size: 18px; text-align: center; line-height: 26px; font-family: 'Georgia', serif;">N</span><span style="font-family: ${FONT_STACK}; font-size: 16px; font-weight: 600; color: #000000; letter-spacing: -0.4px;">Notion</span></span>`,
  ...
  Slack: {
    ...
    text: "#ffffff",
    accent: "#1264a3",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px; color: #ffffff;"><svg width="20" height="20" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><path fill="#36c5f0" d="M22 37.5a5.5 5.5 0 1 1-5.5-5.5H22zm2.75 0a5.5 5.5 0 1 1 11 0v13.75a5.5 5.5 0 1 1-11 0z"/><path fill="#2eb67d" d="M30.25 16a5.5 5.5 0 1 1-5.5-5.5V16zm0 2.75a5.5 5.5 0 1 1 0 11H16.5a5.5 5.5 0 1 1 0-11z"/><path fill="#ecb22e" d="M51.5 24.25a5.5 5.5 0 1 1 5.5 5.5h-5.5zm-2.75 0a5.5 5.5 0 1 1-11 0V10.5a5.5 5.5 0 1 1 11 0z"/><path fill="#e01e5a" d="M38 45.75a5.5 5.5 0 1 1 5.5 5.5V45.75zm0-2.75a5.5 5.5 0 1 1 0-11h13.75a5.5 5.5 0 1 1 0 11z"/></svg><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.4px;">Slack</span></span>`,
    footerNote:
  ...
  Cloudflare: {
    ...
    text: "#404041",
    accent: "#f48120",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><svg width="24" height="14" viewBox="0 0 40 18" xmlns="http://www.w3.org/2000/svg"><path d="M28 17H10A10 10 0 0110 -3a10 10 0 019.5 7H28a3 3 0 010 6h-1.5L26 13h2a8 8 0 000-16h-8.5l-.3-.8A8 8 0 1010 15h17a1 1 0 100-2H17a3 3 0 110-6h11a8 8 0 010 16z" fill="#f48120"/></svg><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #404041; letter-spacing: -0.4px;">Cloudflare</span></span>`,
    footerNote: "Cloudflare, Inc. · 101 Townsend St, San Francisco, CA 94107",
  },
  Datadog: {
    primary: "#632ca6",
    text: "#ffffff",
    accent: "#632ca6",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 26px; height: 26px; background: #ffffff; border-radius: 6px; color: #632ca6; font-weight: 800; font-size: 16px; text-align: center; line-height: 26px; font-family: ${FONT_STACK};">🐶</span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">Datadog</span></span>`,
    footerNote:
  ...
  Sentry: {
    ...
    text: "#ffffff",
    accent: "#7553ff",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><svg width="22" height="20" viewBox="0 0 222 188" fill="#ffffff" xmlns="http://www.w3.org/2000/svg"><path d="M111 12c-7 0-13 4-16 10L70 65c30 16 51 47 51 84h-21c0-29-17-54-43-66L40 137c-2 4-2 9 0 13s7 6 12 6h64c2-25-12-49-34-61l11-19c30 14 49 45 47 80h36c4 0 9-2 11-6s2-9 0-13L127 22c-3-6-9-10-16-10z"/></svg><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">Sentry</span></span>`,
  ...
  PagerDuty: {
    ...
    text: "#ffffff",
    accent: "#06ac38",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 26px; height: 26px; background: #ffffff; border-radius: 6px; color: #06ac38; font-weight: 800; font-size: 15px; text-align: center; line-height: 26px; font-family: ${FONT_STACK};">PD</span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">PagerDuty</span></span>`,
  ...
  Inngest: {
    ...
    text: "#ffffff",
    accent: "#52d9d3",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 22px; height: 22px; background: linear-gradient(135deg, #52d9d3 0%, #b58af6 100%); border-radius: 6px;"></span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">Inngest</span></span>`,
  ...
  Mercury: {
    ...
    text: "#ffffff",
    accent: "#5b9fff",
    logo: `<span style="font-family: 'Georgia', 'Times New Roman', serif; font-size: 22px; font-weight: 400; color: #ffffff; letter-spacing: -0.5px;">Mercury</span>`,
    footerNote:
  ...
  Brex: {
    ...
    text: "#ffffff",
    accent: "#ff9d4c",
    logo: `<span style="font-family: ${FONT_STACK}; font-size: 22px; font-weight: 800; color: #ffffff; letter-spacing: -1px;">Brex</span>`,
  ...
  Plaid: {
    ...
    text: "#ffffff",
    accent: "#000000",
    logo: `<span style="font-family: ${FONT_STACK}; font-size: 22px; font-weight: 700; color: #ffffff; letter-spacing: -0.7px;">Plaid</span>`,
  ...
  Carta: {
    ...
    text: "#ffffff",
    accent: "#26a69a",
    logo: `<span style="font-family: ${FONT_STACK}; font-size: 20px; font-weight: 700; color: #ffffff; letter-spacing: -0.5px;">Carta</span>`,
    footerNote: "Carta · 333 Bush St, Floor 23, San Francisco, CA 94104",
  },
  Pulley: {
    primary: "#2f57e4",
    text: "#ffffff",
    accent: "#2f57e4",
    logo: `<span style="font-family: ${FONT_STACK}; font-size: 20px; font-weight: 700; color: #ffffff; letter-spacing: -0.5px;">Pulley</span>`,
  ...
  AngelList: {
    ...
    text: "#ffffff",
    accent: "#ffffff",
    logo: `<span style="font-family: ${FONT_STACK}; font-size: 20px; font-weight: 700; color: #ffffff; letter-spacing: -0.6px;">AngelList</span>`,
  ...
  Calendly: {
    ...
    text: "#ffffff",
    accent: "#006bff",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 24px; height: 24px; background: #ffffff; border-radius: 50%;"></span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 700; color: #ffffff; letter-spacing: -0.4px;">Calendly</span></span>`,
  ...
  DocuSign: {
    ...
    text: "#000000",
    accent: "#000000",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 18px; color: #000000; letter-spacing: -0.5px;">DocuSign</span>`,
  ...
  Hubspot: {
    ...
    text: "#ffffff",
    accent: "#ff7a59",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">HubSpot</span>`,
  ...
  Mailgun: {
    ...
    text: "#ffffff",
    accent: "#c02c2c",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Mailgun</span>`,
  ...
  Twilio: {
    ...
    text: "#ffffff",
    accent: "#f22f46",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">twilio</span>`,
    footerNote:
  ...
  Anthropic: {
    ...
    text: "#191919",
    accent: "#cb785c",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 22px; height: 22px; background: #cb785c; border-radius: 4px; transform: rotate(45deg);"></span><span style="font-family: 'Georgia', serif; font-size: 18px; font-weight: 400; color: #191919; letter-spacing: -0.4px;">Anthropic</span></span>`,
  ...
  OpenAI: {
    ...
    text: "#ffffff",
    accent: "#10a37f",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 22px; height: 22px; background: #ffffff; border-radius: 50%;"></span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">OpenAI</span></span>`,
  ...
  OpenRouter: {
    ...
    text: "#ffffff",
    accent: "#6c5dd3",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.4px;">OpenRouter</span>`,
  ...
  Substack: {
    ...
    text: "#ffffff",
    accent: "#ff6719",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 22px; height: 22px; background: #ffffff; border-radius: 4px; color: #ff6719; font-weight: 900; font-size: 16px; text-align: center; line-height: 22px; font-family: 'Georgia', serif;">S</span><span style="font-family: 'Georgia', serif; font-size: 18px; font-weight: 600; color: #ffffff; letter-spacing: -0.4px;">Substack</span></span>`,
  ...
  Glassdoor: {
    ...
    text: "#ffffff",
    accent: "#0caa41",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.3px;">Glassdoor</span>`,
  ...
  Lever: {
    ...
    text: "#ffffff",
    accent: "#9b51e0",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Lever</span>`,
  ...
  Greenhouse: {
    ...
    text: "#ffffff",
    accent: "#218d62",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.4px;">Greenhouse</span>`,
  ...
  Gusto: {
    ...
    text: "#ffffff",
    accent: "#f45d48",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">gusto</span>`,
  ...
  "1Password": {
    ...
    text: "#ffffff",
    accent: "#0572ec",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 24px; height: 24px; background: #ffffff; border-radius: 4px; color: #0572ec; font-weight: 900; font-size: 13px; text-align: center; line-height: 24px; font-family: ${FONT_STACK};">1P</span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 600; color: #ffffff; letter-spacing: -0.3px;">1Password</span></span>`,
    footerNote: "1Password · 4711 Yonge St, 10th Floor, Toronto, ON M2N 6K8",
  },
  Okta: {
    primary: "#007dc1",
    text: "#ffffff",
    accent: "#007dc1",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.5px;">okta</span>`,
  ...
  Vanta: {
    ...
    text: "#ffffff",
    accent: "#314CE5",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Vanta</span>`,
  ...
  HackerOne: {
    ...
    text: "#ffffff",
    accent: "#dd4d4d",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 22px; height: 22px; background: #dd4d4d; border-radius: 4px;"></span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 700; color: #ffffff; letter-spacing: -0.4px;">HackerOne</span></span>`,
  ...
  Cobalt: {
    ...
    text: "#ffffff",
    accent: "#06b6d4",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Cobalt</span>`,
  ...
  Pilot: {
    ...
    text: "#ffffff",
    accent: "#ffd600",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Pilot</span>`,
  ...
  Vitally: {
    ...
    text: "#ffffff",
    accent: "#5b3bff",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Vitally</span>`,
  ...
  Delighted: {
    ...
    text: "#ffffff",
    accent: "#ff8866",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="font-size: 22px;">😊</span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 700; color: #ffffff; letter-spacing: -0.3px;">Delighted</span></span>`,
  ...
  USPTO: {
    ...
    text: "#ffffff",
    accent: "#112e51",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 14px; color: #ffffff; letter-spacing: 0.5px;">UNITED STATES PATENT AND TRADEMARK OFFICE</span>`,
  ...
  Squadhelp: {
    ...
    text: "#ffffff",
    accent: "#3aaee0",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Squadhelp</span>`,
  ...
  WeWork: {
    ...
    text: "#ffffff",
    accent: "#000000",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.5px;">WeWork</span>`,
  ...
  Uber: {
    ...
    text: "#ffffff",
    accent: "#000000",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 18px; color: #ffffff; letter-spacing: -0.5px;">Uber</span>`,
    footerNote:
  ...
  "United Airlines": {
    ...
    text: "#ffffff",
    accent: "#0033a0",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 16px; color: #ffffff; letter-spacing: 0.3px;">UNITED</span>`,
  ...
  "The Standard": {
    ...
    text: "#ffffff",
    accent: "#cc0000",
    logo: `<span style="font-family: 'Georgia', serif; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: 0.5px;">THE STANDARD</span>`,
  ...
  "The Batch": {
    ...
    text: "#ffffff",
    accent: "#0a8f5c",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="font-family: 'Georgia', serif; font-style: italic; font-size: 22px; font-weight: 700; color: #ffffff; letter-spacing: -0.4px;">The Batch</span></span>`,
  ...
  "The Information": {
    ...
    text: "#ffffff",
    accent: "#d4af37",
    logo: `<span style="font-family: 'Georgia', 'Times New Roman', serif; font-weight: 400; font-size: 20px; color: #ffffff; letter-spacing: -0.3px;">The Information</span>`,
  ...
  Stratechery: {
    ...
    text: "#ffffff",
    accent: "#ed1c24",
    logo: `<span style="font-family: 'Georgia', 'Times New Roman', serif; font-weight: 400; font-size: 20px; color: #ffffff; letter-spacing: -0.3px;">Stratechery</span>`,
  ...
  "Lenny's Newsletter": {
    ...
    text: "#1a1a1a",
    accent: "#dc2626",
    logo: `<span style="font-family: 'Georgia', serif; font-weight: 700; font-style: italic; font-size: 22px; color: #1a1a1a; letter-spacing: -0.5px;">Lenny's Newsletter</span>`,
  ...
  "First Round Review": {
    ...
    text: "#ffffff",
    accent: "#ed1c24",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.3px;">FIRST ROUND REVIEW</span>`,
  ...
  "Not Boring": {
    ...
    text: "#1a1a1a",
    accent: "#1a1a1a",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 19px; color: #1a1a1a; letter-spacing: -0.6px;">NOT BORING</span>`,
  ...
  "Pragmatic Engineer": {
    ...
    text: "#ffffff",
    accent: "#ee6c4d",
    logo: `<span style="font-family: 'Georgia', serif; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">The Pragmatic Engineer</span>`,
  ...
  TLDR: {
    ...
    text: "#ffffff",
    accent: "#ffd600",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 22px; color: #ffd600; letter-spacing: -0.5px;">TLDR</span>`,
  ...
  "Morning Brew": {
    ...
    text: "#1a1a1a",
    accent: "#0066ff",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="font-size: 22px;">☕</span><span style="font-family: 'Georgia', serif; font-weight: 700; font-style: italic; font-size: 19px; color: #1a1a1a; letter-spacing: -0.4px;">Morning Brew</span></span>`,
  ...
  "Hacker Newsletter": {
    ...
    text: "#ffffff",
    accent: "#ff6600",
    logo: `<span style="font-family: ${MONO_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.2px;">Hacker Newsletter</span>`,
  ...
  "The Hustle": {
    ...
    text: "#ffffff",
    accent: "#febf00",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 900; font-size: 19px; color: #febf00; letter-spacing: -0.5px;">THE HUSTLE</span>`,
  ...
  "Mind the Product": {
    ...
    text: "#ffffff",
    accent: "#e91e63",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.4px;">Mind the Product</span>`,
  ...
  "Backstage Capital": {
    ...
    text: "#ffffff",
    accent: "#1a1a1a",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.3px;">Backstage Capital</span>`,
  ...
  Forbes: {
    ...
    text: "#ffffff",
    accent: "#ed3434",
    logo: `<span style="font-family: 'Times New Roman', serif; font-weight: 900; font-size: 22px; color: #ffffff; letter-spacing: -0.5px;">Forbes</span>`,
  ...
  TechCrunch: {
    ...
    text: "#1a1a1a",
    accent: "#1a1a1a",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 18px; color: #1a1a1a; letter-spacing: -0.5px;">TechCrunch</span>`,
  ...
  "20VC": {
    ...
    text: "#ffffff",
    accent: "#1a1a1a",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 19px; color: #ffffff; letter-spacing: -0.5px;">20VC</span>`,
  ...
  SaaStr: {
    ...
    text: "#ffffff",
    accent: "#fb923c",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 800; font-size: 19px; color: #ffffff; letter-spacing: -0.5px;">SaaStr</span>`,
  ...
  "AI Engineer Summit": {
    ...
    text: "#ffffff",
    accent: "#a78bfa",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.4px;">AI Engineer Summit</span>`,
  ...
  "Product Hunt": {
    ...
    text: "#ffffff",
    accent: "#da552f",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 22px; height: 22px; background: #ffffff; border-radius: 50%; color: #da552f; font-weight: 900; font-size: 13px; text-align: center; line-height: 22px; font-family: ${FONT_STACK};">P</span><span style="font-family: ${FONT_STACK}; font-size: 17px; font-weight: 700; color: #ffffff; letter-spacing: -0.4px;">Product Hunt</span></span>`,
  ...
  GiveDirectly: {
    ...
    text: "#ffffff",
    accent: "#0a3d2a",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.3px;">GiveDirectly</span>`,
  ...
  VectorMail: {
    ...
    text: "#FBF8F1",
    accent: "#1F3A2E",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 26px; height: 26px; background: linear-gradient(135deg, #2c5443 0%, #1F3A2E 100%); border-radius: 6px; color: #FBF8F1; font-weight: 800; font-size: 14px; text-align: center; line-height: 26px; font-family: ${FONT_STACK};">V</span><span style="font-family: ${FONT_STACK}; font-size: 16px; color: #FBF8F1; font-weight: 600; letter-spacing: -0.3px;">VectorMail</span></span>`,
  ...
  "VectorMail Oncall": {
    ...
    text: "#ffffff",
    accent: "#dc2626",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="display: inline-block; width: 10px; height: 10px; background: #dc2626; border-radius: 50%; box-shadow: 0 0 8px #dc2626;"></span><span style="font-family: ${FONT_STACK}; font-size: 17px; color: #ffffff; font-weight: 600; letter-spacing: -0.3px;">VectorMail · Oncall</span></span>`,
  ...
  "VectorMail · Friday Wins": {
    ...
    text: "#FBF8F1",
    accent: "#1F3A2E",
    logo: `<span style="display: inline-flex; align-items: center; gap: 10px;"><span style="font-size: 16px;">🎉</span><span style="font-family: ${FONT_STACK}; font-size: 16px; color: #FBF8F1; font-weight: 600; letter-spacing: -0.3px;">VectorMail · Friday Wins</span></span>`,
    footerNote: "VectorMail · Internal",
  },
  Figma: {
    primary: "#0f0f0f",
  ...
  Clerk: {
    ...
    text: "#ffffff",
    accent: "#6c47ff",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 18px; color: #ffffff; letter-spacing: -0.4px;">Clerk</span>`,
  ...
  "Conference Team": {
    ...
    text: "#ffffff",
    accent: "#0a2540",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 700; font-size: 17px; color: #ffffff; letter-spacing: -0.4px;">ProductCon 2026</span>`,
  ...
  "Vendor Co": {
    ...
    text: "#ffffff",
    accent: "#1f2937",
    logo: `<span style="font-family: ${FONT_STACK}; font-weight: 600; font-size: 16px; color: #ffffff; letter-spacing: -0.3px;">Vendor Co</span>`,
...
function metricGrid(
  ...
  for (let i = 0; i < items.length; i += cols) {
    ...
    for (let j = 0; j < cols; j++) {
      if (items[i + j])
        rows[rows.length - 1]!.push(buildMetricCell(items[i + j]!, cellWidth));
    }
  }
...
function infoCard(
  content: string,
  opts?: { accent?: string; tone?: "info" | "warn" | "ok" | "danger" },
) {
  const accent =
    opts?.accent ??
    (opts?.tone === "warn"
...
function buildDemoThreads(): DemoThread[] {
  ...
  const labelImportant = makeLabel(
    "demo-lbl-important",
    "Important",
    DEMO_LABEL_COLORS.important,
  );
  const labelUpdates = makeLabel(
    "demo-lbl-updates",
    "Updates",
    DEMO_LABEL_COLORS.updates,
  );
  const labelPromotions = makeLabel(
    "demo-lbl-promotions",
    "Promotions",
    DEMO_LABEL_COLORS.promotions,
  );
  ...
  const threadSpecs: Array<{
  ...
  }> = [
    {
      ...
      hour: 9,
      snippet:
        "Founder exploring AI inbox automation. Interested in pilot access and integration details.",
      body: email([
        p("Hi,"),
        p(
        ...
        p(
          "Thanks for building this. The inbox tooling space has needed someone to do it properly for years.",
        ),
        hr(),
        signature(
          "Alex Rivera",
          "Founder & CEO · Founderloop",
          "alex@founderloop.com",
        ),
      ]),
      summary:
        "Founder exploring AI inbox automation and pilot access. Interested in integration details and API. Positive intent; suggest sending architecture overview and scheduling a 30-min call.",
      labels: [labelImportant],
      read: false,
      messageCount: 2,
      replySnippet:
        "Thanks for reaching out. Here's our architecture overview and a link to book a call.",
      replyBody: email([
        replyMeta("Quick intro - AI inbox automation"),
        p("Hi Alex,"),
        p(
          "Thanks for reaching out. We'd love to help you explore VectorMail for your team.",
        ),
        p(
          "Attached is a short architecture overview that covers how we handle AI summaries and search, plus our API for integrations. You can book a 30-min call here: <a href='#' style='color: #1a73e8; text-decoration: underline;'>schedule a call</a> - we'd be happy to walk you through the product and answer any questions about pilot access.",
        ),
        hr(),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Today",
            value: "Profile + company description due Friday, EOD PT",
          },
          {
            label: "This week",
            value: "Office hours sign-ups open at 9 AM PT, Wednesday",
          },
          {
            label: "Week 2",
            value: "First Group office hours · meet your group partner",
          },
        ...
        bullet(
          "YC Startup Library · video archive of every founder talk we've ever recorded.",
        ),
        bullet(
          "Bookface · directory of every YC founder, with experiences searchable by tag.",
        ),
        bullet(
          "Co-Founder Matching · in case you need one. We strongly prefer two-founder teams.",
        ),
        bullet(
          "The Deal · standard YC deal terms, posted publicly so everyone is on equal footing.",
        ),
        ctaRow([
          ctaButton("Complete your profile", { color: "#ff6600" }),
          ctaButton("Office hours signups", {
            color: "#ff6600",
            variant: "outline",
          }),
      ...
      summary:
        "YC onboarding for W24 batch. Action: complete profile and company description by Friday. Neutral, administrative.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Description",
            value: "VectorMail Pro · monthly subscription",
          },
      ...
      summary:
        "Stripe receipt for $99 subscription. No action required unless disputing. Neutral.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      summary:
        "GitHub digest: PR approval, mention in issue, new comment. Review when convenient. Neutral.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      hour: 11,
      snippet:
        "Loving the product. One suggestion: natural language search could show filters.",
      body: email([
        p("Hi team,"),
        p(
        ...
        signature(
          "Jordan Kim",
          "Head of Product · startup.io",
          "jordan@startup.io",
        ),
      ]),
      summary:
        "Positive product feedback. Suggestion: surface applied filters for natural language search. Action: consider UX improvement for filter visibility.",
      labels: [labelImportant],
      read: true,
      messageCount: 2,
      ...
      replyBody: email([
        ...
        p("Hi Jordan,"),
        p(
          'Thanks for the feedback - we really appreciate it. We\'ve added "surface applied filters for natural language search" to our roadmap for next quarter.',
        ),
        p(
          "We'll notify you when it ships so you can try it out. If you have any other ideas, feel free to reply to this thread.",
        ),
        hr(),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Video",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">meet.zoom.us/j/812-44-901</a> · pwd: vmprod`,
          },
          {
            label: "Dial-in",
            value: "+1 (669) 900-6833 · ID 812 44 901 · PIN 9821",
          },
          {
            label: "Organizer",
            value: "Product Team (product@vectormail.app)",
          },
      ...
      summary:
        "Meeting invite: Product sync, Tuesday 2 PM, Zoom. Action: accept or decline.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      hour: 8,
      snippet:
        "This week: frontier models, RAG best practices, and open-source roundup.",
      body: email([
        ...
        listItem({
          title:
            "From the blog · running small models on-device without sacrificing quality",
        ...
        bullet(
          "<strong>'Long-context RAG without the regression cliff'</strong> - Stanford NLP. Provides a recipe to keep retrieval quality stable past 200K tokens.",
        ),
        bullet(
          "<strong>'Speculative decoding for production agents'</strong> - Anthropic. ~2.4× throughput on multi-tool runs, almost no quality loss.",
        ),
        bullet(
          "<strong>'On the limits of synthetic data for instruction tuning'</strong> - DeepMind. Sobering numbers on the cliff after ~30% synthetic mix.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        sectionTitle("Wins"),
        bullet(
          "<strong>Closed Brightlane expansion</strong> (50 → 75 seats, $30K ARR). Their VP Eng called the product 'category-defining' in our renewal call.",
        ),
        bullet(
          "<strong>Shipped Buddy v2.</strong> The new streaming responses + multi-step tool use cut median reply latency from 4.2s to 1.1s.",
        ),
        bullet(
          "<strong>Cobalt pentest complete</strong> with zero criticals and one resolvable medium. SOC 2 Type II audit period starts May 26.",
        ),
        bullet(
          "<strong>Hired Nathan Wu.</strong> Senior backend engineer from Plaid. Starts June 9.",
        ),
        sectionTitle("What we're worried about"),
        bullet(
          "Inbound from larger enterprise prospects (300+ headcount) is outpacing our ability to sell to them - we need a second AE within 6 weeks.",
        ),
        bullet(
          "AI cost trending toward $11K in May vs $7K budget. Investigating whether to switch to a cheaper embedding model.",
        ),
        bullet(
          "Aurinko (our email provider) had two regional outages in February. We're scoping a fallback endpoint.",
        ),
        sectionTitle("Asks (in priority order)"),
        bullet(
          "<strong>2-3 design partner intros in fintech.</strong> We have a workflow tool in beta that fits ops-heavy fintechs. If you know a product or eng lead at a Series B-D fintech who'd take a 30-min look, the warm intro would mean a lot.",
        ),
        bullet(
          "<strong>One senior backend engineer referral.</strong> We're hiring for the second senior eng on the platform team. Anyone you'd vouch for.",
        ),
        bullet(
          "<strong>One go-to-market hire intro.</strong> Looking for our second AE in late Q2 - ideally someone who's sold productivity SaaS into mid-market.",
        ),
        p(
      ...
      summary:
        "Investor update: strong MRR growth. Ask: intros to fintech design partners. Action: reply with intros if available. Positive tone.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Opened by",
            value: "demo@vectormail.app · 2026-05-14 11:42 PT",
          },
          ...
          { label: "Refund method", value: "Original card · Visa •• 4242" },
          {
            ...
            value: "5-7 business days (typically 2-3 for Visa)",
          },
      ...
      summary:
        "Customer support: billing ticket resolved, refund processed. No further action. Neutral/positive closure.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Detect when I'm proposing a time that conflicts with an existing event, and warn me inline.",
        ),
        bullet(
          "Suggest 2-3 open slots that match the other person's working hours (if I'm replying to a known contact).",
        ),
        bullet(
          "Auto-add a meeting block to my calendar when I send a scheduling reply (Calendly is fine but the back-and-forth before booking is what eats my day).",
        ),
        p(
        ...
        signature(
          ...
          "morgan@producthunt.com",
        ),
      ]),
      summary:
        "Feature request: calendar integration for meeting detection and conflict checks. Action: add to roadmap and respond with timeline if planned.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Joint asset.</strong> A 25-minute webinar in early July with one of your customers and one of ours.",
        ),
        bullet(
          "<strong>Timeline.</strong> Sign LOI by end of month, launch the co-marketing motion in mid-June.",
        ),
        sectionTitle("Four next steps (owners + dates)"),
        bullet(
          "<strong>You.</strong> Decide whether the rev-share split is workable for your team. Reply by Friday if possible.",
        ),
        bullet("<strong>Me.</strong> Send the LOI draft Monday."),
        bullet(
          "<strong>Marketing leads (both sides).</strong> Align on the joint webinar topic and date by next Wednesday.",
        ),
        bullet(
          "<strong>Both of us.</strong> Schedule a 30-min follow-up next week to lock the LOI and kick off the webinar working group.",
        ),
        p(
      ...
      summary:
        "Partnership follow-up. Deck attached; action: schedule follow-up for next week. Positive.",
      labels: [labelImportant],
      read: false,
      messageCount: 3,
      ...
      replyBody: email([
        ...
        p("Thanks Casey."),
        p(
          "I'll review the deck and the next steps you outlined. I'll send over some times for a follow-up next week - will aim for Tuesday or Wednesday if that works on your side.",
        ),
        hr(),
        signature("Demo User"),
        emailFooter(),
    ...
    },
    {
      ...
      body: email([
        ...
        p(
          "Here's a recap of your profile activity, post performance, and the most relevant opportunities from your extended network this week.",
        ),
        metricGrid([
        ...
        profileCard({
          name: "Dana Howe",
          title: "Head of Eng · VectorMail",
          initials: "DH",
          accent: "#0a66c2",
          rightLabel: "Your team",
        }),
        profileCard({
          name: "Lina Ortiz",
          title: "Recruiting · Greenhouse",
          initials: "LO",
          accent: "#0a66c2",
          rightLabel: "Recruiter",
        }),
        ...
        bullet(
          "Posts on agentic infra and on-device AI are getting 2-3× normal engagement in your network.",
        ),
        bullet(
          "3 founders you follow posted hiring threads - likely to engage if you comment.",
        ),
        bullet(
          "The 'how we built it' format outperforms 'thought leadership' 4:1 this month.",
        ),
        ctaRow([
          ctaButton("See full digest", { color: "#0a66c2" }),
          ctaButton("Share an update", {
            color: "#0a66c2",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Inbox v3 triage column</strong> - the new sorting model + the brief-card density change. Most likely to need iteration.",
        ),
        bullet(
          "<strong>Buddy chat surface</strong> - final pass on the inline reply UI and the new tool-use indicator.",
        ),
        bullet(
          "<strong>Settings IA</strong> - the rebuilt nav and the consolidated account/security/billing page.",
        ),
        bullet(
          "<strong>Mobile shell</strong> - first proper look at the iOS bottom-tab structure.",
        ),
        sectionTitle("Before the meeting (Monday EOD)"),
        bullet(
          `<strong>Read the doc:</strong> <a href="#" style="color: #1a73e8; text-decoration: none;">Q1 design rationale</a> (8 min read)`,
        ),
        bullet(
          `<strong>Skim the Figma:</strong> <a href="#" style="color: #1a73e8; text-decoration: none;">Q1 - Designs for review</a>. Comments inline are fine.`,
        ),
        bullet(
          "<strong>Drop feedback</strong> in <code>#design-q1</code> or directly in Figma. We'll group it on Tuesday so we spend the meeting on disagreements, not introductions.",
        ),
        ...
        signature(
          "Taylor Reed",
          "Design Lead · VectorMail",
          "taylor@design.io",
        ),
      ]),
      summary:
        "Design review scheduled. Action: add feedback in Figma/Slack before Tuesday 10 AM. Neutral.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Account",
            value: "company.com · Pro plan · 18 months tenure",
          },
          { label: "API key", value: "vmk_prod_••••••••H9wX" },
          { label: "Current limit", value: "100 req/min · 5,000 req/day" },
          {
            label: "Requested limit",
            value: "1,500 req/min · 100,000 req/day",
          },
          {
            label: "Window needed",
            value: "May 18 (launch day) → permanent if usage stays",
          },
          {
            label: "Ticket",
            value: "#9912 (filed 4 hours ago, no response yet)",
          },
        ]),
        ...
        bullet(
          "Tried the in-app 'request limit increase' flow - got 'we'll review within 3 business days.'",
        ),
        ...
        p(
          "Thanks in advance - we love what you've built and want tomorrow to work.",
        ),
        hr(),
        signature(
          "DevOps Team",
      ...
      summary:
        "Urgent request: API rate limit increase needed by EOD for launch. Action: process ticket #9912. Urgent.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        p(
          "Thanks for signing up. VectorMail helps you get to inbox zero with AI-powered summaries, smart search, and a cleaner workflow - all in one place.",
        ),
        sectionTitle("Get started in 3 steps"),
        bullet(
          "Connect your Gmail - We use secure OAuth. We never store your password.",
        ),
        bullet(
          "Let us sync - We'll index your threads and generate summaries. This usually takes a few minutes.",
        ),
        bullet(
          "Explore your inbox - Use the sidebar to filter by label, search with natural language, and skim threads via AI summaries.",
        ),
        sectionTitle("What you can do with VectorMail"),
        p(
          "Summaries: Every thread gets a short summary, action items, and sentiment so you can triage quickly. Search: Find emails by meaning, not just keywords. Nudges: We'll surface threads that might need a reply. Scheduled sends and more are available on Pro.",
        ),
        p(
          "Need help? Reply to this email, check our help center, or join our community. We're here to make your inbox work for you.",
        ),
        ...
        companyEmailFooter("VectorMail", {
          address: "VectorMail · Reply to hello@vectormail.app for support.",
        }),
      ]),
      summary:
        "Onboarding email. No action required beyond connecting Gmail. Positive, informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Plan:</strong> Team · 25 seats to start (we may add 5-10 more in Q3 depending on hiring)",
        ),
        bullet("<strong>Term:</strong> 12 months, annual billing"),
        bullet("<strong>Start date:</strong> Tuesday next week, May 26"),
        bullet(
          "<strong>Payment:</strong> ACH preferred (Net-30 if possible, otherwise upfront is fine)",
        ),
        p(
        ...
        p(
          "Thanks for making this easy. Excited to get the rest of the team onto it.",
        ),
        hr(),
        signature(
          "Riley Adams",
          "Chief of Staff · startup.co",
          "riley@startup.co",
        ),
      ]),
      summary:
        "Prospect moving forward. Action: send contract template for Team plan. Positive.",
      labels: [labelImportant],
      read: true,
      messageCount: 2,
      replySnippet:
        "Contract template attached. Let me know if you have questions.",
      replyBody: email([
        replyMeta("Re: Pricing question"),
        p("Hi Riley,"),
        p(
          "Contract template attached. It includes the standard terms we discussed - the Team plan pricing, seat count, and the 12-month commitment.",
        ),
        p(
          "Let me know if you have any questions or if you'd like to hop on a quick call to walk through anything before you sign.",
        ),
        hr(),
        signature("Demo User"),
        emailFooter(),
    ...
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("Don't recognize this", {
            color: "#dc2626",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Google security notification. Verify if sign-in was user; if not, secure account. Slightly urgent if unexpected.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        logRow(
          "0:00 - 0:10",
          "Retro outcomes - top 3 action items from last sprint, status check",
          { tone: "info" },
        ),
        logRow(
          "0:10 - 0:25",
          "Capacity + time-off - update the doc with your availability",
          { tone: "info" },
        ),
        logRow(
          "0:25 - 0:55",
          "Sprint goals + backlog - prioritization, commitment for the next two weeks",
          { tone: "info" },
        ),
        logRow(
          "0:55 - 1:00",
          "Risks + closing - what could derail this sprint",
          { tone: "warn" },
        ),
        sectionTitle("Carrying into this sprint (3 items)"),
        bullet(
          "VM-118 · Outlook beta polish - 60% complete, Nathan continuing",
        ),
        bullet(
          "VM-167 · Scheduled-send dashboard - blocked on design, unblocking Tuesday",
        ),
        bullet(
          "VM-174 · Aurinko fallback endpoint switching - needs estimation",
        ),
        sectionTitle("New for triage (you'll see these in the planning doc)"),
        bullet(
          "VM-208 · pgvector migration · final cutover plan (Marcus, big rock)",
        ),
        bullet(
          "VM-211 · Inbox v3 triage column · post-design (engineering for two)",
        ),
        bullet("VM-214 · Buddy v2.1 · streaming tool-use indicator"),
        bullet(
          "VM-219 · SOC 2 evidence collection automation (carryover from Vanta)",
        ),
        p(
        ...
        signature(
          "Engineering",
          "Sprint planning · vectormail-ai",
          "eng@company.com",
        ),
      ]),
      summary:
        "Sprint planning agenda. Action: add availability to doc by Wednesday. Neutral.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Recording",
            value: "Yes · published to YouTube ~3 weeks after",
          },
          {
            label: "Expected audience",
            value: "~900 in-person, ~6,000 livestream",
          },
          { label: "Honorarium", value: "$2,500 + travel & lodging covered" },
        ]),
        sectionTitle("Next steps · confirm by Friday"),
        bullet(
          "Reply to this email confirming your participation (or decline) by EOD Friday.",
        ),
        bullet(
          "Within 7 days of confirming, we'll send: the speaker kit, slide template, A/V tech check link, and your green-room schedule.",
        ),
        bullet(
          "Travel and lodging logistics open 30 days out. We use the conference travel desk - they'll handle flights, hotel, and ground transport.",
        ),
        bullet(
          "If you need accommodations (dietary, accessibility, childcare on site), please let us know in your confirmation reply so we can coordinate.",
        ),
      ...
      summary:
        "Proposal accepted. Action: confirm by Friday to receive speaker details. Positive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Billed to",
            value: "VectorMail HQ · 535 Mission St, San Francisco, CA 94105",
          },
          {
            label: "Billed from",
            value: "Vendor Co · 1280 Battery St #200, San Francisco, CA 94111",
          },
        ...
        keyValBlock([
          {
            label: "Platform integration (consulting) · 40 hrs @ $60/hr",
            value: "$2,400.00",
          },
        ...
        bullet(
          "<strong>ACH</strong> - preferred. Routing 122000247 · Account 9012345678 · Reference 'INV-2044'.",
        ),
        bullet(
          "<strong>Wire</strong> - same routing/account; please bear all wire fees on your side.",
        ),
        bullet(
          "<strong>Card</strong> - through the payment portal (2.9% processing fee applied).",
        ),
        ctaRow([
          ctaButton("Pay invoice", { color: "#1f2937" }),
          ctaButton("Download PDF", { color: "#1f2937", variant: "outline" }),
          ctaButton("Dispute or adjust", {
            color: "#1f2937",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Invoice received. Action: pay within 14 days or delegate. Neutral.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        p(
          "Reply when you get a sec. No pressure if this week is too packed - we can shoot for next.",
        ),
        hr(),
        signature("Jamie"),
      ]),
      summary:
        "Informal lunch invite. Action: reply with availability. Positive, low urgency.",
      labels: [],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Rate limits</strong> - added per-endpoint limits in a table; before they were only in prose.",
        ),
        ...
        bullet(
          "Mobile rendering doesn't break the sidebar anymore (sorry - known issue for 6 months).",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Add inline comment", {
            color: "#1a73e8",
            variant: "outline",
          }),
          ctaButton("File a docs issue", {
            color: "#1a73e8",
            variant: "outline",
          }),
        ]),
        ...
        signature(
          "Dev Rel",
          "Developer Relations · VectorMail",
          "devrel@company.com",
        ),
      ]),
      summary:
        "Docs update. Action: review API reference and send feedback by EOW. Neutral.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        p(
          "This is your 24-hour reminder for tomorrow's monthly all-hands. Dana is hosting; agenda + the recording link below.",
        ),
        sectionTitle("Where"),
        keyValBlock([
          {
            label: "Video",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">meet.google.com/vmh-allhands</a>`,
          },
        ...
        sectionTitle("Agenda · 60 minutes"),
        logRow("10:00 - 10:05", "Open + safety message · Dana", {
          tone: "info",
        }),
        logRow(
          "10:05 - 10:20",
          "Quarter so far · CEO + CFO · KPIs and how we're tracking",
          { tone: "info" },
        ),
        logRow(
          "10:20 - 10:35",
          "Product demo: Buddy v2 streaming · Marcus + Elena",
          { tone: "info" },
        ),
        logRow(
          "10:35 - 10:45",
          "Customer story of the month: Brightlane (recorded) · Aria",
          { tone: "info" },
        ),
        logRow(
          "10:45 - 11:00",
          "Q&A - submit questions in Slido (link in #all-hands)",
          { tone: "info" },
        ),
        sectionTitle("Pre-read"),
        bullet(
          "Slide deck will be posted in <code>#all-hands</code> by 9:00 AM PT tomorrow.",
        ),
        bullet(
          "Submit Q&A questions anonymously through the Slido link (open now).",
        ),
        bullet("Join 2-3 min early to test mic + camera if you'll speak."),
        ctaRow([
          ctaButton("Join Meet", { color: "#1a73e8" }),
          ctaButton("Add Q&A in advance", {
            color: "#1a73e8",
            variant: "outline",
          }),
          ctaButton("Open agenda doc", {
            color: "#1a73e8",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Calendar reminder for team all-hands. No action beyond attending. Neutral.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        headline(
          "Brightlane MSA · review complete · two minor comments before signing",
        ),
        p(
        ...
        bullet(
          "Auto-renewal language is mutual and gives both sides 60 days' notice · ✓",
        ),
        bullet(
          "Service credits and SLA escalation language is on our paper, unchanged · ✓",
        ),
        bullet(
          "Insurance requirements ($2M cyber, $1M E&O) match our policy · ✓",
        ),
      ...
      summary:
        "Legal review complete. Action: address comments in sections 4.2 and 7.1 before signing. Neutral.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          { label: "Amount", value: "$99.00 USD" },
          {
            ...
            value: "Visa •• 4242 (valid until 08/27)",
          },
      ...
      summary:
        "Billing status: account in good standing. No action required. Informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      hour: 14,
      snippet:
        "Updated term sheet attached. Three open items - need your call by Wednesday.",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          ...
          { label: "Post-money", value: "$90M" },
          {
            ...
            value: "12% post-money (pre-issuance)",
          },
          { label: "Lead", value: "Horizon Capital ($12M)" },
          {
            label: "Participation",
            value: "Forerunner, Index, Foundry (~$6M total)",
          },
        ...
        signature(
          ...
          "claire@horizoncap.vc",
        ),
      ]),
      summary:
        "Lead investor sent updated Series A term sheet. Action: respond on 3 open items by Wednesday. Time-sensitive.",
      labels: [labelImportant],
      read: false,
      messageCount: 2,
      ...
      replyBody: email([
        ...
        p("Hi Claire,"),
        p(
          "Reading tonight - will send redlines back by tomorrow EOD. Aligned on pro-rata and board structure. Liquidation is where I'll have the most marked up.",
        ),
        p("Talk soon."),
        hr(),
        signature("Demo User"),
    ...
    },
    {
      ...
      hour: 11,
      snippet:
        "Sharing the agenda + pre-read for the April board meeting. Two decisions need your sign-off.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "Tab 1: <strong>Financials</strong> - Q1 vs plan, burn, runway, and the updated bottoms-up model for the rest of 2026.",
        ),
        bullet(
          "Tab 2: <strong>KPIs</strong> - ARR, NRR by cohort, activation, retention curves (your strongest chart this quarter).",
        ),
        bullet(
          "Tab 3: <strong>GTM</strong> - outbound experiment results, top-of-funnel attribution, and the case for doubling the BDR team.",
        ),
        bullet(
          "Tab 4: <strong>Hiring</strong> - proposed plan to ship through Q3 (8 new heads, leveled and budgeted).",
        ),
        bullet(
          "Tab 5: <strong>Pricing</strong> - proposed self-serve reset with cohort impact modeling and the rollout plan.",
        ),
        ...
        signature(
          "Owen Falk",
          "Board observer · Index Ventures",
          "owen@indexvc.com",
        ),
      ]),
      summary:
        "Board prep for April meeting. Action: review pre-read + sign off on hiring plan and pricing reset. Time-sensitive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 9,
      snippet:
        "Loved the March update - one question on NRR and a quick intro to our portfolio.",
      body: email([
        p("Hi,"),
        p(
        ...
        signature(
          ...
          "hana@forerunnervc.com",
        ),
      ]),
      summary:
        "Existing investor reviewing March update. Action: clarify NRR composition + decide on intro to Mosaic Health. Positive tone.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 3,
      snippet:
        "Bryan Goldstein has signed the $25,000 SAFE. Closing documents attached.",
      body: email([
        ...
        profileCard({
          ...
          company:
            "ex-Stripe (early product) · 47 prior investments on AngelList",
          initials: "BG",
          accent: "#0e0e10",
          rightLabel: "Signed",
        }),
        ...
        keyValBlock([
          {
            label: "Investor",
            value: "Bryan Goldstein · individual capacity (no entity)",
          },
          ...
          {
            label: "Funds arrival",
            value: "3-5 business days · expected by May 19 latest",
          },
        ]),
        sectionTitle("What was filed"),
        bullet(
          "SAFE document · countersigned and stored in your AngelList vault",
        ),
        bullet(
          "Cap table updated automatically in Carta within 24 hours of funds receipt",
        ),
        bullet(
          "Form D filing initiated · auto-files to SEC by deadline (15 days from first sale)",
        ),
        bullet("Bryan added to your investor communications list"),
        sectionTitle("Heads up"),
        bullet(
          "Bryan is a high-signal angel - 47 prior investments, ~10% returned 10x+. Worth a personal thank-you note from you within the week.",
        ),
        bullet(
          "He's been quietly evangelizing the company on Twitter; might be worth amplifying his next post",
        ),
        ctaRow([
          ctaButton("View signed SAFE", { color: "#0e0e10" }),
          ctaButton("Send thank-you note", {
            color: "#0e0e10",
            variant: "outline",
          }),
        ]),
        fineprint(
          "AngelList · 410 Townsend St, San Francisco, CA 94107 · We facilitate SAFE financings through our trustee structure. Funds settle T+3 via ACH after countersigning.",
        ),
        companyEmailFooter("AngelList"),
      ]),
      summary:
        "AngelList: angel SAFE signed. No action required - funds in transit. Positive.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      hour: 16,
      snippet:
        "Looking at the deck. Could you share L4 retention curves by cohort?",
      body: email([
        p("Hi,"),
        p(
      ...
      summary:
        "VC due diligence: requesting L4 retention curves by cohort. Action: share data (NDA optional). Time-sensitive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          { label: "Method", value: "Option pricing method (OPM) · backsolve" },
          {
            ...
            value: "Carta Valuations LLC (independent)",
          },
          ...
          {
            label: "Valid until",
            value: "May 12, 2027 (or next material event)",
          },
        ]),
        ...
        ctaRow([
          ...
          ctaButton("Issue a new grant", {
            color: "#0a2540",
            variant: "outline",
          }),
          ctaButton("Schedule call with Carta", {
            color: "#0a2540",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Carta: 409A complete. New strike $0.43. No action unless you want to grant new options. Informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      daysAgo: 7,
      snippet:
        "Q1 LP distribution notice attached. Wire instructions confirmed.",
      body: email([
        p("Dear LPs,"),
        p(
        ...
        keyValBlock([
          ...
          { label: "Total distribution", value: "$1,400,000 USD" },
          {
            ...
            value: "Calculated based on commitment %",
          },
          { label: "Wire date", value: "Wednesday, April 15, 2026" },
          {
            label: "Settlement (typical)",
            value: "1-2 business days domestic, 3-5 international",
          },
          {
            label: "Quarter to date",
            value: "$1.4M (this is the only Q1 distribution)",
          },
        ]),
        ...
        bullet(
          "This is a return of capital (RoC) followed by partial gain - your K-1 will reflect both portions separately.",
        ),
        bullet(
          "Q1 K-1 estimates will be sent in early May; finals after fund audit completion (typically September).",
        ),
        bullet(
          "Consult your tax advisor for treatment in your specific entity.",
        ),
        ctaRow([
          ctaButton("Update wire instructions", { color: "#1f2937" }),
          ctaButton("Download wire form", {
            color: "#1f2937",
            variant: "outline",
          }),
          ctaButton("Email LP relations", {
            color: "#1f2937",
            variant: "outline",
          }),
        ]),
        ...
        signature(
          "Foundry Operations",
          "LP Relations · Foundry Capital",
          "ops@foundrycap.com",
        ),
      ]),
      summary:
        "LP distribution notice for Q1. Action: confirm wire instructions if changed in last 90 days. Time-sensitive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 9,
      snippet:
        "Following up on the bridge round conversation - we're in for $500K.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "SAFE doc - we'll use the latest YC template or yours, your call. Either is fine.",
        ),
        bullet(
          "Wire instructions - we'll pre-fund within 5 business days of signature.",
        ),
        bullet(
          "Confirm cap-table impact with Claire/Horizon so there are no surprises at Series A close.",
        ),
      ...
      summary:
        "Existing investor committing $500K to bridge round at Series A terms. Action: send SAFE doc. Positive close.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 10,
      snippet:
        "We're a 400-person engineering org. Curious if you have an enterprise tier with SSO + DLP.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "Net-60 payment terms (we can move to Net-30 if there's a discount).",
        ),
        bullet(
          "Our standard MSA template attached; happy to redline yours instead.",
        ),
        bullet(
          "Vendor security questionnaire is in the SecurityScorecard portal - we can send the link.",
        ),
        p(
        ...
        signature(
          "Drew Hwang",
          "Director of IT, Productivity Tools · Northwind Corp",
          "drew@northwindcorp.com",
        ),
      ]),
      summary:
        "Enterprise prospect (400 ppl). Asks: Okta SSO + DLP/CMK. Action: confirm both supported, scope paid POC for Q2. High-value lead.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Target seats from Jun 1",
            value: "75 (+25, 50% expansion)",
          },
          { label: "Term", value: "12 months, prepaid annual" },
          {
            label: "Volume discount",
            value: "Asking for a 10% break for hitting 75+ seats",
          },
        ...
        bullet(
          "<strong>Pricing lock</strong> for the next 12 months (no mid-year re-rating).",
        ),
        bullet(
          "<strong>Customer story</strong> participation: happy to be the public case study you've been asking about. I've got data on time saved + customer NPS gain.",
        ),
        bullet(
          "<strong>Reference call</strong> for one or two prospects per quarter, scheduled through me.",
        ),
        p(
        ...
        p(
          "Thanks for the great support over the last year. Excited to scale this up.",
        ),
        hr(),
        signature(
          "Sophia Pereira",
          "VP Engineering · Brightlane",
          "sophia@brightlane.io",
        ),
      ]),
      summary:
        "Renewal + 25-seat expansion (Brightlane). Action: send quote and confirm 12-mo price lock. Positive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Do you offer non-profit pricing?</strong> We've seen a lot of vendors offer 50-80% off for 501(c)(3) orgs and it makes the difference between us being able to fund a tool versus not.",
        ),
        bullet(
          "<strong>Seats:</strong> 12 to start. We may go up to 18 if our summer fellowship program runs as planned, but that's a Q3 question.",
        ),
        bullet(
          "<strong>Plan:</strong> Whatever your Team plan equivalent is would be enough - we don't need Enterprise features.",
        ),
        ...
        signature(
          "Felix Romero",
          "Executive Director · Code For Good (501(c)(3))",
          "felix@codeforgood.org",
        ),
      ]),
      summary:
        "Non-profit inquiry (12 seats). Action: confirm non-profit pricing tier and reply with quote. Small but warm lead.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Option A · Save call (recommended):</strong> I reach out to Jules directly today, offer a 20-min reset call + free training session for the new ops lead. Soft, helpful, no pressure.",
        ),
        bullet(
          "<strong>Option B · Check-in email only:</strong> Default playbook. Probably misses the timing.",
        ),
        bullet(
          "<strong>Option C · Wait and see:</strong> Auto-renewal might just go through. Risk: it doesn't, and we lose $24K without trying.",
        ),
        sectionTitle("What I need from you"),
        p(
        ...
        signature(
          "Aria Lawson",
          "Customer Success Lead · VectorMail",
          "aria@vectormail.app",
        ),
      ]),
      summary:
        "Internal alert: Loop AI churn risk, $24K ARR. Action: decide on save call within 3 weeks. Time-sensitive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 5,
      snippet:
        "Hit the API ceiling on the Team plan twice this week. Want to discuss usage-based pricing.",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          ...
          {
            label: "Current sustained traffic",
            value: "~85 req/min, peaks to 180",
          },
          {
            label: "Times we hit 429 this week",
            value: "2 (Tue 2:48 PM, Thu 11:32 AM)",
          },
          {
            label: "Customer-facing impact",
            value: "Yes - 12-minute degraded mode each time",
          },
        ]),
        ...
        bullet(
          "<strong>Commit to a monthly minimum</strong> (let's say $500/mo or 50K requests, whichever is more).",
        ),
        bullet(
          "<strong>Overage pricing</strong> for anything above commit at a clearly-priced per-request rate.",
        ),
        bullet(
          "<strong>No seat-rate change</strong> - we're happy with our current Team plan otherwise.",
        ),
        bullet(
      ...
      summary:
        "Customer wants usage-based API pricing instead of full Enterprise upgrade. Action: propose hybrid plan + share rate card.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 2,
      snippet:
        "A user scored 9/10 and left a comment: 'Briefs save me 2 hours a day.'",
      body: email([
        ...
        keyValBlock([
          {
            label: "Respondent",
            value: "Customer #c-2841 (Brightlane · 75 seats)",
          },
        ...
        bullet(
          "<strong>Case study candidate.</strong> Customer has health = green, NPS = 9, and 9 months of tenure. Strong candidate for the public case study Aria's been working on.",
        ),
        bullet(
          `<strong>Mobile waitlist priority.</strong> Add this user to the iOS beta when it goes out - they'll be a great early tester.`,
        ),
        bullet(
          "<strong>Reference call material.</strong> Add this verbatim to the sales reference deck (with permission).",
        ),
        ctaRow([
          ctaButton("View response in Delighted", { color: "#ff8866" }),
          ctaButton("Mark for case study", {
            color: "#ff8866",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "9/10 NPS with positive qualitative comment. Mention of mobile app gap. Informational - consider for case study.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      hour: 19,
      snippet:
        "Trial expires Friday. Two of our PMs love it - what does pricing look like for 8 seats?",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          {
            label: "Company",
            value: "Castleworks · workflow software for trades · 22 employees",
          },
          { label: "Trial seats used", value: "2 of 5 (PMs)" },
          { label: "Trial ends", value: "Friday, May 22, 2026" },
          {
            label: "Desired plan",
            value: "8 seats (2 PMs + 4 ops + 2 me/exec)",
          },
          {
            label: "Term preference",
            value: "Annual, prepaid (if it gets a better rate)",
          },
          {
            label: "Decision-maker on price",
            value: "Me · CFO needs SOC 2 confirmation before signing",
          },
        ]),
        ...
        signature(
          "Theo Vargas",
          "Head of Operations · Castleworks",
          "theo@castleworks.co",
        ),
      ]),
      summary:
        "Trial converting (Castleworks, 8 seats). Action: send annual pricing + confirm SOC 2 status. Hot lead.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 6,
      snippet:
        "Does VectorMail push thread summaries into Slack? We want to wire it into our team channel.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "<strong>Native Slack integration</strong> ideally - bot user, OAuth, channel selector, the works.",
        ),
        bullet(
          "<strong>Or a webhook</strong> - we have engineering bandwidth to wire it up if you publish a stable webhook API.",
        ),
        bullet(
          "<strong>Configurable schedule and channels</strong> per inbox (different briefs to different channels).",
        ),
        bullet(
          "<strong>Threading</strong> - when someone clicks the link in Slack, it should open the actual thread in VectorMail (not just a summary view).",
        ),
        ...
        signature(
          "Mei Lin",
          "Head of Operations · Haystack Studio",
          "mei@haystack.studio",
        ),
      ]),
      summary:
        "Integration ask: Slack push for daily briefs. Action: confirm webhook support or scope native integration.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "New ops lead onboarded after Aria's save call (Mar 24) - DAU jumped within 4 days.",
        ),
        bullet(
          "Buddy v2 streaming responses adopted by their sales team - 18 new active users.",
        ),
        bullet(
          "Slack integration shipped - surfaces briefs in their team channels, which drives daily engagement.",
        ),
        sectionTitle("Risk indicators (still watch)"),
        bullet(
          "One power user dropped from daily to weekly · investigate before renewal.",
        ),
        bullet(
          "Account has not yet adopted the search feature heavily - opportunity to nudge.",
        ),
        ctaRow([
          ctaButton("View account in Vitally", { color: "#5b3bff" }),
          ctaButton("Owner: Aria Lawson", {
            color: "#5b3bff",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Health score calculation: usage frequency (40%) + feature breadth (30%) + sentiment signals (20%) + commercial signals (10%).",
        ),
        companyEmailFooter("Vitally"),
      ]),
      summary:
        "Vitally: Loop AI health score green. No immediate action. Positive signal.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      daysAgo: 8,
      snippet:
        "Looking for a real AI inbox - not just shortcuts. Can we see Buddy live?",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          {
            label: "Company",
            value: "Northglade · early-stage SaaS, ARR ~$1.2M, growing 30% MoM",
          },
          ...
          { label: "Annual spend on Superhuman", value: "~$2,400" },
          {
            ...
            value: "I personally make the call on tools at this size",
          },
        ]),
        sectionTitle("Three things we want to see in the demo"),
        bullet(
          "<strong>Buddy live.</strong> Drafting a reply to a real-looking thread, end-to-end, with you narrating the failure modes you've designed around.",
        ),
        bullet(
          "<strong>Daily brief.</strong> A real brief on a busy inbox so we can see if it surfaces what we'd actually care about.",
        ),
        bullet(
          "<strong>Semantic search.</strong> A query like 'investor threads from last week mentioning the term sheet' - does it actually work?",
        ),
        ...
        signature(
          "Carter Liu",
          "Founder & CEO · Northglade",
          "carter@northglade.com",
        ),
      ]),
      summary:
        "Superhuman customer evaluating switch. Action: book live Buddy demo this week. Warm lead, fast-moving.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 12,
      snippet:
        "Nathan passed the systems round 4/4. References are exceptional. Ready to send offer?",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          {
            label: "Coding (Marcus)",
            value:
              "Strong Yes · 'clean, fast, picked up our codebase model in 20 min'",
          },
          {
            label: "Systems design (Dana)",
            value:
              "Strong Yes · 'best design conversation we've had in 6 months'",
          },
          {
            label: "Product sense (you)",
            value: "Hire · 'great judgment, asks the right questions'",
          },
          {
            label: "Culture (Aria)",
            value: "Strong Yes · 'low-ego, high-trust'",
          },
        ...
        bullet(
          "He's been honest the entire process - wants to be at VectorMail if comp lands close",
        ),
        ...
        signature(
          "Lina Ortiz",
          "Senior Recruiting Partner · Greenhouse Talent",
          "lina@greenhouseteam.com",
        ),
      ]),
      summary:
        "Recruiter recommending offer for Nathan Wu (senior eng). Competing offer; decide by Friday. Action: approve offer + level.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        p(
          "Wishing you and the team the best - really excited to watch what you build.",
        ),
        hr(),
        signature("Priscilla Adams"),
      ]),
      summary:
        "Candidate withdrew from process. Action: close loop in ATS, send brief thanks. Routine.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      hour: 9,
      snippet:
        "Accepted! Excited to start May 5. Forwarding the signed letter.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          'Laptop preference: 16" MacBook Pro M3, 64GB RAM (I do a lot of model work locally).',
        ),
        bullet(
          "Address for shipping: changing it on May 1 - I'll send the updated one then.",
        ),
        bullet(
          "Office days: happy to commit to 3 days/week in person from week 1. SF based.",
        ),
        bullet(
          "Background check: already in motion via Checkr - you should see results by next Tuesday.",
        ),
      ...
      summary:
        "Candidate accepted offer, starts May 5. Action: kick off onboarding (laptop, accounts). Positive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 3,
      snippet:
        "Strong PM friend leaving Anthropic. Wants to do AI infra. Worth a chat?",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "<strong>Currently:</strong> Staff PM at Anthropic. Led the API platform from $0 → 9-figure annualized in 22 months.",
        ),
        bullet(
          "<strong>Before that:</strong> Product at Stripe (Connect platform), early at Brex, undergrad CS at MIT.",
        ),
        bullet(
          "<strong>What she wants next:</strong> Something small, AI-native, where she can shape product from the ground up. Not 'AI feature in an existing product' - full AI-native product surface.",
        ),
        bullet(
          "<strong>Why she's leaving:</strong> Anthropic grew past her comfort zone (~50 people when she joined, now 1000+). She wants the early stage again.",
        ),
        ...
        signature(
          "Jamal Ortiz",
          "Engineering · ex-Anthropic",
          "jamal.ortiz@anthropic-friend.io",
        ),
      ]),
      summary:
        "Warm intro to Staff PM (ex-Anthropic). Action: reply yes/no, request intro CC. Strong inbound.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      summary:
        "Lever weekly digest: 3 new applicants for backend role. Action: review referrals first.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        bullet(
          `What did Jasmine work on under you? What was the highest-leverage thing she did?`,
        ),
        bullet(
          `What would she be exceptional at? What would she struggle with?`,
        ),
        bullet(`How does she handle ambiguity, conflict, and pressure?`),
        bullet(
          `If you were starting a company tomorrow, would you hire her as your first PM? Why or why not?`,
        ),
        bullet(
          `Anything I haven't asked that would help me understand her better?`,
        ),
        p(
        ...
        signature(
          "Quinn Holloway",
          "Recruiting Lead · NextRoom",
          "quinn@nextroom.ai",
        ),
      ]),
      summary:
        "Reference check for Jasmine Park. Action: book a 15-min call this week.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Coding interview (Marcus)",
            value: "✓ Submitted · Strong Yes",
          },
          { label: "Systems design (Dana)", value: "✓ Submitted · Hire" },
          { label: "Behavioral (you)", value: "⚠ Outstanding - overdue" },
          {
            label: "Hiring-manager loop (Aria)",
            value: "✓ Submitted · Strong Yes",
          },
          {
            label: "Debrief",
            value: "Friday, 10:00 AM PT - needs all 4 in by Thursday EOD",
          },
        ]),
        sectionTitle("What we need from you"),
        bullet("Open the scorecard in Greenhouse (link below)."),
        bullet(
          "Submit a written assessment in 5-10 minutes - doesn't need to be exhaustive, but does need to be specific.",
        ),
        bullet(
          "Pick: Strong Yes / Yes / No / Strong No · with one-sentence rationale per dimension.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Open candidate in Greenhouse", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Greenhouse req-2414 · Owner: Lina Ortiz · This is your second auto-reminder; further reminders will escalate to Dana.",
        ),
        companyEmailFooter("VectorMail Recruiting"),
      ]),
      summary:
        "Internal: scorecard overdue for Carter Liu. Action: submit today. Internal.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 10,
      snippet:
        "Auth refactor at 60%. Sentry alert noise reduced 40%. Two PRs need review.",
      body: email([
        ...
        bullet(
          "<strong>#412</strong> · feat(search): pgvector index switch on warm path · Marcus · 14 files, +228/-68 · CI green · ETA: 30 min review",
        ),
        bullet(
          "<strong>#418</strong> · feat(api): per-user-key rate limiter (closes VM-187) · Nathan · 6 files, +89/-12 · CI green · ETA: 15 min review",
        ),
        sectionTitle("Tomorrow's plan"),
        bullet(
          "Marcus runs the pgvector RFC review (1 hour, blocked time on calendar).",
        ),
        bullet(
          "Sprint 11 planning kicks off Thursday - make sure your availability is in the doc.",
        ),
        bullet("Aria + Marcus on the DataPipe escalation call at 10 AM."),
        hr(),
        signature(
          "Engineering Bot",
          "Daily standup auto-digest · #eng-standup",
        ),
      ]),
    ...
    },
    {
      ...
      daysAgo: 3,
      snippet:
        "Draft RFC for migrating from Pinecone to pgvector. Comments by Friday.",
      body: email([
        p("Hi team,"),
        p(
        ...
        bullet(
          "HNSW build times on the initial 12M vectors. Need to time-box and have a rollback plan.",
        ),
        bullet(
          "Query plan stability - Postgres planner can surprise us on hybrid filter+vector queries. I want to add EXPLAIN ANALYZE tests in CI.",
        ),
        bullet(
          "Operational story for pgvector on RDS at our scale isn't as battle-tested as Pinecone's managed offering. Need clear runbook for index rebuild + tuning.",
        ),
      ...
      summary:
        "Internal RFC: Pinecone → pgvector migration. Action: leave comments by Friday, attend decision meeting Tue.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 22,
      snippet:
        "Email sync delays 7:42-8:18 PM PT. Root cause: Aurinko webhook lag. Resolved.",
      body: email([
        ...
        logRow(
          "19:42:18",
          "Aurinko webhook latency p99 crossed 30s threshold",
          { tone: "warn" },
        ),
        logRow("19:43:02", "Oncall paged via PagerDuty (Marcus)", {
          tone: "warn",
        }),
        logRow("19:46:11", "Marcus acknowledged, started investigation", {
          tone: "info",
        }),
        logRow(
          "19:54:32",
          "Identified: Aurinko provider rotated TLS certs upstream",
          { tone: "info" },
        ),
        logRow(
          "20:02:08",
          "Confirmed our retry queue holding correctly, no data loss",
          { tone: "ok" },
        ),
        logRow(
          "20:18:44",
          "Webhook lag recovered, queue drained, all events processed",
          { tone: "ok" },
        ),
        ...
        bullet(
          "<strong>Add Aurinko TLS rotation to the runbook</strong> · owner: Aria · due Friday · so the next on-call doesn't burn 10 minutes diagnosing the same thing",
        ),
        bullet(
          "<strong>Add webhook-lag alert at 5-min threshold</strong> · owner: Nathan · due Friday · so we know before the 30s threshold triggers a page",
        ),
        bullet(
          "<strong>Open ticket with Aurinko</strong> · owner: Marcus · due today · ask for advance notice of TLS rotations on shared edge nodes",
        ),
        ctaRow([
          ctaButton("View full incident timeline", { color: "#dc2626" }),
          ctaButton("Open postmortem doc", {
            color: "#dc2626",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Resolved incident report (36-min sync delay). 2 follow-ups assigned. Informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      daysAgo: 5,
      snippet:
        "What went well, what to change. Velocity up 18% from sprint 13.",
      body: email([
        headline(
          "Sprint 14 retro · what worked, what didn't, what we're changing",
        ),
        p(
        ...
        bullet(
          "<strong>Pairing experiment paid off.</strong> Marcus + Elena spent ~2 days pairing on the search-index project. Result: shipped a sprint earlier than originally scoped, with cleaner code and zero rollbacks. Continuing pairing for the next two big rocks.",
        ),
        bullet(
          "<strong>Zero rollbacks.</strong> First clean sprint in months. Likely a combination of better test coverage (now at 84%) and the new pre-deploy smoke suite.",
        ),
        bullet(
          "<strong>On-call load down 40%.</strong> Last sprint's noise-reduction work on Sentry alerts is showing up in the data.",
        ),
        bullet(
          "<strong>Cross-team dependencies cleared faster.</strong> Design partner sat with eng for the last 2 days of the sprint - that closed 3 ambiguities that would have spilled to Sprint 15.",
        ),
        sectionTitle("What didn't"),
        bullet(
          "<strong>Design handoff still late.</strong> Three of four design assets landed Wednesday instead of Monday. Same pattern as Sprint 13. Talked through it on the call - root cause is upstream: PMs giving design less than 5 days of lead time on the spec.",
        ),
        bullet(
          "<strong>PR review SLA at 18 hours median.</strong> Up from 14h two sprints ago. Reviewers consistently delaying because of 'I'll get to it tomorrow' on small PRs.",
        ),
        bullet(
          "<strong>Two backlog items got promoted mid-sprint.</strong> Both legitimate (a customer escalation and a security finding), but the disruption cost ~6 points of velocity.",
        ),
        ...
        bullet(
          "Update sprint-planning template to require design kickoff one sprint ahead · Dana · this week",
        ),
        bullet(
          "Build the PR-review Slack bot · Nathan · 2-day estimate · ships in Sprint 15",
        ),
        bullet(
          "Postmortem the two backlog promotions · Marcus · figure out if there's a process gap",
        ),
        hr(),
        signature(
          "Product",
          "Sprint 14 retro digest",
          "product@vectormail.app",
        ),
      ]),
      summary:
        "Sprint retro digest. Two improvement areas (design handoff, PR SLA). Informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      hour: 21,
      snippet:
        "API latency p95 > 1200ms for 5 min. Auto-resolved after deploy rollback.",
      body: email([
        brandBlock("Datadog"),
        ...
        p(
          "A 5-minute latency spike on <strong>vectormail-api</strong> auto-resolved when the triggering deploy was rolled back. No customer-facing requests timed out - the long-tail traffic fell within our retry budget.",
        ),
        metricGrid([
      ...
      summary:
        "Datadog alert: brief latency spike, auto-rolled back. No action - informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
    ...
    },
    {
      ...
      daysAgo: 6,
      snippet:
        "You're primary May 19-25. Runbook updated. Two open follow-ups from last week.",
      body: email([
        ...
        keyValBlock([
          {
            label: "Primary",
            value: "You · 7 days starting Mon May 19, 9:00 AM PT",
          },
          { label: "Secondary", value: "Marcus Liu (always-on for SEV-1)" },
          { label: "Escalation", value: "Dana Howe · then CEO · per playbook" },
          {
            label: "Last week's primary",
            value: "Elena Vargas (1 page, SEV-3, resolved)",
          },
          {
            label: "Pager tool",
            value: "PagerDuty · vectormail-prod schedule",
          },
        ]),
        ...
        bullet(
          "Aurinko has a regional maintenance window Tuesday 2-4 AM PT - they say no impact, we'll watch.",
        ),
        bullet(
          "Our Stripe webhook handler had a signature failure 12 days ago that they 'fixed' - keep an eye on the dashboard.",
        ),
        bullet(
          "Marcus is shipping the pgvector cutover Wednesday at 7 PM PT. Be available; it's behind a feature flag with a kill-switch.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("View PagerDuty schedule", {
            color: "#dc2626",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Oncall handoff for May 19-25. 2 carryover items. Informational.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Color palette opinions - that's locked from the brand work last quarter.",
        ),
        bullet(
          "Typography opinions - those are locked at the brand level too.",
        ),
        bullet(
          "'What if we also did X' tangents - capture those, but we're not designing new features at this crit.",
        ),
        sectionTitle("Format"),
        p(
        ...
        signature(
          "Taylor Reed",
          "Design Lead · VectorMail",
          "design@vectormail.app",
        ),
      ]),
      summary:
        "Design crit Thursday. Three review questions. Action: review Figma + show up.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        p(
          "Auto-generated weekly digest from the product analytics pipeline. <strong>Healthy across the board.</strong> No new fires. Highlights below.",
        ),
        sectionTitle("Usage"),
        metricGrid([
          ...
          {
            label: "Activation (first reply ≤ 7d)",
            value: "71%",
            sub: "+2 pp",
          },
          {
        ...
        bullet(
          "<strong>Daily Brief:</strong> 78% of active users opened at least one this week (target 75%).",
        ),
        bullet(
          "<strong>Buddy reply:</strong> 41% used Buddy to draft a reply (vs 38% last week).",
        ),
        bullet(
          "<strong>Semantic search:</strong> 62% of users ran ≥ 1 NL query this week.",
        ),
        bullet(
          "<strong>Outlook beta:</strong> 14 customers active. NPS so far: 8.7.",
        ),
        sectionTitle("Top user-requested features (this week)"),
        bullet(
          "<strong>Mobile app</strong> · 47 mentions · top request 11 weeks running",
        ),
        bullet(
          "<strong>Outlook support</strong> · 31 mentions · beta active, will close most of these",
        ),
        bullet(
          "<strong>Team folders</strong> · 28 mentions · in roadmap for Q3",
        ),
        bullet(
          "<strong>Calendar integration</strong> · 22 mentions · scoped, not started",
        ),
        bullet(
          "<strong>Bulk operations</strong> · 18 mentions · technical scope sketched",
        ),
        sectionTitle("Negative signals to watch"),
        bullet(
          "Drop-off on onboarding step 3 (connect Gmail) is up 3 pp. Investigate Tuesday.",
        ),
        bullet(
          "Sentiment in support tickets trending slightly negative - Aria flagging.",
        ),
        ctaRow([
          ctaButton("Open full dashboard", { color: "#1F3A2E" }),
          ctaButton("Drill into onboarding drop-off", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Generated by metrics-bot at 8:00 AM PT every Sunday. Data fresh through Saturday 11:59 PM PT. Source: PostHog + internal analytics warehouse.",
        ),
        companyEmailFooter("VectorMail Metrics"),
      ]),
      summary:
        "Weekly product metrics digest. Healthy across the board. Informational.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      hour: 17,
      snippet:
        "Three things for our 1:1: roadmap, hiring, my career path. Notes attached.",
      body: email([
        p("Hi,"),
        p(
        ...
        signature(
          "Dana Howe",
          "Head of Engineering · VectorMail",
          "dana@vectormail.app",
        ),
      ]),
      summary:
        "Direct report 1:1 agenda. 3 topics incl. career path. Action: prep talking points before 11am.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        p(
          "Heads up - your annual Notion Plus subscription for <strong>VectorMail HQ</strong> auto-renews on May 24, 2026. We'll charge the card on file (Brex •• 1842) for the full year on that date. No action required if everything below looks right.",
        ),
        ...
        keyValBlock([
          ...
          {
            label: "Per seat",
            value: "$8 / month, billed annually ($96/seat/yr)",
          },
        ...
        bullet(
          "Admin tools (member roles, link expiration, restricted templates)",
        ),
        sectionTitle("Want to make a change?"),
        p(
          "You can add seats, remove seats, switch to monthly, or upgrade to Business / Enterprise before the renewal date. Any changes apply immediately and are pro-rated.",
        ),
        ctaRow([
          ctaButton("Manage subscription", { color: "#000000" }),
          ctaButton("Add or remove seats", {
            color: "#000000",
            variant: "outline",
          }),
      ...
      summary:
        "Notion auto-renewal notice. Action: confirm budget or change plan before May 24.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("Upgrade to Enterprise", {
            color: "#000000",
            variant: "outline",
          }),
      ...
      summary:
        "Vercel usage alert: 80% of build minutes used. Action: monitor or upgrade. Low-priority.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("Cycle 10 planning", {
            color: "#5e6ad2",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Team: vectormail-ai · Workspace: VectorMail HQ · Cycle 9: May 5 → May 16, 2026",
        ),
      ...
      body: email([
        ...
        keyValBlock([
          ...
          { label: "Active editors", value: "8 editors, 14 viewers" },
          {
            ...
            value: "$45/editor/mo (was $15/editor/mo)",
          },
          {
            label: "Effective immediately",
            value: "Yes - pro-rated charge on next invoice",
          },
          { label: "Next invoice", value: "June 9, 2026 · ~$3,420" },
        ]),
        sectionTitle("New features your team can use today"),
        bullet(
          "<strong>Design systems</strong> - shared component libraries across multiple files, with versioning and update tracking.",
        ),
        bullet(
          "<strong>Branching</strong> - create design branches on top of your main file, review changes, merge back. Like git for designs.",
        ),
        bullet(
          "<strong>Advanced permissions</strong> - set per-file and per-folder permissions, including view-only and comment-only modes.",
        ),
        bullet(
          "<strong>SSO + SCIM</strong> - Okta SSO and SCIM provisioning for adding/removing teammates automatically.",
        ),
        bullet(
          "<strong>Audit log</strong> - full activity history for compliance and incident response.",
        ),
        bullet(
          "<strong>Variable themes</strong> - share design tokens across your team and apply them to any component.",
        ),
        sectionTitle("Setup we'd recommend in the first 30 days"),
        bullet("Set up SSO via Okta (~30 min, requires admin)."),
        bullet(
          "Migrate your existing component library into the new Design Systems area.",
        ),
        bullet(
          "Configure default permissions for new files (recommend 'View only' as default).",
        ),
        ctaRow([
          ctaButton("Open admin settings", { color: "#0f0f0f" }),
          ctaButton("Set up SSO", { color: "#0f0f0f", variant: "outline" }),
          ctaButton("View migration guide", {
            color: "#a259ff",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        fineprint(
          "Digest period: 2026-05-11 → 2026-05-17 · Project ID: vectormail-ai-prod",
        ),
        companyEmailFooter("Sentry"),
      ]),
      summary:
        "Sentry trend alert: 23% increase in errors. Action: investigate embedding null bug. Time-sensitive.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 5,
      snippet:
        "Your account has been credited $200 from the AI Startups program.",
      body: email([
        brandBlock("Twilio"),
        ...
        keyValBlock([
          ...
          {
            label: "Applied to",
            value: "All Twilio products, no restrictions",
          },
        ...
        bullet(
          "<strong>Free tier consultation</strong> with a Twilio AI solutions engineer (45 min).",
        ),
        bullet(
          "<strong>Beta access</strong> to Twilio Voice AI features ahead of general availability.",
        ),
        bullet(
          "<strong>Quarterly office hours</strong> with the Twilio AI startup team and other portfolio companies.",
        ),
        bullet(
          "<strong>Marketing co-op</strong> if you publish a case study (credit toward the next year).",
        ),
        ctaRow([
          ctaButton("View console", { color: "#f22f46" }),
          ctaButton("Book solutions call", {
            color: "#f22f46",
            variant: "outline",
          }),
          ctaButton("Twilio for AI Startups", {
            color: "#f22f46",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Items",
            value: "47 (API keys, DB credentials, OAuth secrets, certs)",
          },
          {
            label: "Your permission level",
            value: "Manage (read, write, share with admin approval)",
          },
          { label: "Shared by", value: "Marcus Liu · marcus@vectormail.app" },
          { label: "Shared on", value: "Friday, May 14, 2026 · 11:18 AM PT" },
          {
            label: "Vault audit trail",
            value: "Enabled - your accesses are logged",
          },
        ]),
    ...
    },
    {
      ...
      daysAgo: 2,
      snippet:
        "3 transactions over $75 are missing receipts. Add them in the app.",
      body: email([
        brandBlock("Brex"),
        ...
        bullet(
          "<strong>Email:</strong> Forward the original receipt to <code>receipts@brex.com</code> from this address - Brex auto-matches it.",
        ),
        bullet(
          "<strong>App:</strong> Open the Brex app → Recent → tap the transaction → 'Add receipt' → snap or upload.",
        ),
        bullet(
          "<strong>Slack:</strong> DM @Brex in Slack with the receipt + transaction ID.",
        ),
        ctaRow([
          ctaButton("Open Brex app", { color: "#0f0f0f" }),
          ctaButton("Forward receipts via email", {
            color: "#0f0f0f",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Brex: 3 receipts overdue. Action: upload in app. Low priority but recurring.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          { label: "From", value: "Brightlane Holdings, Inc." },
          {
            ...
            value: "First Republic Bank · 7180•••••",
          },
          { label: "Beneficiary account", value: "Mercury Checking •• 3412" },
          {
            label: "Reference / Memo",
            value: "BL-2026-INV-0091 (Q2 renewal · 75 seats · annual prepay)",
          },
        ...
        bullet(
          "Sender on file? <strong>Yes</strong> - Brightlane Holdings has sent wires to this account 6 times in the past 12 months.",
        ),
        bullet(
          "Amount matches expected invoice? <strong>Yes</strong> - exact match to INV-0091.",
        ),
        bullet(
          "Originating bank matches history? <strong>Yes</strong> - First Republic, same as prior wires.",
        ),
        ctaRow([
          ctaButton("View transaction", { color: "#0f1c3f" }),
          ctaButton("Mark invoice paid in Stripe", {
            color: "#0f1c3f",
            variant: "outline",
          }),
          ctaButton("Reply to send thanks", {
            color: "#0f1c3f",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Wire from Brightlane cleared ($45K). Action: confirm with finance, mark invoice paid.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Environment",
            value: "Sandbox (test data only - Production is unaffected)",
          },
          {
            label: "Rotated by",
            value: "marcus@vectormail.app · auto-policy (90-day rotation)",
          },
          {
            label: "Old secret",
            value: "Last 4: ••••8F2A · revoked at 11:47 AM",
          },
          {
            label: "New secret",
            value: "Available in your Plaid dashboard · view-once",
          },
          {
            label: "Endpoint affected",
            value: "https://sandbox.vectormail.app/api/plaid/webhook",
          },
          {
            label: "Estimated dev/QA disruption",
            value: "Until env var is updated (typically <10 min)",
          },
        ]),
        sectionTitle("Steps to update"),
        bullet(
          "Sign in to dashboard.plaid.com → Team Settings → API Keys → Webhook secrets.",
        ),
        bullet(
          "Copy the new secret (it's only viewable for the next 24 hours).",
        ),
        bullet(
          "Update <code>PLAID_WEBHOOK_SIGNING_SECRET</code> in your sandbox env (Vercel preview env).",
        ),
        bullet(
          "Trigger a test webhook delivery to confirm signature verification passes.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("View rotation history", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Plaid: webhook secret rotated. Action: update env vars in sandbox.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "In person",
            value: "Forerunner Ventures · 1 Letterman Drive, Bldg C, 4th floor",
          },
          {
            label: "Zoom",
          ...
          {
            label: "Dial-in",
            value: "+1 (669) 900-6833 · ID 812 44 901 · PIN 4421",
          },
        ]),
        sectionTitle("Agenda (drafted)"),
        logRow("2:00 - 2:10", "Welcome + safety message · Hana", {
          tone: "info",
        }),
        logRow("2:10 - 2:35", "Q1 + April KPIs · CEO + CFO", { tone: "info" }),
        logRow("2:35 - 2:55", "Customer wins + pipeline · CRO", {
          tone: "info",
        }),
        logRow("2:55 - 3:15", "Hiring plan through Q3 · Head of People", {
          tone: "info",
        }),
        logRow("3:15 - 3:35", "Product roadmap + Q3 themes · CPO", {
          tone: "info",
        }),
        ...
        bullet(
          "Authorize $250K bridge facility with SVB (already vetted by counsel).",
        ),
        bullet(
          "Adopt the revised option grant guidelines for executive hires.",
        ),
        sectionTitle("Attendees · 7"),
        profileCard({
          name: "Hana Cho",
          title: "Partner, Forerunner",
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "In person",
            value:
              "VectorMail HQ · 535 Mission St, 4th floor (large meeting room)",
          },
          {
            label: "Zoom",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">meet.google.com/vmh-allhands-may</a>`,
          },
          { label: "Host", value: "Dana Howe" },
          { label: "Calendar", value: "Work" },
        ]),
        sectionTitle("Agenda"),
        logRow("10:00 - 10:10", "CEO update · KPIs, hiring, customer wins", {
          tone: "info",
        }),
        logRow(
          "10:10 - 10:25",
        ...
        logRow(
          "10:25 - 10:40",
          "Live Q&A - submit questions in Slido in advance",
          { tone: "info" },
        ),
        logRow("10:40 - 10:45", "Wrap + birthdays this month", {
          tone: "info",
        }),
        sectionTitle("Pre-read"),
        bullet(
          "Slides will be posted in <code>#all-hands</code> by 9 AM PT day-of.",
        ),
        bullet(
          "Anonymous Q&A is live now - submit anything you want addressed.",
        ),
        bullet(
          "Recording will be in the shared drive within 30 min of the meeting.",
        ),
        ctaRow([
          ctaButton("Yes", { color: "#0caa41" }),
          ctaButton("Maybe", { color: "#1a73e8", variant: "outline" }),
    ...
    },
    {
      ...
      body: email([
        ...
        p(
          "Q2 renewal conversation with Sophia at Brightlane. They're expanding 50 → 75 seats and asking for a 10% volume discount + 12-month price lock. Aria has the quote ready - please review before the call.",
        ),
        sectionTitle("Where"),
        keyValBlock([
          {
            label: "Video",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">brightlane.zoom.us/j/4188-99-2841</a>`,
          },
          {
            label: "Organizer",
            value: "Sophia Pereira (sophia@brightlane.io)",
          },
          {
            label: "Brightlane attendees",
            value: "Sophia Pereira (VP Eng), Tomas Reyes (CFO)",
          },
          { label: "Our attendees", value: "You + Aria Lawson" },
        ]),
        sectionTitle("Pre-read · quote + relationship history"),
        bullet(
          "<strong>Current state:</strong> 50 seats · $99/seat/mo · ~$59.4K ARR · 9 months tenure",
        ),
        bullet(
          "<strong>Proposed:</strong> 75 seats · 10% volume discount · 12-month price lock · ~$80.2K ARR (+35%)",
        ),
        bullet(
          "<strong>Customer story participation:</strong> Sophia agreed to be the public case study",
        ),
        bullet(
          "<strong>Reference calls:</strong> 1-2 per quarter, scheduled through Sophia",
        ),
        sectionTitle("Decisions to make on the call"),
        bullet("Confirm the discount + price lock."),
        bullet(
          "Lock case-study scope + timeline (Aria has a draft we can share).",
        ),
        bullet(
          "Ask for the customer-of-the-month moment in our internal all-hands.",
        ),
        ctaRow([
          ctaButton("Yes", { color: "#0caa41" }),
          ctaButton("Maybe", { color: "#1a73e8", variant: "outline" }),
        ...
        fineprint(
          "Customer health: Green. NPS: 9. Risk of non-renewal: Low. Risk of pushing back on the discount: Low.",
        ),
        companyEmailFooter("Calendar"),
      ]),
      summary:
        "Renewal call with Brightlane. Action: review quote before Tuesday.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Location",
            value: "Ritual Coffee · 1026 Valencia St, San Francisco",
          },
        ...
        bullet(
          "How is the senior backend engineer market shifting in SF this quarter? Are we still in the comp band that closes deals?",
        ),
        bullet(
          "Anything you've seen in the last 30 days that should change how we're sourcing or pitching?",
        ),
        bullet(
          "Real talk on Nathan Wu's competing offer: how aggressive should we be vs. comparable Series A companies right now?",
        ),
        bullet(
          "Heads-up on anyone you have in your network we should be talking to (Staff PM specifically, given Sasha Hill is on the radar).",
        ),
        sectionTitle("What Lina usually wants from me"),
        bullet(
          "Reciprocal intel: what's our funnel looking like? Where are we losing candidates?",
        ),
        bullet(
          "Referrals from our team to her other clients (low-touch, high-value).",
        ),
        ctaRow([
          ctaButton("Yes", { color: "#0caa41" }),
          ctaButton("Move 30 min later", {
            color: "#1a73e8",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Reminder: 5-min walk buffer each way. Hand-drip coffee is the move there; she always gets the iced cortado.",
        ),
        companyEmailFooter("Calendar"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Video",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">meet.google.com/vmh-design-q1</a>`,
          },
          {
            label: "Figma",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">Q1 - Designs for review</a>`,
          },
          {
            label: "Pre-read",
            value: "Read Figma + comments before the meeting",
          },
        ]),
        ...
        ctaRow([
          ...
          ctaButton("Propose another time", {
            color: "#1a73e8",
            variant: "outline",
          }),
          ctaButton("Decline (recording is fine)", {
            color: "#dc2626",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Your previous 'Yes' on Tuesday has been removed. Please reconfirm so we know who's in for Wednesday.",
        ),
        companyEmailFooter("Calendar"),
      ]),
      summary:
        "Design review rescheduled to Wed 2 PM. Action: confirm or rebook.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Reply to Sam directly to propose a new time. Easiest: send your Calendly link for next week.",
        ),
        bullet("Hold Tuesday-Thursday next week open until he confirms."),
        bullet(
          "Make sure to surface 'intros to fintech operators' when you reschedule - Hana asked about that 3 days ago and his are valuable.",
        ),
        ctaRow([
          ctaButton("Reply to Sam", { color: "#1a73e8" }),
          ctaButton("Send Calendly link", {
            color: "#1a73e8",
            variant: "outline",
          }),
        ]),
        fineprint(
          "This event has been removed from your calendar. A new event will appear when you and Sam confirm a replacement time.",
        ),
        companyEmailFooter("Calendar"),
      ]),
      summary:
        "Lunch declined, asking to reschedule. Action: propose new time.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "In person",
            value:
              "Forerunner Ventures · 1 Letterman Drive · 4th floor, room 4C",
          },
          {
            label: "Zoom backup",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">forerunner.zoom.us/j/824-22-901</a>`,
          },
          { label: "Organizer", value: "Hana Cho (hana@forerunnervc.com)" },
          {
            label: "Cadence",
            value: "Monthly · always last Monday of the month",
          },
        ]),
        sectionTitle("Suggested topics this month"),
        bullet(
          "<strong>The NRR question.</strong> She asked in March whether the jump from 108 to 117 was concentrated or broad-based. You owe her an answer with data.",
        ),
        bullet(
          "<strong>Mosaic Health intro.</strong> She offered an intro to Sam at Mosaic. You haven't confirmed yes/no - easiest answer is yes.",
        ),
        bullet(
          "<strong>Pricing reset.</strong> The variant-B rollout is live. Share early results since this is one of her favorite topics.",
        ),
        bullet(
          "<strong>Wild card.</strong> Anything else you want fresh-eye input on - pricing, hiring, fundraising approach.",
        ),
        sectionTitle("Pre-prep"),
        bullet("Bring the NRR cohort cut Hana asked for in March."),
        bullet(
          "Have one specific question ready that's actually keeping you up at night.",
        ),
        bullet(
          "She always closes with 'what can I help with' - have a real ask.",
        ),
        ctaRow([
          ctaButton("Yes", { color: "#0caa41" }),
          ctaButton("Maybe", { color: "#1a73e8", variant: "outline" }),
        ...
        fineprint(
          "Office hours run weekly with each portfolio company. Hana cancels rarely; if you can't make it, she usually rebooks within the same week.",
        ),
        companyEmailFooter("Calendar"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        p(
          "Theo Vargas (Castleworks) cancelled the lunch you had booked for Friday May 22 at 1:00 PM. He's working on a new time and will send a replacement invite separately.",
        ),
        sectionTitle("Original event"),
        keyValBlock([
        ...
        bullet(
          "Wait until Tuesday for Theo's replacement invite (he said he'd lock it by then).",
        ),
        bullet(
          "If you don't hear from Theo by Wednesday, send a friendly nudge - it's worth keeping this on the calendar given he's a paying customer.",
        ),
        ctaRow([ctaButton("Reply to Theo", { color: "#1a73e8" })]),
        fineprint(
          "Cancellations don't appear in your calendar but are tracked in your meeting history for 30 days.",
        ),
        companyEmailFooter("Calendar"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        listItem({
          title:
            "The 5 levels every PM ladder needs (and why most teams only use 3)",
        ...
        listItem({
          title:
            "The rubric template I'd steal · Stripe's leveling doc, with edits",
    ...
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("Listen to the audio", {
            color: "#1a1a1a",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Stratechery is a daily strategy newsletter by Ben Thompson. To unsubscribe or manage your preferences, visit stratechery.com/account.",
        ),
    ...
    },
    {
      ...
      hour: 6,
      snippet:
        "OpenAI's new model, Anthropic enterprise push, and 3 fundraise scoops.",
      body: email([
        ...
        headline(
          "OpenAI's quiet new model, Anthropic's enterprise momentum, and 3 fundraise scoops",
        ),
        p(
        ...
        listItem({
          title:
            "Anthropic Enterprise Revenue Triples in 6 Months, Sources Say",
        ...
        fineprint(
          "The Information · subscriber-exclusive · forwarding is logged. Reply to this email with feedback for the editor.",
        ),
    ...
    },
    {
      ...
      daysAgo: 4,
      snippet:
        "How early-stage founders should approach the first 10 enterprise sales.",
      body: email([
        ...
        headline(
          "The first 10 enterprise sales · what 50+ founders wish they'd known",
        ),
        p(
        ...
        bullet(
          "<strong>Discount everything in year 1.</strong> The data is unambiguous - first-year customers should be 30-50% below your standard pricing in exchange for written feedback and a willingness to be a reference. Founders who 'held the line' on pricing in the first 10 deals lost 70% of them.",
        ),
        bullet(
          "<strong>You don't need an AE until your 11th customer.</strong> Founders close the first 10. Hiring earlier means you teach an AE a sales motion that doesn't exist yet - they fail, and you blame them. Don't.",
        ),
        bullet(
          "<strong>Build a sales artifact, not a pitch deck.</strong> A one-page case study from your first customer is worth 10× more than a 30-slide pitch deck. Spend time making it perfect.",
        ),
        bullet(
          "<strong>Procurement gates are the real bottleneck.</strong> SOC 2, MSA template, security questionnaires, DPA. Build a 'procurement-ready' kit before customer #2, not customer #10.",
        ),
        bullet(
          "<strong>Founder-led sales is the only sustainable signal of PMF.</strong> If you can't sell it, no one else can. Period.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Download the artifact pack", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
        fineprint(
          "First Round Review · Free for founders, forever. Published every other Tuesday. Manage subscription at firstround.com/review.",
        ),
    ...
    },
    {
      ...
      daysAgo: 5,
      snippet:
        "On the rise of vertical AI companies and what it means for ecosystem builders.",
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("Watch the podcast version", {
            color: "#fde047",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Reply with what you're working on - I read every one. Not Boring is supported by sponsors that I personally vet. This week's sponsor: Mercury (banking).<br/><br/>Catch you next Sunday - Packy",
        ),
    ...
    },
    {
      ...
      daysAgo: 2,
      snippet:
        "Hiring slowdowns, AI tools that actually ship, and Big Tech engineering trends.",
      body: email([
        ...
        headline(
          "This week in engineering · hiring market real talk + AI tools that actually ship",
        ),
        p(
        ...
        bullet(
          "A staff engineer's career retrospective: 'I should have left earlier' (paid)",
        ),
        ...
        fineprint(
          "The Pragmatic Engineer is a reader-supported newsletter. Free subscribers get the weekly digest. Paid subscribers get the long-form deep dives. No ads, ever.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        p(
          "Three writers you follow published in the last 24 hours. Quick summaries below - tap any title to read the full post.",
        ),
        listItem({
        ...
        listItem({
          title:
            "Patrick O'Shaughnessy · Decoder ring for founders raising in 2026",
        ...
        bullet(
          "'Why every Series B is rewriting their pricing right now' - by Hana Cho · 1.2K likes",
        ),
        bullet(
          "'The post-AI cost stack for SaaS' - by Ben Thompson · 980 likes",
        ),
        bullet(
          "'Hiring for adversarial product sense' - by Marisol Choi · 720 likes",
        ),
        ctaRow([
          ctaButton("Open Substack", { color: "#ff6719" }),
          ctaButton("Manage subscriptions", {
            color: "#ff6719",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Subscribe to receive these directly when they're published. You can turn off this daily roundup in Substack settings.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        headline(
          "Week 4 talk available · Jessica Livingston on founder humility",
        ),
        p(
        ...
        listItem({
          title:
            "'Founder humility, listening, and the hidden signal we look for'",
          meta: "Jessica Livingston, co-founder of Y Combinator · 38 minutes · transcript + Q&A included",
          emoji: "🎥",
        }),
        sectionTitle("What you'll learn"),
        bullet(
          "Why the most successful founders we've backed were 'great listeners, not great talkers' - and the specific behaviors that show this trait in early conversations.",
        ),
        bullet(
          "How to spot when you're talking past your customer (vs. talking with them) - Jessica's specific test.",
        ),
        bullet(
          "The 'first 50 customer conversations' framework that produced PMF for half of YC's most successful companies.",
        ),
        bullet(
          "Why founders who 'know everything already' have the lowest success rate in our data, and how to avoid that trap.",
        ),
        sectionTitle("Recommended reading + exercises"),
        bullet(
          "Do the 'Mom Test' exercise from Rob Fitzpatrick's book before next week. We provide the worksheet.",
        ),
        bullet(
          "Ship the next 3 customer conversations as recorded calls (with permission) and transcribe them. You'll see things you missed in real time.",
        ),
        bullet(
          "Read the Startup School essay 'The Hidden Power of Listening' (2018, Jessica) - it's the written version of the talk, useful as a refresher.",
        ),
        ctaRow([
          ctaButton("Watch the talk", { color: "#ff6600" }),
          ctaButton("Download transcript", {
            color: "#ff6600",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("View full lineup", {
            color: "#e91e63",
            variant: "outline",
          }),
          ctaButton("Submit a talk for 2027", {
            color: "#e91e63",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      hour: 11,
      snippet:
        "Your SOC 2 Type II audit kicks off May 26. 4 evidence items still open.",
      body: email([
        brandBlock("Vanta"),
        ...
        bullet(
          "Wednesday afternoon: Marcus runs the incident tabletop with the on-call rotation.",
        ),
        bullet(
          "Friday: Vanta sanity-check + you sign off everything is green for Monday.",
        ),
        ctaRow([
          ctaButton("Open audit dashboard", { color: "#314CE5" }),
          ctaButton("Message your auditor", {
            color: "#314CE5",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Vanta: SOC 2 audit kickoff in 7 days. 4 evidence items open. Action: close all 4 this week.",
      labels: [labelImportant],
      read: false,
    },
    {
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Request type",
            value: "GDPR Article 15 · Right of Access (data export)",
          },
          {
            label: "Requester",
            value: "anon-customer-c-4128 (Brightlane staff member)",
          },
          { label: "Account", value: "Brightlane (customer · 75 seats)" },
          {
            label: "Submitted via",
            value: "Self-serve portal · privacy.vectormail.app/request",
          },
          { label: "Received", value: "Friday, May 15, 2026 · 9:32 AM PT" },
          {
            label: "Statutory deadline",
            value: "30 days · target complete May 28, 2026",
          },
          { label: "Owner", value: "Aria Lawson + Privacy team" },
        ]),
        sectionTitle("What's being exported"),
        bullet(
          "All emails synced for this user (~2,400 threads, ~14,800 individual messages)",
        ),
        bullet(
          "All AI-generated summaries, briefs, drafts attributed to this user",
        ),
        bullet(
          "Account metadata: signup date, payment history (none - they're on the company plan), audit log of their access",
        ),
        bullet(
          "Vector embeddings (we'll include them as raw arrays + an explanation of what they are)",
        ),
        ...
        bullet(
          "Only if anything unusual surfaces in the review (e.g., they're asking us to also delete the data - which is a separate Article 17 request and goes through a different flow).",
        ),
        hr(),
        signature(
          "Privacy team",
          "Privacy + Compliance · VectorMail",
          "privacy@vectormail.app",
        ),
      ]),
      summary:
        "GDPR data export request. Action: aware only - privacy team handling.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>L-01.</strong> Verbose error messages on /api/auth leak stack traces in production. <span style='color: #5f6368;'>CVSS 3.7</span>",
        ),
        bullet(
          "<strong>L-02.</strong> Content-Security-Policy header missing on /demo subroutes. <span style='color: #5f6368;'>CVSS 3.1</span>",
        ),
        bullet(
          "<strong>L-03.</strong> Default password policy allows 8-character passwords without complexity requirements. <span style='color: #5f6368;'>CVSS 2.9</span>",
        ),
        sectionTitle("Informational (selected)"),
        bullet(
          "HSTS preload not enabled - recommend submitting to hstspreload.org.",
        ),
        bullet("Subresource Integrity not enforced on Marketing site."),
        bullet(
          "Webhook endpoints accept events older than 5 minutes - replay window.",
        ),
        bullet(
          "Stripe webhook handler doesn't enforce <code>stripe-signature</code> timestamp.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Schedule retest", {
            color: "#0a2540",
            variant: "outline",
          }),
          ctaButton("Export findings to Jira", {
            color: "#0a2540",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Pentest report: 1 medium, 3 low. Action: triage medium finding within 30 days.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 3,
      snippet:
        "Harry would like to have you on 20VC. Recording window: late June.",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          ...
          {
            label: "Format",
            value: "Video + audio, in-studio (London) or remote (your choice)",
          },
          {
            label: "Audience",
            value: "~180K downloads/episode · founders, investors, operators",
          },
          {
            label: "Topic",
            value: "AI inbox category + your specific founder journey",
          },
          { label: "Air date", value: "Mid-July 2026" },
        ]),
        sectionTitle("What Harry tends to ask (heads up)"),
        bullet(
          "How you arrived at the specific wedge of 'AI inbox' vs other AI productivity surfaces.",
        ),
        bullet(
          "The Series A - fundraise timing, terms, what you wish you'd known.",
        ),
        bullet(
          "Honest conversation on your competitive landscape (Microsoft Copilot, Superhuman, etc.). Harry likes specifics, not platitudes.",
        ),
        bullet(
          "The one thing you got wrong in the first 18 months and what changed.",
        ),
        bullet(
          "Closing question Harry always asks: 'What advice would you give the founder who's exactly where you were 18 months ago?'",
        ),
        ...
        bullet(
          "If remote: we send pro-grade microphone + camera to your office a week before. Yours to keep.",
        ),
        bullet(
          "If in-studio (London): we cover business-class travel + 3 nights at the Standard. Recording done within 48 hours of arrival.",
        ),
        bullet(
          "Pre-call with Harry ~10 days before to align on themes (60 min, video).",
        ),
        bullet(
          "Episode goes out across YouTube, Spotify, Apple Podcasts, and standalone newsletter (35K subscribers).",
        ),
        p(
        ...
        signature(
          "Marisol Reyes",
          "Head of Production · 20VC",
          "marisol@20vc.com",
        ),
      ]),
      summary:
        "Podcast invitation from 20VC. Action: confirm yes/no, propose recording slot.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Location",
            value: "San Mateo County Event Center, San Mateo, CA",
          },
          {
            label: "Expected attendance",
            value: "12,400 (in-person) + 28K (livestream)",
          },
          {
            label: "Your track",
            value: "AI-Native · 14 speakers across 2 days",
          },
          {
            label: "Audience profile",
            value:
              "Founders (38%), product/eng leaders (28%), investors (18%), other (16%)",
          },
        ]),
        sectionTitle("Two formats - your pick"),
        bullet(
          "<strong>Solo talk (25 min):</strong> Your stage, your story. We help with framing if needed. Strong format for the kind of opinionated, contrarian content that gets shared after the event.",
        ),
        bullet(
          "<strong>Moderated panel (35 min):</strong> 3-4 speakers on stage, Jason Lemkin moderating. More conversational. Good if you'd prefer a discussion to a monologue.",
        ),
        ...
        bullet(
          "All-access conference pass + VIP speaker dinner Wednesday night.",
        ),
        bullet(
          "Recording rights: SaaStr.com (full), your own marketing (clip-only).",
        ),
        ...
        signature(
          "SaaStr Programs",
          "Speaker booking · SaaStr Annual 2026",
          "programs@saastr.com",
        ),
      ]),
    ...
    },
    {
      ...
      hour: 14,
      snippet:
        "Writing about AI inbox category. Could I ask a few questions by Friday?",
      body: email([
        p("Hi,"),
        p(
        ...
        signature(
          ...
          "avery.tan@techcrunch.com",
        ),
      ]),
      summary:
        "TechCrunch press inquiry. Action: respond by Friday with availability or written quote.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Category",
            value: "AI Productivity (one of 18 total categories)",
          },
          { label: "Finalists in your category", value: "12 products" },
          {
            label: "Voting opens",
            value: "Thursday, June 5, 2026 · 9:00 AM PT",
          },
          {
            label: "Voting closes",
            value: "Thursday, June 12, 2026 · 11:59 PM PT",
          },
          {
            label: "Winners announced",
            value: "Tuesday, June 17, 2026 · live stream",
          },
          {
            label: "Award ceremony",
            value: "San Francisco · invite-only · June 26",
          },
        ]),
        sectionTitle("What winners get"),
        bullet(
          "Permanent Golden Kitty badge on your Product Hunt page (visible forever).",
        ),
        bullet(
          "Featured placement in our 'Best of 2026' newsletter (180K subscribers).",
        ),
        bullet(
          "Coverage in our annual recap article (typically picked up by major tech press).",
        ),
        bullet(
          "Invitation to host a 'Live with the winners' AMA after the awards.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Download promotional kit", {
            color: "#da552f",
            variant: "outline",
          }),
      ...
      summary:
        "PH awards nomination. Action: mobilize community for voting in June.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        p(
          "Your semi-monthly payroll run is in motion. The total has been deducted from your linked bank account (Mercury Checking •• 3412) and will hit your team's accounts on Friday, May 17.",
        ),
        ...
        keyValBlock([
          ...
          {
            label: "Filing status",
            value: "All federal + 4 state filings auto-submitted",
          },
        ]),
        sectionTitle("Breakdown by category"),
        bullet(
          "<strong>Salaries:</strong> $172,200.00 (12 full-time salaried)",
        ),
        bullet(
          "<strong>Hourly + contractor:</strong> $15,220.00 (2 part-time)",
        ),
        bullet("<strong>Bonus payouts:</strong> $0.00 (none this period)"),
        bullet(
          "<strong>Reimbursements:</strong> $4,820 (travel + equipment, all approved)",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Download payroll report", {
            color: "#f45d48",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Engineering retreat dinner · 8 ppl at Robin",
            value: "$612.00 · receipt ✓",
          },
          {
            label: "Domain renewals · vectormail.app + 4 alts",
            value: "$189.00 · receipt ✓",
          },
          {
            label: "Stripe terminal · for in-person events",
            value: "$106.00 · receipt ✓",
          },
        ]),
        ...
        bullet(
          "All categories correct (software, meals, software, software) · ✓",
        ),
        bullet("All within submitter's monthly limit ($5K) · ✓"),
        bullet(
          "Marcus has approver delegation up to $3K · this is within his scope but still needs your sign-off because the total exceeds $1.5K",
        ),
        ctaRow([
          ctaButton("Approve $1,847.00", { color: "#0caa41" }),
          ctaButton("Request changes", {
            color: "#0f0f0f",
            variant: "outline",
          }),
      ...
      summary:
        "Expense report awaiting approval ($1,847). Action: approve in app.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "You have 23 custom metrics with zero queries in the last 30 days - consider dropping them ($28/mo savings).",
        ),
        bullet(
          "Log retention is at 30 days; you can drop to 15 days for non-prod indexes ($94/mo savings).",
        ),
        ctaRow([
          ctaButton("Download receipt", { color: "#632ca6" }),
          ctaButton("View usage detail", {
            color: "#632ca6",
            variant: "outline",
          }),
          ctaButton("Apply optimization tips", {
            color: "#632ca6",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Plan: Pro · Annual contract · 7 months remaining. To change billing or method, visit Account → Billing.",
        ),
        companyEmailFooter("Datadog"),
      ]),
      ...
      body: email([
        ...
        keyValBlock([
          ...
          { label: "Strike price", value: "$0.4327 per share (current 409A)" },
          {
            ...
            value: "$5,192 grant value · ~$96K equity at last preferred price",
          },
          ...
          {
            label: "Acceleration",
            value: "Double-trigger (change-of-control + termination)",
          },
        ]),
        ...
        bullet(
          "Elena receives the grant package via DocuSign (sent ~10 min ago).",
        ),
        bullet(
          "Once she signs, Pulley auto-updates the cap table and notifies the board.",
        ),
        bullet("Vesting starts immediately on her start date (May 5)."),
        bullet(
          "If she doesn't sign within 30 days, the grant lapses and we need a new board action.",
        ),
        ctaRow([
          ctaButton("View grant in Pulley", { color: "#2f57e4" }),
          ctaButton("Download board consent", {
            color: "#2f57e4",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "§3.4 · Added a specific 24-hour incident notification SLA. Reasonable, already our practice.",
        ),
        bullet(
          "§5.2 · Changed 'shall' to 'will' throughout. Stylistic, no impact.",
        ),
        bullet(
          "§9.1 · Added their preferred dispute-resolution venue (Delaware). Already aligned with our state of incorporation.",
        ),
        bullet(
          "Exhibit A · Updated their billing contact and tax ID. Administrative.",
        ),
        ...
        signature(
          ...
          "counsel@morrisonfoerster.com",
        ),
      ]),
      summary:
        "Counsel review of Brightlane MSA. Action: decide on 2 material clauses.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        headline(
          "Your trademark application has been approved for publication",
        ),
        p(
        ...
        keyValBlock([
          ...
          { label: "Publication date", value: "Tuesday, June 1, 2026" },
          {
            ...
            value: "Thursday, July 1, 2026",
          },
        ]),
        sectionTitle("What happens next"),
        bullet(
          "<strong>June 1:</strong> Your mark publishes in the USPTO's Official Gazette.",
        ),
        bullet(
          "<strong>June 1 - July 1:</strong> 30-day opposition window. Anyone who believes your mark damages theirs can file an opposition (rare at this stage).",
        ),
        bullet(
          "<strong>~Aug 1 (if no opposition):</strong> USPTO issues a Notice of Allowance.",
        ),
        bullet(
          "<strong>Within 6 months of NoA:</strong> You file a Statement of Use, which we already have.",
        ),
        bullet(
          "<strong>~Q4 2026:</strong> Registration certificate issued. Your ® symbol use is legal nationwide.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Set up monitoring", {
            color: "#112e51",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Application status can be tracked at tsdr.uspto.gov using Serial 98712341. The Trademark Trial and Appeal Board adjudicates oppositions if filed.",
        ),
        companyEmailFooter("USPTO"),
      ]),
      summary:
        "Trademark approved for publication. Action: monitor opposition period.",
      labels: [labelUpdates],
      read: true,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Signed by Nathan",
            value: "May 14, 2026 · 11:18 AM PT (1h 36m turnaround)",
          },
          {
            label: "Signed by VectorMail",
            value: "May 14, 2026 · 11:24 AM PT (auto-counter via Dana)",
          },
        ...
        bullet(
          "Customer names, ARR, or business-specific metrics not in the public update.",
        ),
        bullet("Hiring plans, comp bands, or internal org details."),
        bullet(
          "Standard 5-year confidentiality post-termination + 1-year non-disparagement.",
        ),
        ctaRow([
        ...
        fineprint(
          "This document is legally binding in all 50 U.S. states and the EU. Audit trail is admissible as evidence of execution. Stored encrypted in your DocuSign vault.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Master Services Agreement</strong> · standard DataPipe terms, lightly customized.",
        ),
        bullet(
          "<strong>Statement of Work (SOW)</strong> · embedding pipeline service, 24-month term.",
        ),
        bullet(
          "<strong>Data Processing Addendum (DPA)</strong> · GDPR + CCPA compliant, standard SCCs.",
        ),
        bullet(
          "<strong>Custom Schedule A</strong> · data residency requirements per your legal's spec (US-East + EU-West only, no APAC ingress).",
        ),
        ...
        keyValBlock([
          ...
          {
            label: "Commit",
            value: "$60K annually · billed quarterly in advance",
          },
          {
            label: "Overage",
            value: "$0.0008 per embedding above commit (50% discount vs spot)",
          },
          {
            label: "Pilot period",
            value: "First 30 days · cancel for any reason with 7-day notice",
          },
          {
            label: "Data residency",
            value:
              "US-East 1 (primary) + EU-West 1 (failover); no other regions",
          },
          {
            label: "Auto-renewal",
            value: "12-month renewals with 60-day notice required to opt-out",
          },
        ]),
        ...
        signature(
          "Aaron Cole",
          "VP Legal & Compliance · DataPipe",
          "aaron@datapipe.io",
        ),
      ]),
      summary:
        "Vendor MSA awaiting review. Action: route to counsel, target signature next week.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Status",
            value: "MileagePlus Premier · Gold (priority boarding ✓)",
          },
        ...
        bullet(
          "Upgrade to Economy Plus included (auto-applied · 4A confirmed)",
        ),
        bullet("Priority security at SFO · TSA PreCheck active"),
        ctaRow([
          ctaButton("Manage trip", { color: "#0033a0" }),
          ctaButton("Mobile boarding passes", {
            color: "#0033a0",
            variant: "outline",
          }),
          ctaButton("Add hotel + car", {
            color: "#0033a0",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Check-in",
            value: "Wednesday, May 27, 2026 · from 3:00 PM ET",
          },
          {
            label: "Check-out",
            value: "Saturday, May 30, 2026 · by 11:00 AM ET",
          },
          {
            label: "Room",
            value: "King City View · King bed, floor 12+, 250 sq ft",
          },
          { label: "Nights", value: "3" },
          {
            label: "Rate",
            value: "$430/night × 3 = $1,290 + tax $237.94 = $1,527.94 total",
          },
          { label: "Card on file", value: "Brex Visa •• 1842" },
          {
            label: "Cancellation",
            value: "Free until 6 PM ET, May 25 · then 1 night charge",
          },
        ]),
        ...
        bullet(
          "From JFK: ~50 min by taxi/Uber ($65-85), 70 min via subway (A train to 14th St, ~$3).",
        ),
        bullet("Closest subway: 14th Street / 8th Avenue (A, C, E, L)."),
        bullet(
          "Closest landmark: The High Line elevated park (literally outside the door).",
        ),
        ctaRow([
          ctaButton("Manage booking", { color: "#cc0000" }),
          ctaButton("Add digital key on May 26", {
            color: "#cc0000",
            variant: "outline",
          }),
          ctaButton("Add to Apple Wallet", {
            color: "#cc0000",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        p(
          `Here's your trip receipt. We hope you enjoyed the ride with <strong>Marcus M.</strong> · ⭐⭐⭐⭐⭐ 4.94 driver rating · 2018 Toyota Camry · Tesla Y plate · ABC-123.`,
        ),
        ...
        keyValBlock([
          ...
          {
            label: "Charged to",
            value: "Brex Visa •• 1842 (auto-receipt to receipts@brex.com)",
          },
        ]),
        ...
        ctaRow([
          ...
          ctaButton("Request invoice", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Receipt automatically forwarded to receipts@brex.com for expense matching. If a refund is needed, request within 30 days through Uber's help center.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        p(
          "Confirm by Tuesday so I can hold or release the reservation. Excited.",
        ),
        hr(),
        signature(
          "Theo Vargas",
      ...
      summary:
        "Friend in town next week, wants dinner Thursday. Action: confirm + pick spot.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      summary:
        "Triple-handle intro with Sasha (Staff PM). Action: reply with calendar link.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Ceremony",
            value: "5:00 PM · Beltane Ranch · 11775 Sonoma Hwy",
          },
          { label: "Reception + dinner", value: "5:45 PM onward · same venue" },
          { label: "Dress code", value: "Garden party - cocktail attire" },
          {
            label: "Lodging block",
            value: "Sonoma Mission Inn · $325/night, code 'PEREIRA-WEDDING'",
          },
          { label: "RSVP deadline", value: "Sunday, May 25, 2026" },
        ]),
        sectionTitle("A few things to know"),
        bullet(
          "<strong>Outdoor ceremony</strong>, so wear shoes that can handle grass.",
        ),
        bullet(
          "<strong>Family-style dinner</strong> with vegetarian, vegan, and GF options. Note any allergies in the RSVP form.",
        ),
        bullet(
          "<strong>Open bar.</strong> Champagne for the toasts, then it's your call.",
        ),
        bullet(
          "<strong>Shuttle</strong> from Sonoma Mission Inn at 4:30 PM and back at 11:30 PM.",
        ),
        bullet(
          "<strong>+1 invited if you have someone you'd like to bring.</strong>",
        ),
        p(
        ...
        ctaRow([
          ...
          ctaButton("RSVP no (we'll miss you)", {
            color: "#dc2626",
            variant: "outline",
          }),
          ctaButton("Book hotel block", {
            color: "#1a73e8",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Wedding RSVP needed by May 25. Action: respond with attendance.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 18,
      snippet:
        "Following up from Slack - filter chips not persisting after refresh.",
      body: email([
        p("Hi,"),
        p(
        ...
        sectionTitle("Repro"),
        bullet(
          "Open VectorMail in Chrome 124 (or Safari 17.3 - same behavior in both).",
        ),
        bullet("Run an NL search like 'investor emails this week.'"),
        bullet(
          "Notice the auto-inferred filter chips appear at the top (sender domain, date range, etc.).",
        ),
        bullet("Refresh the page (Cmd-R)."),
        bullet(
          "Chips are gone. The search query field is empty. Results are gone.",
        ),
        sectionTitle("Expected behavior"),
        p(
          "Either the chips and results persist (preferred), or at minimum the original NL query is preserved in the search bar so users can re-run with one keystroke.",
        ),
        ...
        p(
          "Otherwise things are great. Sync is fast, briefs are good, Buddy v2 is the killer feature for me personally.",
        ),
        hr(),
        signature(
          "Quinn Holloway",
      ...
      summary:
        "Customer bug report: filter chip persistence. Action: file ticket, reply with ETA.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "What we tried to use but bounced off - your team should hear this.",
        ),
        bullet(
          "How our usage patterns have shifted in the last 90 days as we've gotten comfortable.",
        ),
        bullet(
          "Specific quality-of-life improvements that would make us heavier users.",
        ),
        bullet("The procurement conversation - what worked, what was painful."),
        sectionTitle("Format suggestions"),
        bullet(
          "<strong>25 minutes</strong> is plenty. Anything more and we'll start drifting.",
        ),
        bullet(
          "<strong>Recorded is fine</strong> - I'll trust you to share excerpts with permission.",
        ),
        bullet(
          "<strong>Video or audio</strong> - your call. I prefer video but I can do either.",
        ),
    ...
    },
    {
      ...
      daysAgo: 5,
      snippet:
        "Outlook beta is live. 12 customers on the waitlist now have access.",
      body: email([
        ...
        bullet(
          `Northwind IT lead: "Sync feels as fast as Gmail. Wasn't sure that was going to be true."`,
        ),
        bullet(
          `Brightlane VP Eng: "First Outlook tool that doesn't feel like a port. Briefs are working day one."`,
        ),
        bullet(
          `Castleworks PM: "One thing I missed: shared inbox folders aren't yet supported." (Already filed.)`,
        ),
        sectionTitle("Tracking"),
        bullet(
          "Sentiment in <code>#outlook-beta</code> Slack channel - Aria monitoring.",
        ),
        bullet(
          "Sync error rate dashboard - Datadog · alerts at 0.1% threshold.",
        ),
        bullet(
          "Daily check-in calls with first 3 customers for the first week.",
        ),
        sectionTitle("Next milestones"),
        bullet(
          "<strong>Week 2:</strong> Add 30 more customers from waitlist (currently 188 deep).",
        ),
        bullet(
          "<strong>Week 4:</strong> First post-launch eval against Gmail (quality + latency parity).",
        ),
        bullet(
          "<strong>Week 6:</strong> Decision on GA timing based on stability + customer feedback.",
        ),
        hr(),
        signature(
          "Product",
          "VectorMail · Internal launch update",
          "product@vectormail.app",
        ),
      ]),
    ...
    },
    {
      ...
      hour: 19,
      snippet:
        "DataPipe (35 seats) is escalating sync delays. Reaching out to you.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "4 reported instances of full inbox sync stalling for 2+ hours.",
        ),
        bullet(
          "Two of their highest-volume users (sales leads) hit the latency twice each.",
        ),
        bullet(
          "They opened an internal Slack channel '#vectormail-watch' to track issues - that's the canary signal.",
        ),
        bullet(
          "Their CSAT survey from yesterday came in at 6/10 (was 9/10 in March).",
        ),
        sectionTitle("What we know on our side"),
        bullet("Their sync token rotation is fine - no auth errors."),
        bullet(
          "They're geographically split between SF and Dublin; the Dublin pod hits a known Aurinko EU latency window every Friday afternoon.",
        ),
        bullet(
          "Eng has a fix in flight (the EU fallback endpoint switch in #VM-174); not yet in production.",
        ),
        sectionTitle("What I'm proposing"),
        p(
      ...
      summary:
        "Customer escalation, $42K ARR. Action: confirm Wed 10 AM call attendance.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        signature(
          "Felix Romero",
          "Former Executive Director · Code For Good",
          "felix@codeforgood.org",
        ),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "I send 50-80 emails per day; per-thread signature switching is a real time-savings if it works.",
        ),
        bullet(
          "My current Gmail signatures have HTML formatting (logos, link styling) - would need to preserve that.",
        ),
        bullet(
          "Some signatures have legal-disclosure boilerplate that's non-negotiable from a compliance standpoint.",
        ),
        p(
        ...
        signature(
          "Sarah Cole",
          "Partner · Meadow Partners",
          "sarah@meadowpartners.vc",
        ),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Equity",
            value: "0.45% (40,000 shares · 4-year vest, 1-year cliff)",
          },
          {
            label: "Sign-on bonus",
            value: "$30,000 (paid at start, clawback in first 12 months)",
          },
          {
            label: "Total Y1 comp",
            value: "$245,000 cash · $90,000 equity value at current 409A",
          },
        ...
        bullet(
          "Series B fintech in NYC · $230K base, 0.30% equity, $20K sign-on. Comparable cash, lower equity.",
        ),
        bullet(
          "Ramp · $225K base, 0.35% equity, $25K sign-on. Closer to ours.",
        ),
        ...
        bullet(
          "Marcus reaching out personally tomorrow morning to answer any technical questions.",
        ),
        bullet(
          "Dana scheduling an informal 15-minute coffee with the team Wednesday.",
        ),
        bullet("People Ops on standby for any equity or relocation questions."),
        ctaRow([
          ctaButton("Open offer in Greenhouse", { color: "#218d62" }),
          ctaButton("Message recruiter", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Resume",
            value: "6 yrs · Haystack Studio (4 yrs) · Twilio (2 yrs)",
          },
          {
            label: "Stack overlap",
            value:
              "TypeScript ✓ · Node ✓ · Postgres ✓ · Redis ✓ · Inngest (new)",
          },
          { label: "Location", value: "San Francisco · open to hybrid" },
          {
            label: "Comp expectations",
            value: "$195K - $230K base + equity (per recruiter)",
          },
          {
            label: "Notice period",
            value: "2 weeks (clean exit per her ref check)",
          },
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Reviewer",
            value: "Former Senior Engineer · 1-2 yrs · SF Bay Area",
          },
        ...
        sectionTitle("Suggested follow-up"),
        bullet(
          "Reply publicly with a thoughtful, non-generic response (Glassdoor weighs employer responses).",
        ),
        bullet(
          "Forward to your hiring page - these reviews actively help close candidates in final stages.",
        ),
        bullet(
          "Consider the 'second technical recruiter' advice - Lina has been pushing this for two weeks now.",
        ),
        ctaRow([
          ctaButton("Reply publicly", { color: "#0caa41" }),
          ctaButton("View on Glassdoor", {
            color: "#0caa41",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Glassdoor allows one employer response per review. Responses are public and become part of the permanent record.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Quick 20-min call</strong> - just to evaluate, no commitment. I'll share company name and full deck.",
        ),
        bullet(
          "<strong>If not for you</strong> - would you have 1-2 referrals in your network? Standard $5K referral fee on a successful hire, paid to you personally.",
        ),
        p(
        ...
        signature(
          "Beatrice Cohen",
          "Partner · Harrison & Co. Executive Search",
          "beatrice@harrison-search.com",
        ),
      ]),
      summary:
        "Cold recruiter outreach. Optional - reply with referral if any.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Payment method",
            value: "Brex Visa •• 1842 · auto-charge May 14",
          },
        ...
        bullet(
          "Two unused Elastic IPs in us-west-2 · $7.30/mo if released (Marcus knows about these)",
        ),
        bullet(
          "A dev RDS instance is running 24/7 but only used 10-6 PT · ~$180/mo savings with a schedule",
        ),
        ctaRow([
          ctaButton("Download invoice", { color: "#ff9900" }),
          ctaButton("Open Cost Explorer", {
            color: "#ff9900",
            variant: "outline",
          }),
          ctaButton("Apply suggested fixes", {
            color: "#ff9900",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Pricing reflects Enterprise Discount Program (EDP) commits. Full line-item detail is in your Billing Console. Tax is calculated separately and appears on your invoice PDF.",
        ),
    ...
    },
    {
      ...
      daysAgo: 2,
      snippet:
        "Cloudflare blocked 2.3M requests from a botnet targeting your domain.",
      body: email([
        ...
        keyValBlock([
          { label: "Attack vector", value: "HTTP GET flood (Layer 7)" },
          {
            ...
            value: "/api/* (78%), /demo/enter (12%), other (10%)",
          },
          {
            label: "Mitigation",
            value: "Managed Challenge + Rate-limiting rule #14",
          },
          {
            label: "Source ASNs",
            value: "AS398101, AS208861, AS137409 (+ 12 more)",
          },
          {
            label: "Top source country",
            value: "BR (28%), VN (19%), IN (14%)",
          },
        ]),
      ...
      body: email([
        ...
        keyValBlock([
          ...
          { label: "Usage to date", value: "$0.00 (unused)" },
          {
            ...
            value: "All models in the OpenRouter catalog · 240+",
          },
          { label: "Stacking", value: "Consumed before paid balance" },
        ]),
        sectionTitle("Suggested ways to use it"),
        bullet(
          "Run an evaluation against your top 3 candidate models - $50 is enough for a real benchmark.",
        ),
        bullet(
          "Try the newer Claude 4.7 1M-context model on a long-document workflow.",
        ),
        bullet(
          "Quietly route 5-10% of production traffic for two days to compare cost + quality with your current provider.",
        ),
        ctaRow([
        ...
        fineprint(
          "Credits are non-transferable, non-refundable, and don't roll over. To extend, contact your OpenRouter sales rep - we sometimes offer renewal credits for high-volume customers.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Raise the step timeout to 90s temporarily (config change, no deploy needed).",
        ),
        bullet(
          "Switch the EU region to the Aurinko fallback endpoint until they recover.",
        ),
        bullet(
          "Watch the status page - if not green in 1h, escalate via support.",
        ),
        ctaRow([
      ...
      summary:
        "Inngest function failures. Action: investigate timeout in scheduled-sends.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        metricGrid([
          ...
          {
            label: "Event types",
            value: "user.created (8), session.created (4)",
          },
        ...
        bullet(
          "Make sure the raw request body is passed to <code>wh.verify()</code> - not a re-parsed JSON object.",
        ),
        bullet(
    ...
    },
    {
      ...
      body: email([
        ...
        listItem({
          title:
            "Apple announces on-device AI model upgrades coming in iOS 19 (4 min)",
        ...
        listItem({
          title:
            "New paper on long-context retrieval claims SOTA on RULER (5 min)",
        ...
        listItem({
          title:
            "DeepMind: agentic browsing benchmarks · the floor just moved (3 min)",
        ...
        listItem({
          title:
            "Cursor's new 'Composer' multi-file mode (live in beta) (4 min)",
        ...
        listItem({
          title:
            "Tigris ships durable object storage that's faster than S3 (3 min)",
        ...
        fineprint(
          "TLDR · daily · 5-minute tech news for busy developers and founders. Manage your subscription at tldrnewsletter.com.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Big Tech earnings kick off.</strong> Microsoft beats on AI revenue (Azure AI up 88% YoY). Meta crushes ads with new agentic targeting. Google misses on cloud but beats on Search.",
        ),
        bullet(
          "<strong>Fed signals patience on rate cuts.</strong> No moves on rates expected before September. Inflation print at 2.4% gives them room to be deliberate.",
        ),
        bullet(
          "<strong>Anthropic raises $7.5B.</strong> The AI lab arms race continues to compress, with two-thirds of all VC dollars flowing into 4 companies.",
        ),
        ...
        fineprint(
          "Morning Brew · daily · 4 million subscribers · Built on the belief that business news shouldn't be boring.",
        ),
    ...
    },
    {
      ...
      daysAgo: 6,
      snippet:
        "Best of HN this week: rust at scale, AI infra costs, and a postmortem worth reading.",
      body: email([
        ...
        p(
          "Curated by hand from the top of HN each week. ~50,000 readers. Below: the 8 stories that got the most upvotes plus 4 I personally found most interesting.",
        ),
        ...
        listItem({
          title:
            "Why AI infra costs are about to crash (388 points · 240 comments)",
        ...
        listItem({
          title:
            "How we lost our database for 90 minutes (296 points · 174 comments)",
        ...
        listItem({
          title:
            "I built a search engine for 100M images with $200 (218 points · 88 comments)",
        ...
        bullet(
          "'The Quiet Revolution in DSLs' - why narrow, domain-specific languages are quietly making a comeback in 2026.",
        ),
        bullet(
          "'On On-Call' - the most thoughtful piece I've read on the actual emotional load of being primary on-call, separate from the technical aspects.",
        ),
        bullet(
          "'Why postgres just won' - argues database consolidation around postgres is now an irreversible trend.",
        ),
        bullet(
          "'Three years of unicorn engineering' - recently-Series-D engineer reflecting on the trade-offs of working at a high-growth company.",
        ),
        ctaRow([
        ...
        fineprint(
          "Hacker Newsletter has been hand-curating Saturday digests since 2010. If you like it, the best thing you can do is share it with another engineer.",
        ),
      ...
      body: email([
        ...
        metricGrid([
          ...
          { label: "Customer count", value: "180", sub: "average $28K ACV" },
          {
            ...
            value: "12K",
            sub: "built in 4 months",
          },
        ]),
        sectionTitle("Three tactics they used"),
        bullet(
          "<strong>Built the waitlist before the product.</strong> Spent 4 months posting daily on LinkedIn about specific legal-research pain points. Built a 12K-person waitlist before they wrote a line of code. Half converted in the first 3 months post-launch.",
        ),
        bullet(
          "<strong>Priced from day 1.</strong> No free tier, no freemium. $99/month minimum from launch. They argued it filtered for serious users and avoided the death-by-support-tickets that kills bootstrapped startups.",
        ),
        bullet(
          "<strong>Profitable from week one.</strong> They were profitable before they had product-market fit. The discipline forced focus and gave them runway no VC could have provided.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Subscribe to The Hustle", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
        fineprint(
          "The Hustle · daily business newsletter · 2.5 million subscribers · part of the HubSpot Media Network",
        ),
    ...
    },
    {
      ...
      hour: 15,
      snippet:
        "Self-serve price A/B test results: variant B won. +18% revenue per visitor.",
      body: email([
        headline(
          "Pricing A/B test · Variant B wins · +18% revenue per visitor",
        ),
        p(
        ...
        metricGrid([
          ...
          {
            label: "Cancellation in first 30d",
            value: "1.8%",
            sub: "no change vs control",
          },
        ...
        bullet(
          "Added <strong>'Save 17%'</strong> annual toggle on the pricing page - landing on annual by default",
        ),
        ...
        bullet(
          "<strong>Tuesday May 26:</strong> Ship Variant B to 100% of self-serve traffic",
        ),
        bullet(
          "<strong>Monitor 30 days:</strong> Watch cancellation rate (kill-switch if it climbs >3%)",
        ),
        bullet(
          "<strong>Re-evaluate at 30 days:</strong> Full cohort analysis to confirm the lift holds in production",
        ),
        ctaRow([
          ctaButton("Approve full rollout", { color: "#1F3A2E" }),
          ctaButton("Hold for review", {
            color: "#1F3A2E",
            variant: "outline",
          }),
          ctaButton("Open results dashboard", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
        ...
        signature(
          "Marketing",
          "VectorMail · Growth team",
          "marketing@vectormail.app",
        ),
      ]),
      summary:
        "Pricing A/B test winner. Action: approve variant B rollout to 100%.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      daysAgo: 4,
      snippet:
        "Q3 planning starts Monday. Pre-read assigned, sessions scheduled.",
      body: email([
        headline(
          "Q3 planning kicks off Monday · three sessions over two weeks",
        ),
        p(
        ...
        logRow(
          "Week 1 · Mon May 19",
          "Strategy + Q3 themes · 90 min · everyone",
          { tone: "info" },
        ),
        logRow(
          "Week 1 · Thu May 22",
          "Roadmap proposals · 2 hours · function leads present",
          { tone: "info" },
        ),
        logRow(
          "Week 2 · Tue May 27",
          "Trade-offs + commit · 2 hours · everyone, decisions made",
          { tone: "warn" },
        ),
        sectionTitle("Required pre-read by Sunday EOD"),
        bullet(
          `<strong>Q2 retrospective</strong> · what we did well, what we didn't (12 min read)`,
        ),
        bullet(
          `<strong>Customer-facing constraints memo</strong> · what's actually on fire from CS + sales (8 min read)`,
        ),
        bullet(
          `<strong>Bottoms-up model update</strong> · finance's projection of headcount + spend through Q3 (skim, 5 min)`,
        ),
        bullet(
          `<strong>Three pre-circulated theme drafts</strong> · pick the one most likely to compound (15 min read + ranking)`,
        ),
        sectionTitle("Three guardrails for the process"),
        bullet(
          "<strong>Pre-read is required.</strong> Show up to Monday with a position, not a question.",
        ),
        bullet(
          "<strong>One theme will win.</strong> Not three. Spending our resources on the one thing that compounds is the entire point.",
        ),
        bullet(
          "<strong>Trade-offs visible.</strong> Every commit gets a paired 'we are NOT doing X because we said yes to Y.' If you can't name the trade-off, the commit isn't real.",
        ),
        sectionTitle("Logistics"),
        bullet(
          "Sessions in person at the office (large meeting room) + Zoom for remote folks",
        ),
        bullet(
          "All three are <strong>required</strong> - if you can't make one, send a delegate with decision rights",
        ),
        bullet(
          "Async ranking ballot for theme selection drops Wednesday at noon",
        ),
        p("See you Monday."),
        hr(),
        signature(
    ...
    },
    {
      ...
      daysAgo: 7,
      snippet:
        "Wins from this week: NPS at 67, 3 new logos, Outlook beta shipped.",
      body: email([
        ...
        metricGrid([
          {
            label: "New logos this week",
            value: "3",
            sub: "Brightlane, Castleworks, Northglade",
          },
        ...
        bullet(
          "<strong>Brightlane expansion</strong> · 50 → 75 seats · $30K net new ARR · Sophia wants a case study",
        ),
        bullet(
          "<strong>Castleworks closed</strong> · 8-seat trial → annual contract · ~$10K new ARR",
        ),
        bullet(
          "<strong>Northglade onboarded</strong> · 100% activation in 3 days (record)",
        ),
        bullet(
          "<strong>Loop AI saved</strong> · DAU recovered, committed to 12-month renewal",
        ),
        sectionTitle("Product wins"),
        bullet(
          "<strong>Outlook beta shipped on time</strong> · 12 customers activated overnight · sentiment positive",
        ),
        bullet(
          "<strong>Buddy v2 streaming</strong> · cut median reply latency from 4.2s to 1.1s",
        ),
        bullet(
          "<strong>Sentry noise reduced 40%</strong> · oncall load now sustainable",
        ),
        sectionTitle("People wins"),
        bullet(
          "<strong>Hired Elena Vargas</strong> · senior eng from Stripe, starts June 2",
        ),
        bullet(
          "<strong>Nathan Wu in offer-decision week</strong> · expected yes by Friday",
        ),
        bullet(
          "<strong>Glassdoor 5-star</strong> from a former employee - second this quarter",
        ),
        sectionTitle("Misc wins"),
        bullet(
          "<strong>Series A term sheet</strong> from Horizon · 90% across the line",
        ),
        bullet(
          "<strong>Bridge SAFE from Foundry</strong> · $500K, executed today",
        ),
        bullet("<strong>USPTO trademark</strong> approved for publication"),
        sectionTitle("Anti-wins (we ship these too)"),
        bullet(
          "<strong>Datadog SLO breach</strong> · 12 min · auto-rolled back · being postmortemed Monday",
        ),
        bullet(
          "<strong>DataPipe escalation</strong> · being handled, save call Wednesday",
        ),
        p("Strong week. Touch grass. See you Monday."),
        hr(),
        signature(
          "VectorMail HQ",
          "Friday Wins · published every Friday at 5 PM PT",
        ),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Generate a new password directly in 1Password (Suggest Strong Password).",
        ),
        bullet("Log in to legacy-internal.vectormail.app and rotate it."),
        bullet("Update the entry in 1Password."),
        bullet(
          "Optional: delete the legacy site if it's no longer in active use.",
        ),
        ctaRow([
          ctaButton("Open Watchtower", { color: "#0572ec" }),
          ctaButton("Rotate this item", {
            color: "#0572ec",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Watchtower scans your vault daily for compromised credentials, weak passwords, reused passwords, and missing 2FA. Settings → Watchtower to configure.",
        ),
        companyEmailFooter("1Password"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Triage SLA (per your program)",
            value: "48 hours · due Monday 8:42 PM",
          },
          { label: "Severity (researcher claim)", value: "Medium · CVSS 5.4" },
          {
            label: "Bounty range (your program)",
            value: "$1,000 - $3,500 for medium",
          },
        ]),
      ...
      summary:
        "Bug bounty report - medium severity IDOR. Action: triage within 48h.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Document",
            value: "Data Processing Addendum (GDPR + CCPA)",
          },
          {
            label: "Parties",
            value: "Brightlane (Controller) + VectorMail (Processor)",
          },
          { label: "Linked to", value: "MSA-2025-BL-0091 (master agreement)" },
          {
            label: "Brightlane signed",
            value: "May 13, 2026 · 2:18 PM PT · by Tomas Reyes (CFO)",
          },
          {
            label: "VectorMail signed",
            value: "May 13, 2026 · 2:38 PM PT · by Demo User (CEO)",
          },
        ...
        bullet(
          "Standard Contractual Clauses (2021 EU Commission) for any EU data transfers",
        ),
        bullet(
          "Sub-processor consent procedure (60-day objection window for new sub-processors)",
        ),
        bullet(
          "24-hour incident notification with specifics on PII, scope, and remediation",
        ),
        ...
        fineprint(
          "Fully-executed DPA stored in your DocuSign vault. Audit trail attached. Brightlane's legal team has the same file. No further action required.",
        ),
        companyEmailFooter("DocuSign"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Auto-PR",
            value: "vectormail-ai/vectormail-ai#441 - ready to merge",
          },
          {
            label: "Repo locations affected",
            value: "5 import sites · all in /src/lib/integrations",
          },
        ]),
        ...
        sectionTitle("Recommendation"),
        p(
          "This is a low-risk merge - pure version bump of a well-tested patch. <strong>Recommend merging today.</strong> The vulnerable path is exploitable in your OAuth callback flow, so this is meaningful to ship.",
        ),
        ctaRow([
          ctaButton("Review + merge PR #441", { color: "#1f883d" }),
          ctaButton("View CVE details", {
            color: "#24292f",
            variant: "outline",
          }),
          ctaButton("View all 5 import sites", {
            color: "#24292f",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Dependabot will retry CI hourly if checks fail. If you'd like Dependabot to auto-merge low-risk patch updates, you can enable it in your repository's security settings.",
        ),
        companyEmailFooter("GitHub"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>VM-208</strong> · pgvector cutover plan · due Wed · in progress (60%)",
        ),
        bullet(
          "<strong>VM-214</strong> · Buddy v2.1 streaming tool-use indicator · due Thu · in progress (30%)",
        ),
        bullet(
          "<strong>VM-219</strong> · SOC 2 evidence automation · due Fri · todo",
        ),
        bullet(
          "<strong>VM-228</strong> · Q3 OKR draft · due Fri · in progress (40%)",
        ),
        sectionTitle("Due next week"),
        bullet(
          "<strong>VM-237</strong> · Inbox v3 triage column shipping · in review",
        ),
        bullet(
          "<strong>VM-241</strong> · Mobile responsive polish · in review",
        ),
        bullet(
          "<strong>VM-249</strong> · Pricing experiment full rollout · backlog",
        ),
        ctaRow([
          ctaButton("Open Linear", { color: "#5e6ad2" }),
          ctaButton("View this cycle", {
            color: "#5e6ad2",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Linear digest · Monday mornings at 9 AM PT · disable in your notification settings",
        ),
        companyEmailFooter("Linear"),
      ]),
      ...
      body: email([
        ...
        keyValBlock([
          { label: "Repository", value: "vectormail-ai/vectormail-ai" },
          {
            ...
            value: "Member · push to branches, open PRs, no direct main writes",
          },
        ...
        bullet(
          "Send her the new-hire engineering doc (Marcus has the template).",
        ),
        bullet(
          "Pair her with Nathan for first-week onboarding (he's offered).",
        ),
        ctaRow([
          ctaButton("View her profile", { color: "#24292f" }),
          ctaButton("Manage team access", {
            color: "#24292f",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Organization: vectormail-ai · Seat count: 8 of 25 used · You can review team permissions at any time.",
        ),
        companyEmailFooter("GitHub"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Updated <strong>Objective 1</strong> wording - softened 'dominate' to 'lead' (after your feedback last week).",
        ),
        bullet(
          "Added a <strong>new key result</strong> under Objective 2 about Outlook NRR by end of Q3.",
        ),
        bullet(
          "Reorganized the <strong>hiring section</strong> - split senior eng + staff eng into separate sub-objectives.",
        ),
        bullet(
          "Added two questions in comments - one tagged to you about the GTM objective.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Reply to Dana's comment", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
        fineprint(
          "You'll receive a daily digest of changes to pages you're watching. Manage notifications in Notion settings.",
        ),
        companyEmailFooter("Notion"),
      ]),
    ...
    },
    {
      ...
      summary:
        "VC double-opt intro to potential customer (Mosaic Health). Action: reply with demo link.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Wesley Park</strong> - Partner at SignalFire, leads enterprise AI. Ex-Atlassian product, ex-Snap. Has been the lead voice on AI-productivity in their portfolio.",
        ),
        bullet(
          "<strong>SignalFire</strong> - $2.8B AUM. Notable AI investments: Cresta, Decagon, Lattice (early). Strong recruiting platform (Beacon AI) that pulls candidates from their proprietary dataset.",
        ),
        bullet(
          "<strong>Their typical engagement post-investment:</strong> active on hiring, lightweight on product, quick at board meetings.",
        ),
        sectionTitle("My recommendation"),
        p(
      ...
      summary:
        "Co-investor warm intro. Action: respond and qualify SignalFire.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Instrument",
            value: "Post-money SAFE · $90M cap · no discount · no MFN",
          },
          { label: "Amount", value: "$500,000 USD" },
          { label: "Effective date", value: "May 13, 2026" },
          {
            label: "Funds expected",
            value: "Monday, May 19 (wire initiated Friday)",
          },
          {
            label: "Cap table impact",
            value: "Pending conversion at next priced round",
          },
          { label: "DocuSign envelope", value: "DSE-2026-bridge-FB-500" },
        ]),
        sectionTitle("What was filed / updated"),
        bullet(
          "SAFE signed by Daniel (Foundry) and you · counter-signed today",
        ),
        bullet(
          "Board consent for the bridge financing · signed by all board members",
        ),
        bullet(
          "Cap table updated in Carta (Foundry now reflects bridge in pending instruments)",
        ),
        bullet(
          "Form D filing initiated · 15 days from first sale (deadline May 28)",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Download for records", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Pilot scope",
            value: "30 seats · IT leadership + Customer Support org",
          },
          {
            label: "Cost",
            value: "$15,000 (paid, fully refundable if any criterion missed)",
          },
          {
            label: "Success contract",
            value: "250-seat MSA at $99/seat/mo, 24-month term · $7.4M ARR",
          },
      ...
      summary:
        "Enterprise POC scoping doc with success criteria. Action: review and align.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        sectionTitle("What we need"),
        bullet(
          "<strong>Updated SOC 2 Type II report</strong> · we'll accept the one you sent us last year as evidence, but want the current one if available.",
        ),
        bullet(
          "<strong>Vendor security questionnaire</strong> · 84 questions, full PDF attached. Estimated 90 minutes if you have your security policies on hand.",
        ),
        bullet(
          "<strong>Most recent pentest summary</strong> · scope + findings only, not the full report. Anonymized fine.",
        ),
        bullet(
          "<strong>Subprocessor list</strong> · most vendors update this quarterly anyway.",
        ),
        bullet(
          "<strong>BC/DR documentation</strong> · we just need attestation, not the full plan.",
        ),
        ...
        bullet(
          "Without artifacts by May 30 - our procurement team can't sign off and the renewal slips into June",
        ),
        p(
        ...
        signature(
          "Marcus Reeves",
          "Procurement · Brightlane",
          "procurement@brightlane.io",
        ),
      ]),
      summary:
        "Customer procurement security form due May 30. Action: forward SOC 2 or fill form.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Pre-onboarding workshop with the team (45 min) - walked them through the 3 features that matter most for week-1 usage.",
        ),
        bullet(
          "Dedicated Slack Connect channel from day 1 - they ask questions there instead of filing tickets.",
        ),
        bullet(
          "Set Buddy expectations correctly upfront ('it will make mistakes, here's how to give it feedback' beats 'it's magic and never wrong').",
        ),
        sectionTitle("What I'd propose next"),
        bullet("Add Carter to the customer-advisory list (he's offered)."),
        bullet(
          "Bring him on the next podcast episode if your interest is there.",
        ),
        bullet(
          "Feature Northglade as the 'fast onboarding' case study in next month's marketing.",
        ),
        hr(),
        signature(
          "Aria Lawson",
    ...
    },
    {
      ...
      daysAgo: 2,
      snippet:
        "Great - confirming you for the AI-native track at SaaStr Annual.",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          ...
          {
            label: "Recording",
            value: "Yes · livestream + post-event YouTube",
          },
          {
            label: "Estimated audience",
            value: "~1,100 in-person + ~3,800 livestream",
          },
        ]),
        sectionTitle("Speaker packet · what we need by July 1"),
        bullet(
          "<strong>Talk abstract</strong> · 150-word version + 50-word version for our app. Send both.",
        ),
        bullet(
          "<strong>Bio</strong> · 80-word professional bio + 30-word 'short version' for slides.",
        ),
        bullet(
          "<strong>Photo</strong> · 1500×1500 minimum, professional headshot (or your best LinkedIn).",
        ),
        bullet(
          "<strong>Slide template</strong> · we provide a 16:9 SaaStr-branded deck. Use whatever you want creatively but keep the SaaStr title slide + closing slide.",
        ),
        bullet(
          "<strong>Logistics form</strong> · arrival, hotel preference, dietary, any accommodations.",
        ),
        sectionTitle("On-site logistics"),
        bullet(
          "Travel: business-class flight from your home city, fully covered (we book through our travel desk).",
        ),
        bullet(
          "Hotel: Marriott San Mateo, 3 nights (Sept 13-15). Block code is 'SAASTR2026SPK'.",
        ),
        bullet("A/V tech check: Sunday Sept 13, 3 PM. Required."),
        bullet(
          "Speaker dinner: Sunday Sept 13, 7 PM. Optional but encouraged - most speakers attend.",
        ),
        bullet("Green room access throughout the conference + VIP lounge."),
        sectionTitle("Honorarium"),
        bullet(
          "<strong>$2,500 USD</strong> · paid via wire within 14 days of the talk being delivered.",
        ),
        bullet(
          "Need a signed W-9 by August 15 to ensure timely payment. Form attached.",
        ),
        ctaRow([
          ctaButton("Download speaker packet", { color: "#0a2540" }),
          ctaButton("Submit bio + abstract", {
            color: "#0a2540",
            variant: "outline",
          }),
        ...
        fineprint(
          "Excited to have you. Reply to this email with any questions and our speaker liaison (Justin) will respond within 24 hours.",
        ),
        hr(),
        signature(
          "SaaStr Programs",
    ...
    },
    {
      ...
      body: email([
        ...
        sectionTitle("Format"),
        bullet(
          "Pre-standup: drop your update in <code>#eng-standup</code> bot thread by 9:45 AM.",
        ),
        bullet(
          "9:55-10:00 PT: Eng-standup bot publishes the digest in <code>#eng-all</code>.",
        ),
        bullet(
          "10:00-10:15 PT: live discussion of anything that needs sync, not just a re-read of the digest.",
        ),
        sectionTitle("Where"),
        keyValBlock([
          {
            label: "Video",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">meet.zoom.us/j/812-44-901</a>`,
          },
        ...
        bullet(
          "Marcus shipping pgvector cutover Wednesday - flag any concerns today.",
        ),
        bullet("Two PRs need review by EOD (Marcus #412, Nathan #418)."),
        bullet(
          "Aria + Marcus on DataPipe call at 10 AM (right after standup).",
        ),
        ctaRow([
          ctaButton("Join Zoom", { color: "#1a73e8" }),
          ctaButton("Drop async update", {
            color: "#1a73e8",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Recurring daily on weekdays. Cancellation = use the recurring-event override in Calendar. If you'll be late, drop in #eng-standup so people aren't waiting.",
        ),
        companyEmailFooter("Calendar"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        logRow("May 17", "First attempt - declined (insufficient_funds)", {
          tone: "danger",
        }),
        ...
        logRow("May 24", "Subscription paused if all retries fail", {
          tone: "warn",
        }),
    ...
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("View usage by API key", {
            color: "#10a37f",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Org: VectorMail Eng · Billing email: finance@vectormail.app · Cycle: May 1 - May 31",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          `<strong>1M-token context window</strong> for both Opus and Sonnet. Retrieval quality at full context is meaningfully better than 4.6's 200K (see the long-context retrieval benchmarks in the model card).`,
        ),
        bullet(
          `<strong>Improved tool use.</strong> Multi-step agentic workflows are noticeably more reliable - fewer 'forgot to call the tool' failures and better recovery when tools return unexpected outputs.`,
        ),
        bullet(
          `<strong>Lower latency.</strong> Sonnet 4.7 is significantly faster at the same quality. Opus 4.7 maintains 4.6's latency profile while improving quality.`,
        ),
        bullet(
          `<strong>Same pricing, same API surface.</strong> No migration cost - just change the model string.`,
        ),
        ...
        ctaRow([
          ...
          ctaButton("View model card", {
            color: "#cb785c",
            variant: "outline",
          }),
          ctaButton("Migration guide", {
            color: "#cb785c",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Gmail",
            value: "47.2 GB · large attachments + 4 years of email",
          },
          {
            label: "Drive",
            value: "32.8 GB · primarily docs + shared folders",
          },
        ...
        fineprint(
          "If you hit 100%, you have 14 days to upgrade or clean up before mail delivery is suspended. After 2 years over the limit, content is removed by Google.",
        ),
        companyEmailFooter("Google"),
      ]),
    ...
    },
    {
      ...
      hour: 13,
      snippet:
        "Pushing for full team rollout. Need a Team plan quote for 22 seats.",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          ...
          {
            label: "Seats",
            value: "22 (might grow to 30 in Q3 if hiring goes per plan)",
          },
          ...
          {
            label: "Volume discount",
            value: "Whatever your standard for 20+ is",
          },
        ]),
        sectionTitle("Three asks alongside the contract"),
        bullet(
          "<strong>API access addendum.</strong> We want programmatic access for our internal integrations. Do you have a standard API addendum we can sign at the same time as the MSA, or is that a separate negotiation?",
        ),
        bullet(
          "<strong>Pricing lock</strong> for the first 12 months - no mid-year increases.",
        ),
        bullet(
          "<strong>Account-management contact</strong> - we'd appreciate Aria specifically as our primary contact post-signing if she's available.",
        ),
        sectionTitle("Timeline I'm targeting"),
        p(
      ...
      summary:
        "Customer expanding to 22 seats. Action: send Team plan quote + API addendum.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        ctaRow([
          ...
          ctaButton("View all comments", {
            color: "#ff6719",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Substack · 'VectorMail Founder Thoughts' · 2,200 subscribers · responses to comments boost engagement materially",
        ),
        companyEmailFooter("Substack"),
      ]),
    ...
    },
    {
      ...
      daysAgo: 6,
      snippet:
        "Standard speaker honorarium is $2,500. Wire instructions inside.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "<strong>Travel preferences</strong> · airline + hotel preferences",
        ),
        ctaRow([
          ctaButton("Sign W-9 via DocuSign", { color: "#0a2540" }),
          ctaButton("Submit wire info", {
            color: "#0a2540",
            variant: "outline",
          }),
        ]),
        fineprint(
          "If you're outside the US, we issue a 1042-S instead of a 1099 and may need additional withholding documentation. Reply if so.",
        ),
        hr(),
        signature(
          "Justin Park",
          "Speaker Operations · SaaStr Annual 2026",
          "programs@saastr.com",
        ),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>600+ founders</strong> · pre-seed through Series C · spanning consumer, B2B, fintech, AI, biotech",
        ),
        bullet(
          "<strong>Weekly office hours</strong> · with our partners, plus rotating guests (recent: Marisol Choi at Lattice, Ben Foulkes at Levels, Jasmine Park at NextRoom)",
        ),
        bullet(
          "<strong>Quarterly retreats</strong> · 2-day off-sites, ~80 founders, intentionally small",
        ),
        bullet(
          "<strong>Founder-to-founder lending</strong> · genuinely helpful resource for warm intros, customer feedback, and lessons learned",
        ),
        bullet(
          "<strong>Hiring help</strong> · our community has produced 4 hires for active members in the last quarter",
        ),
        sectionTitle("How it works"),
        bullet("100% free, no equity, no obligations"),
        bullet("Lightly moderated · no recruiters, no aggressive self-promo"),
        bullet(
          "Slack workspace, single global view, regional channels for SF/NYC/ATX/Remote",
        ),
        bullet(
          "Quarterly survey on community health (last quarter: 78% would recommend)",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Learn more first", {
            color: "#1a1a1a",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Invitation expires in 14 days. If you're not the right person on your team, please forward (one founder per company).",
        ),
        hr(),
        signature(
          "Backstage Capital",
          "Community team",
          "community@backstagecapital.com",
        ),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Suppress addresses that have hard-bounced 2+ times in the last 90 days (~640 records).",
        ),
        bullet(
          "Run the next list through Mailgun Validate before send - catches ~85% of invalid mailboxes pre-send.",
        ),
        bullet(
          "Re-confirm consent on the ~2,200 recipients who haven't engaged in 6+ months.",
        ),
        bullet(
          "If your next send is transactional, route it via the <code>transactional</code> domain instead of <code>marketing</code> to insulate that reputation.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Open reputation dashboard", {
            color: "#c02c2c",
            variant: "outline",
          }),
        ]),
      ...
      summary:
        "Mailgun: sender rep alert. Action: clean list before next send.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        headline(
          "TypeError in /api/inbox - 14 events, 8 users in the last hour",
        ),
        p(
        ...
        keyValBlock([
          {
            label: "Commit a4f2e91",
            value: `marcus · feat(search): parallel embedding fetch`,
          },
          {
            label: "Commit 9d3b7c2",
            value: `elena · refactor: account-scoped email reading`,
          },
        ...
        ctaRow([
          ctaButton("Open in Sentry", { color: "#7553ff" }),
          ctaButton("Assign to someone else", {
            color: "#7553ff",
            variant: "outline",
          }),
        ...
        fineprint(
          "Issue ID: VMAI-184 · Alert rule: high-frequency-new-issue · Assignee: you (auto)",
        ),
        companyEmailFooter("Sentry"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "If not resolved by 12:42 AM (60 min), auto-escalates to secondary on-call (you)",
        ),
        bullet(
          "If still not resolved by 1:42 AM, auto-escalates to Dana (eng lead)",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Join #incident-142", {
            color: "#06ac38",
            variant: "outline",
          }),
        ]),
        fineprint(
          "PagerDuty schedule: vectormail-prod · Marcus is primary · You are secondary · Dana is eng-lead. SLAs and on-call rotations can be edited in PagerDuty settings.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            ...
            value:
              "Following up on Jamal's intro - interested in learning about VectorMail and where you might be hiring.",
          },
          {
            label: "Why now?",
            value:
              "Leaving Anthropic in 2 weeks, exploring opportunities in AI-native product roles.",
          },
          {
            label: "What I'd like to discuss",
            value:
              "Product surface + scope, the customer base, where the team is biggest gap in product capacity.",
          },
          {
            label: "Time preference",
            value: "Mornings work best for me - I'm a slow afternoon thinker.",
          },
        ]),
        sectionTitle("Suggested prep"),
        bullet(
          "Look at her Anthropic API platform work - most of it is publicly traceable through their docs and announcements.",
        ),
        bullet(
          "Read Jamal's intro email again (you have it in your inbox) for his framing.",
        ),
        bullet(
          "Have a clear answer to 'where would I sit in your product org' - she'll ask within 5 min.",
        ),
        ctaRow([
        ...
        fineprint(
          "Booking flow: 30-min intro · auto-confirmed · Zoom link sent to both sides. Reminders auto-fire 1 day before + 1 hour before.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Evidence due",
            value: "Sunday, May 25, 2026 · 11:59 PM UTC",
          },
          { label: "Dispute ID", value: "dp_1Pc9aE2eZvKYlo2C" },
        ]),
        sectionTitle("Evidence Stripe recommends submitting"),
        bullet(
          "Receipt for the charge (Stripe can attach this automatically).",
        ),
        bullet(
          "Proof the customer accessed VectorMail (login timestamps, feature usage logs).",
        ),
        bullet(
          "Communication with the customer (any support emails or in-app messages).",
        ),
        bullet(
          "Refund / cancellation policy and a screenshot of where it was disclosed.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Accept the dispute", {
            color: "#80868b",
            variant: "outline",
          }),
          ctaButton("View customer history", {
            color: "#635bff",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Footer trust signals: added Brightlane, Castleworks, Northglade logos (all approved).",
        ),
        bullet(
          "Feature copy on Buddy: tightened from 4 sentences to 2 with the same payload.",
        ),
        bullet(
          "Mobile-only hero: shorter headline variant (testing showed mobile users churn at the 5-line headline).",
        ),
        bullet("Compliance footer: SOC 2 Type II badge moved above the fold."),
        sectionTitle("How to comment"),
        bullet(
          `Doc: <a href="#" style="color: #1a73e8; text-decoration: none; font-weight: 500;">Marketing v3 copy</a> in the shared drive`,
        ),
        bullet("Comments inline; we'll resolve by EOW"),
        bullet(
          "Tuesday EOD is the hard cut - we want Wednesday ship for the experiment to land before Memorial Day weekend",
        ),
        ctaRow([
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Joint blog post.</strong> The 'how we use each other' angle - your team uses Linear; we use VectorMail. Could be a Substack-style essay (4-5K words) or a tighter how-we-work piece (1,500 words). Both perform well in our audience.",
        ),
        bullet(
          "<strong>Joint webinar.</strong> 45-60 min live, with audience Q&A. Strong for top-of-funnel - but only works if both teams commit to promotion (yours is 2x bigger so we'd lean on you a bit).",
        ),
        bullet(
          "<strong>Joint customer story.</strong> If we have a customer that's both Linear + VectorMail, we could do a 3-way case study. I'd guess Brightlane or Castleworks fits - happy to check.",
        ),
        bullet(
          "<strong>Bundle / cross-promo.</strong> Not as exciting from a content perspective, but the deepest pre-existing relationships convert.",
        ),
        ...
        bullet(
          "60 min webinar · live + recorded · both sides promote to email lists + social",
        ),
        bullet(
          "Expected reach: ~5K live, ~30K via recording (per your audience size + ours)",
        ),
        bullet(
          "Production: I have someone on my side who can run the tech, or we use Zoom Webinars",
        ),
        bullet("Topic + speakers locked by July 1 if we're shipping mid-July"),
        p(
          "30-min scoping call sounds good - I'm holding Tuesday 2 PM PT and Wednesday 10 AM PT next week. Either work?",
        ),
        hr(),
        signature(
          "Owen Wright",
          "Head of Partnerships · Linear",
          "owen@linear.app",
        ),
      ]),
      summary:
        "Linear open to co-marketing in Q3. Action: propose joint webinar/blog.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>20 minutes max</strong> · 5 min context, 10 min Q&A, 5 min buffer",
        ),
        bullet(
          "Phone or video, your call. I personally prefer phone - less performative.",
        ),
        bullet("I always cover three things, in this order:"),
        bullet(
          "&nbsp;&nbsp;&nbsp;&nbsp;1) <strong>What we use VectorMail for + the specific outcomes</strong>",
        ),
        bullet(
          "&nbsp;&nbsp;&nbsp;&nbsp;2) <strong>What was painful in the first 30 days</strong> - honest answer, with the caveats",
        ),
        bullet(
          "&nbsp;&nbsp;&nbsp;&nbsp;3) <strong>Would I buy it again? Why?</strong>",
        ),
      ...
      summary:
        "Existing customer agreed to give reference call. Action: connect with Northwind.",
      labels: [labelImportant],
      read: true,
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Cover + executive summary</strong> · 2 slides · the 'one slide if they only read one' synthesis",
        ),
        bullet(
          "<strong>Q1 KPIs vs plan</strong> · 5 slides · ARR, NRR, activation, retention, sales pipeline",
        ),
        bullet(
          "<strong>April update</strong> · 4 slides · how the trends evolved post-Q1 close",
        ),
        bullet(
          "<strong>Hiring</strong> · 4 slides · Q2 plan, Q3 ask, retention metrics",
        ),
        bullet(
          "<strong>Customer wins + pipeline</strong> · 6 slides · logos, expansion, big-deal health",
        ),
        bullet(
          "<strong>Product</strong> · 4 slides · Q2 shipped, Q3 themes, the pgvector cutover",
        ),
        bullet(
          "<strong>Finance</strong> · 5 slides · burn, runway, cash position, raise scenarios",
        ),
        bullet(
          "<strong>Risks + asks</strong> · 4 slides · what we want the board to weigh in on",
        ),
        bullet(
          "<strong>Appendix</strong> · 4 slides · cohort retention, cap table, customer health detail",
        ),
        sectionTitle("Three asks for the board this quarter"),
        bullet("Approve hiring plan expansion (+3 heads in Q3)"),
        bullet(
          "Authorize $250K SVB bridge facility (already vetted by counsel)",
        ),
        bullet("Adopt the revised option grant guidelines for executive hires"),
        sectionTitle("Open items / known gaps"),
        bullet(
          "Customer-of-the-month slide - need a quote from Brightlane (Aria is chasing)",
        ),
        bullet(
          "April churn analysis - Finance to finalize Monday after the May close",
        ),
        bullet(
          "Updated comp benchmark data for the option grant slide - Lina pulling Tuesday",
        ),
        ctaRow([
          ctaButton("Open the deck", { color: "#1F3A2E" }),
          ctaButton("Comment template", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Past performance: last quarter's deck went 3 rounds of revision; let's aim for 2 this time. Final must be ready Tuesday for board distribution Wednesday.",
        ),
        hr(),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Cash balance</strong> in linked Mercury account: $4.13M operating + $2.40M treasury · supports significantly higher daily float",
        ),
        bullet(
          "<strong>Historical usage</strong>: average $18.4K/mo over last 6 months · room to grow without raising risk",
        ),
        bullet(
          "<strong>Payment history</strong>: 100% on-time auto-pay · zero declines · zero disputes",
        ),
        bullet(
          "<strong>Account tenure</strong>: 18 months · seasoned customer",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Request higher limit", {
            color: "#0f0f0f",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Brex automatically re-evaluates limits quarterly based on account health. Your next review: August 17, 2026.",
        ),
        companyEmailFooter("Brex"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        logRow(
          "May 16 · 9:18 AM",
          "+ $45,000.00 · Wire from Brightlane Holdings · INV-0091",
          { tone: "ok" },
        ),
        logRow(
          "May 16 · 2:42 PM",
          "− $187,420.00 · Payroll · Gusto (14 employees)",
          { tone: "info" },
        ),
        logRow("May 16 · 4:18 PM", "− $895.00 · Datadog · INV-22918", {
          tone: "info",
        }),
        logRow(
          "May 16 · 5:30 PM",
          "− $1,344.00 · Notion · scheduled annual renewal",
          { tone: "info" },
        ),
        logRow("May 16 · 11:59 PM", "− $4,210.00 · AWS · April bill (sweep)", {
          tone: "info",
        }),
        ...
        keyValBlock([
          ...
          {
            label: "Operating · payroll sweep · ••8104",
            value: "$0.00 (drained May 15)",
          },
        ...
        bullet(
          "May 19 · Stripe payout cycle (~$184K expected from May volume).",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Daily reports settings", {
            color: "#0f1c3f",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "To reclaim lead",
            value: "$4,300 minimum (next increment)",
          },
        ...
        bullet(
          "<strong>inboxbrain.ai</strong> · 11 letters · clean, brandable, no hyphens",
        ),
        bullet(
          "Premium .ai TLD · steady price appreciation (Squadhelp .ai average is up 34% YoY)",
        ),
        bullet("Trademark check: clean (we ran it for you when you bid)"),
        bullet(
          "Estimated brand value: $8K-15K based on comparable Squadhelp sales",
        ),
        sectionTitle("Your options"),
        bullet(
          "<strong>Bid again at $4,300+</strong> · keep the auction alive · increases by $100 minimum",
        ),
        bullet(
          "<strong>Walk away</strong> · auction continues without you · we'll refund your earnest money",
        ),
        bullet(
          "<strong>Make a private offer to current high bidder</strong> · sometimes works for under-the-radar deals",
        ),
        ctaRow([
          ctaButton("Bid $4,300", { color: "#3aaee0" }),
          ctaButton("Bid custom amount", {
            color: "#3aaee0",
            variant: "outline",
          }),
          ctaButton("Withdraw from auction", {
            color: "#80868b",
            variant: "outline",
          }),
        ]),
        fineprint(
          "If you withdraw, your earnest money is refunded within 3 business days. If you win, you have 7 days to complete payment via wire or ACH; we handle the transfer to your registrar.",
        ),
    ...
    },
    {
      ...
      daysAgo: 4,
      snippet:
        "Happy to be featured. Can we review the case study before publish?",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "<strong>Can we review the draft before it goes live?</strong> Two reasons: (1) confirm the metrics you cite are still accurate, (2) make sure my quotes don't accidentally leak anything sensitive (our internal usage data is fair game; our customer names are not).",
        ),
        bullet(
          "<strong>I'll aim for a 24-hour turnaround</strong> when you send it. Anything urgent flagged in my inbox gets through fast.",
        ),
        sectionTitle("What I'd be comfortable saying publicly"),
        bullet(
          "Specific time-saved metrics from our team (we tracked it for 60 days; the data is real and impressive)",
        ),
        bullet(
          "Why we switched from our prior tool (you can name the prior tool if you'd like)",
        ),
        bullet("How we onboarded the team (the playbook is replicable)"),
        bullet(
          "Specific quotes from me and from 1-2 of my engineers (with their permission)",
        ),
        sectionTitle("What I'd prefer we don't disclose"),
        bullet(
          "Our seat count specifically (the range '50-100' is fine; the exact number is not)",
        ),
        bullet(
          "Names of specific Brightlane customers we're emailing (privacy)",
        ),
        bullet(
          "The exact contract value (the ARR range is fine in general; the per-seat negotiated price isn't)",
        ),
      ...
      summary:
        "Brightlane case study consent (review required). Action: send draft for review.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      hour: 7,
      snippet:
        "Your auto-triage this week: 14 archived, 3 snoozed, 7 surfaced.",
      body: email([
        ...
        metricGrid([
          {
            label: "Auto-archived",
            value: "14",
            sub: "newsletters, receipts, alerts",
          },
          { label: "Snoozed", value: "3", sub: "for later this week" },
          {
            label: "Surfaced for you",
            value: "7",
            sub: "needed reply or decision",
          },
        ...
        bullet(
          "<strong>Investor threads</strong> consistently surfaced in <em>Important · Needs Reply</em> (your engagement rate: 100%, median response time 4.2 hours).",
        ),
        bullet(
          "<strong>Receipts + notifications</strong> auto-archived at 96% accuracy this week. The 4% we got wrong: 2 Stripe alerts that needed manual triage (we've adjusted the model).",
        ),
        bullet(
          "<strong>Sales/inbound</strong> messages all got drafted replies with consistent voice. You sent 7 of 8 without changes - strongest reply-quality week we've measured.",
        ),
        sectionTitle("What Buddy got wrong this week"),
        bullet(
          `Snoozed Sophia's customer-story email for 'next week' when it would have been better to surface immediately. Adjusted weight on 'sender = engaged customer' in the snooze model.`,
        ),
        bullet(
          `Drafted a reply to TechCrunch press inquiry that was too casual. You significantly edited it. We've added 'press inquiry' as a higher-formality category.`,
        ),
        ...
        signature(
          "Buddy",
          "Your AI inbox · VectorMail",
          "summary@vectormail.app",
        ),
      ]),
    ...
    },
    {
      ...
      daysAgo: 7,
      snippet:
        "Heard great things. Open to a quick coffee on your next NYC trip?",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "<strong>Joe Coffee · Pro Building</strong> · convenient if you're south of 23rd",
        ),
        bullet(
          "<strong>Devoción · Williamsburg</strong> · if you want a longer slot and the walk",
        ),
    ...
    },
    {
      ...
      daysAgo: 4,
      snippet:
        "Lenny wants to feature your team on a webinar about AI-native product orgs.",
      body: email([
        p("Hi,"),
        p(
        ...
        keyValBlock([
          {
            label: "Length",
            value: "60 minutes · 45 conversation + 15 live Q&A",
          },
          {
            label: "Format",
            value: "Lenny moderates · you + one other founder respond",
          },
          {
            label: "Audience size",
            value: "~5,000 live · ~30,000-50,000 via recording",
          },
          {
            label: "Distribution",
            value: "Newsletter (170K), YouTube, Spotify, Apple Podcasts",
          },
          { label: "Length to record", value: "75 min (we pad for re-takes)" },
        ]),
        sectionTitle("What we'll cover"),
        bullet(
          "How you structured the product org from day 1 (what worked, what didn't)",
        ),
        bullet(
          "PM ↔ engineering ratios in AI-native companies (you have data; Lenny loves data)",
        ),
        bullet(
          "How AI changes the day-to-day of product work (concrete examples requested)",
        ),
        ...
        bullet(
          "Lenny's audience is exactly your future customer base (founders + heads of product at growing startups)",
        ),
        bullet(
          "Past guest companies see 200-400 inbound trial signups in the 30 days post-publish",
        ),
        bullet(
          "It's 75 minutes of your time for ~30K founders to hear your story directly",
        ),
        bullet(
          "Past guests we've featured include Marty Cagan, Teresa Torres, and a recent rotation of AI-native founders",
        ),
        p(
          "Confirm a date and we'll send the pre-call agenda + technical setup details.",
        ),
        hr(),
        signature(
          "Marisol Reyes",
          "Production · Lenny's Podcast & Webinars",
          "podcast@lennysnewsletter.com",
        ),
      ]),
      ...
      body: email([
        ...
        metricGrid([
          ...
          { label: "Expansion ARR", value: "$30K", sub: "Brightlane" },
          {
            label: "New logos",
            value: "3",
            sub: "Castleworks, Northglade, +1",
          },
        ]),
        sectionTitle("What drove new ARR this week"),
        bullet(
          "<strong>Brightlane expansion · $30K</strong> · 50 → 75 seats · annual prepay · signed Tuesday",
        ),
        bullet(
          "<strong>Castleworks new · $9.6K</strong> · 8-seat trial → annual · signed Friday",
        ),
        bullet(
          "<strong>Northglade new · $7.1K</strong> · 6-seat team plan · annual",
        ),
        bullet(
          "<strong>Two self-serve upgrades</strong> · $65K combined · annual",
        ),
        sectionTitle("Churn detail"),
        bullet(
          "<strong>Code For Good</strong> · $4K ARR · non-profit shutting down (sad, but not preventable)",
        ),
        bullet("No other churn this week"),
        sectionTitle("Pipeline forecast (next 14 days)"),
        bullet(
          "<strong>Northwind POC kickoff</strong> · ~$300K ARR if it converts (June close)",
        ),
        bullet(
          "<strong>startup.io expansion</strong> · ~$26K · Jordan moving forward",
        ),
        bullet(
          "<strong>~6 self-serve mid-funnel</strong> · expected $20-30K total",
        ),
        ctaRow([
          ctaButton("Open ARR dashboard", { color: "#1F3A2E" }),
          ctaButton("Drill into expansion", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Auto-generated Sundays at 7 AM PT. Data fresh through Saturday 11:59 PM PT. Source: Stripe + our internal ARR pipeline.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Current role",
            value: "VP Engineering · Bloom Health · Series C health-tech",
          },
          {
            label: "Team size she manages",
            value: "62 engineers · 5 directors reporting to her",
          },
          {
            label: "Previous",
            value:
              "Director Eng at Stripe (3y) · Staff Eng at Square (2y) · early Brex",
          },
          {
            label: "Notable past projects",
            value: "Stripe Identity launch · Square Online launch",
          },
          {
            label: "Why she's leaving",
            value:
              "Confidential - but the short version is leadership change at Bloom doesn't match her values",
          },
          {
            label: "Open to roles",
            value: "VP Eng at smaller Series A/B AI-native companies",
          },
        ]),
        sectionTitle("Why I'm flagging her specifically"),
        bullet(
          "Her background is exactly what we'd want for our future VP Eng (Q3-Q4 2026 hire target per the original plan)",
        ),
        bullet(
          "She built and ran two ship-from-scratch teams (Stripe Identity, Square Online) - that's the muscle we need next",
        ),
        bullet(
          "Her old reports describe her as 'unusually low-ego' - the most consistent feedback in her references",
        ),
        bullet(
          "She has explicit AI experience (Bloom Health's clinical-decision-support product uses Claude heavily)",
        ),
        bullet(
          "If she does move, she'll have at least 3 offers within 2 weeks - opportunity-cost of slow play is high",
        ),
        sectionTitle("Risk to be aware of"),
        bullet(
          "Her current comp is reportedly ~$520K cash + significant Bloom equity. We'd need to be at the top of our band to be competitive.",
        ),
        bullet(
          "She's not formally on the market - so any conversation needs to be confidential from the start",
        ),
        sectionTitle("What I'd propose"),
        p(
        ...
        p(
          "Reply with your read on the resume and whether the coffee is worth doing.",
        ),
        hr(),
        signature(
          "Dana Howe",
      ...
      summary:
        "VP Eng candidate resume forward. Action: review and align with Dana.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Title",
            value:
              "AI for productivity · who wins, what's broken, what's overhyped",
          },
          {
            label: "Format",
            value: "45-min moderated panel + 10 min audience Q&A",
          },
          { label: "Date", value: "Tuesday, September 23, 2026" },
          { label: "Time", value: "2:30 PM - 3:25 PM PT" },
          {
            label: "Venue",
            value: "Yerba Buena Center for the Arts, San Francisco",
          },
          {
            label: "Audience",
            value: "~1,400 in-person · livestream + post-event recording",
          },
        ...
        bullet(
          "swyx prepares 8-10 sharp questions in advance, sends them 5 days before",
        ),
        bullet(
          "Strong opinions are encouraged · panels work when panelists disagree productively",
        ),
        bullet(
          "No PR talking points - the audience will spot them and the social-media chatter post-event punishes them",
        ),
        sectionTitle("Honorarium + logistics"),
    ...
    },
    {
      ...
      body: email([
        brandBlock("Anthropic"),
        headline(
          "You've been added to the 'VectorMail Eng' Anthropic Console organization",
        ),
        p(
        ...
        bullet(
          "Manage spending limits and view real-time usage across the org",
        ),
        bullet("Add/remove team members and adjust their roles"),
        bullet("View 90-day audit log of all API and dashboard activity"),
        bullet(
          "Switch between Claude Opus, Sonnet, and Haiku model tiers without ticket",
        ),
        sectionTitle("Recommended first actions"),
        bullet(
          "Enable MFA on your account (admin-level access without MFA is a soft policy violation)",
        ),
        bullet(
          "Confirm your API keys are stored in 1Password rather than env files",
        ),
        bullet(
          "Review billing/usage limits - they default lower than what most production accounts need",
        ),
        ctaRow([
        ...
        fineprint(
          "Admin role is the highest-privileged tier. Treat with appropriate care. You can be downgraded to Developer by any other admin if needed.",
        ),
        companyEmailFooter("Anthropic"),
      ]),
    ...
    },
    {
      ...
      hour: 16,
      snippet:
        "Save call went well. Loop AI committing to renew for 12 months.",
      body: email([
        headline(
          "Loop AI save call · renewed 12 months · no discount required",
        ),
        p(
        ...
        bullet(
          "Their previous VP Ops (who had been our champion + DAU driver) left April 3 for another company",
        ),
        bullet(
          "New ops lead (Sarah Park) wasn't onboarded to VectorMail by her predecessor - she defaulted back to native Gmail because no one walked her through the value",
        ),
        bullet(
          "Once we showed Sarah a 15-minute walkthrough, she immediately got it - 'oh, this is why everyone here was so attached to it'",
        ),
        bullet(
          "The 'low DAU = churn risk' signal was correct but the diagnosis was wrong - they didn't lose interest, they lost continuity",
        ),
        sectionTitle("What's happening next week"),
        bullet(
          "<strong>Tuesday 10 AM PT:</strong> 1-hour refresher session for Loop AI's team led by Sarah and me. 12 people invited (every active seat).",
        ),
        bullet(
          "<strong>Wednesday:</strong> Personalized briefs setup workshop with the 4 power users (one tier above what we usually offer; one-time goodwill gesture)",
        ),
        bullet(
          "<strong>Friday:</strong> Renewal contract signed. Pulley confirmed it's locked in our queue.",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Video",
            value: `<a href="#" style="color: #1a73e8; text-decoration: none;">brightlane.zoom.us/j/qbr-4128</a>`,
          },
          {
            label: "Brightlane attendees",
            value: "Sophia (VP Eng) · Tomas (CFO) · Maya (CIO)",
          },
          {
            label: "Our attendees",
            value: "You + Aria + Marcus (technical Q&A if needed)",
          },
        ...
        logRow(
          "10:00 - 10:10",
          "Account health snapshot - usage, sentiment, key wins · Aria",
          { tone: "info" },
        ),
        logRow(
          "10:10 - 10:25",
          "Brightlane's Q2 outcomes from VectorMail · Sophia + Aria",
          { tone: "info" },
        ),
        logRow(
          "10:25 - 10:40",
          "Product roadmap preview - what's coming in Q3 · you",
          { tone: "info" },
        ),
        logRow("10:40 - 10:55", "Renewal terms confirmation · Tomas + you", {
          tone: "warn",
        }),
        logRow("10:55 - 11:00", "Open Q&A + wrap", { tone: "info" }),
        sectionTitle("Key decisions to land"),
        bullet(
          "Confirm Brightlane is signing the expansion + 12-month price lock (their procurement team has been quiet, want explicit yes)",
        ),
        bullet(
          "Get verbal commitment on the customer-story participation (Sophia signed off in email; want it in front of Tomas too)",
        ),
        bullet(
          "Surface our Q3 priorities to align with their Q3 hiring + product plans",
        ),
        sectionTitle("Risks I want surfaced before the call"),
        bullet(
          "Slack Connect channel got paused 24 hours ago - flag in this thread so we know if it's about anything we should address",
        ),
        bullet(
          "Aria heard their procurement team is slow this quarter; confirm contracts can sign by Tuesday EOD",
        ),
        ctaRow([
          ctaButton("Yes", { color: "#0caa41" }),
        ...
        fineprint(
          "Calendar reminder · 24 hours before this event auto-resends · QBR deck linked in this thread; please skim by Friday EOD if you haven't",
        ),
        companyEmailFooter("Calendar"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Direct quote, attributed to you with title (founder & CEO, VectorMail)",
        ),
        bullet(
          "Used in the 'where this category goes' section toward the end of the piece",
        ),
        bullet(
          "Anything you say is on the record - you've seen me work, you know my style",
        ),
        bullet(
          "If you want to revise after the call, that's fine; I won't publish a version you haven't seen",
        ),
      ...
      summary:
        "Reporter quote follow-up. Action: send 1-2 sentence quote today.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Form type",
            value: "1099-K (third-party network reporting)",
          },
          ...
          {
            label: "Filed with",
            value: "IRS · automated · postmarked February 28, 2026",
          },
          {
            label: "State copies",
            value: "California (we sent), all others (you'll handle)",
          },
        ]),
        sectionTitle("What this is (and what it isn't)"),
        bullet(
          "<strong>What it is:</strong> Gross volume - what was charged on cards processed through Stripe, before fees, refunds, or chargebacks.",
        ),
        bullet(
          "<strong>What it isn't:</strong> Net revenue. Your actual taxable income is gross minus fees minus refunds minus chargebacks; your accountant calculates this.",
        ),
        bullet(
          "<strong>What you do with it:</strong> Forward to your accountant. Pilot.com (your bookkeeper) can ingest it directly if you give them dashboard access.",
        ),
        ...
        fineprint(
          "If you spot a discrepancy on the 1099-K, contact Stripe Support before filing - corrections take 5-10 business days and we can issue a corrected 1099-K if needed.",
        ),
        companyEmailFooter("Stripe"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Customer story · Brightlane</strong> · 5 edits · Marketing",
        ),
        ...
        bullet(
          "<strong>Marcus asked you</strong> in 'pgvector RFC' · 2 days ago",
        ),
        bullet(
          "<strong>Aria tagged you</strong> in 'Customer story · Brightlane' · 3 days ago",
        ),
        bullet(
          "<strong>Marketing tagged you</strong> in 'Landing copy v3' · 3 days ago",
        ),
        ...
        ctaRow([
          ...
          ctaButton("View all activity", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Weekly digest · sent Sundays at 8 AM PT · adjust frequency in Notion → Settings → Notifications",
        ),
        companyEmailFooter("Notion"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Your view of the AI-inbox category - where the moats actually are vs. where they're hyped",
        ),
        bullet(
          "Your founding thesis + how it's evolved through customer feedback",
        ),
        bullet(
          "Your 24-month roadmap (publicly tellable parts; we'll do this under NDA if needed)",
        ),
        bullet(
          "How BlueOcean's distribution network might complement or compete with your wedge",
        ),
        sectionTitle("Why we'd want this conversation even if nothing happens"),
        bullet(
          "Helps us calibrate where we'd build internally vs. where we'd partner vs. where we'd acquire",
        ),
        bullet(
          "Builds the relationship in case it becomes relevant in 12-24 months",
        ),
        bullet(
          "You get a real strategic conversation with someone outside your investor base",
        ),
        bullet(
          "Both sides walk away with calibration about the other's positioning",
        ),
        ...
        sectionTitle("Logistics"),
        bullet(
          "45 minutes · Zoom · I'll send the calendar invite once you confirm",
        ),
        bullet(
          "Available windows in the next two weeks: May 22 (afternoon), May 28 (morning), June 3 (any time)",
        ),
        bullet(
          "Happy to do dinner instead if you're in NYC any time soon - Eliot's preference",
        ),
        p(
        ...
        signature(
          "Eliot Marsh",
          "Corporate Development · BlueOcean Corp",
          "eliot@blueoceancorp.com",
        ),
      ]),
      summary:
        "M&A inbound (BlueOcean). Action: decide whether to take the call - loop in counsel first.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          { label: "When", value: "Friday, May 22 · 7:00 PM - 10:00 PM PT" },
          {
            label: "Where",
            value:
              "Private room · Saison · 178 Townsend St (close to your office)",
          },
          { label: "Dress", value: "Smart casual" },
          {
            label: "Cost",
            value: "I'm covering · founder dinner gift from Growth Collective",
          },
          {
            label: "Off the record?",
            value: "Yes - Chatham House rules · nothing leaves the room",
          },
        ]),
        sectionTitle("Who's in the room"),
        bullet("Marisol Choi (Lattice, recently IPO'd)"),
        bullet(
          "Carter Liu (Northglade - and you'd recognize each other since you just signed them)",
        ),
        ...
        bullet(
          "Plus me, plus the room is open for one more - which is where you come in",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "<strong>Root cause identified.</strong> Their sync delays were caused by a <em>misconfigured webhook endpoint on their side</em> (firewall added two weeks ago was throttling our webhook deliveries). Not a VectorMail bug at all.",
        ),
        bullet(
          "<strong>Engineering patched it on the call.</strong> Marcus joined for the technical portion, walked Roberto's team through what we were seeing, identified the firewall rule, and they fixed it in real time.",
        ),
        bullet(
          "<strong>CTO said 'this is why we picked you.'</strong> Roberto explicitly: we showed up with diagnostics, we explained what we were seeing, we joined the troubleshooting call. That's the value he was hoping for when he signed.",
        ),
        bullet(
          "<strong>Renewal moved forward.</strong> Their 12-month renewal (was scheduled for August) is now signed and dated today. Annual prepay. $42K ARR locked in.",
        ),
        sectionTitle("What I'd take from this"),
        bullet("Save calls work when we show up with data, not apologies."),
        bullet(
          "Engineering presence on customer escalation calls is often the deciding factor. Worth the time cost.",
        ),
        bullet(
          "Their internal Slack channel '#vectormail-watch' is now '#vectormail-love.' Same group, different vibe.",
        ),
        sectionTitle("Follow-ups assigned"),
        bullet(
          "Marcus drafting a 'troubleshooting webhook delivery' runbook so we catch this pattern faster next time.",
        ),
        bullet(
          "Aria sending a one-pager on common firewall configurations to all enterprise customers as preemptive education.",
        ),
        bullet(
          "Marketing including the DataPipe story (with permission) in next month's case-study cycle.",
        ),
        p(
          "Great recovery. Touch grass and go home for the weekend - earned it.",
        ),
        hr(),
        signature(
          "Aria Lawson",
    ...
    },
    {
      ...
      daysAgo: 6,
      snippet:
        "Considering you for 30 Under 30. Need short answers to 5 questions.",
      body: email([
        p("Hi,"),
        p(
        ...
        sectionTitle("How it works"),
        bullet(
          "<strong>Long list (now):</strong> ~120 founders we're considering · I need short answers to 5 questions from each.",
        ),
        bullet(
          "<strong>Editorial committee (mid-June):</strong> We narrow to ~50 finalists based on the responses + our independent research.",
        ),
        bullet(
          "<strong>Final 30 (early July):</strong> Notified privately. Public list goes live mid-September with the print issue.",
        ),
        bullet(
          "<strong>What you get if selected:</strong> Print + digital coverage in Forbes (significant), a 30U30 invite-only summit, and ongoing alumni network access.",
        ),
        sectionTitle("Five questions · target Friday EOD"),
        bullet(
          "<strong>1. Founding story in 100 words.</strong> Why this company, why now.",
        ),
        bullet(
          "<strong>2. The most counterintuitive thing you've learned.</strong> 80 words. Forbes loves this question.",
        ),
        bullet(
          "<strong>3. Best metric showing momentum.</strong> A number with context. Real numbers are required.",
        ),
        bullet(
          "<strong>4. Three references we can cite.</strong> Customers, investors, or peers who'd vouch.",
        ),
        bullet(
          "<strong>5. What does 'big' look like for VectorMail in 5 years?</strong> 60 words. We're looking for ambition + specificity.",
        ),
        sectionTitle("Submission"),
        bullet("Reply with answers in this email"),
        bullet("Include a high-res headshot (≥1500×1500, professional)"),
        bullet(
          "Your responses are reviewed by 3 editors + our independent fact-checker",
        ),
        bullet(
          "If you make the final 30, we'll send a contributor agreement and a longer interview before press",
        ),
        ctaRow([
        ...
        fineprint(
          "Friday is the soft deadline. Send earlier if you want my editorial input on framing. Eligibility: under 30 as of January 1, 2026 (we'll verify).",
        ),
        hr(),
        signature(
          "Lucia Park",
          "Senior Editor · Forbes 30 Under 30",
          "lucia.park@forbes.com",
        ),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        metricGrid([
          ...
          {
            label: "Net change to fully diluted",
            value: "<0.01%",
            sub: "minor",
          },
        ]),
        ...
        bullet(
          "8 rounding errors in option grants (resolved to nearest share)",
        ),
        bullet(
          "3 missing 83(b) election flags (employees confirmed elections were filed; updated metadata)",
        ),
        bullet(
          "1 orphaned SAFE (eventually located the signed copy in old DocuSign vault; reattached)",
        ),
        bullet(
          "5 historical option grants that had been forfeited but not deactivated in Carta (deactivated; pool returned)",
        ),
        ...
        keyValBlock([
          { label: "Common stock outstanding", value: "9,200,000" },
          {
            ...
            value: "1,840,000 (Series A)",
          },
          {
            label: "SAFEs outstanding",
            value: "Daniel Brun ($500K) · Bryan Goldstein ($25K)",
          },
        ...
        bullet(
          "Detailed instrument log (every SAFE, option grant, and stock issuance)",
        ),
        ctaRow([
          ctaButton("Open Carta dashboard", { color: "#0a2540" }),
          ctaButton("Download exports", {
            color: "#0a2540",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Your cap table is now audit-ready for Series B-level diligence. The clean state is preserved with automated daily reconciliation going forward.",
        ),
        companyEmailFooter("Carta"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Commit",
            value: "ad7c2f1 · 'fix(search): null-safe label filter'",
          },
        ...
        logRow(
          "16:42 PT",
          "Marcus merged PR #441 → main · 'fix(search): null-safe label filter'",
          { tone: "info" },
        ),
        logRow("16:42 PT", "Vercel build triggered automatically", {
          tone: "info",
        }),
        logRow("16:47 PT", "Build failed · typecheck error", {
          tone: "danger",
        }),
        logRow("16:47 PT", "Marcus auto-notified via email + Slack", {
          tone: "info",
        }),
        sectionTitle("Suggested fix"),
        infoCard(
        ...
        ctaRow([
          ...
          ctaButton("Promote previous deploy", {
            color: "#000000",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Real friction points in the first 30-60 days - Sophia mentioned in your intro she'd be honest about these, which is exactly what my CFO needs to hear",
        ),
        bullet(
          "How the migration went specifically (we're coming from Microsoft Copilot + Superhuman; she's coming from Superhuman alone)",
        ),
        bullet(
          "Decision factors that made the difference between 'try' and 'commit at scale'",
        ),
        bullet(
          "How she'd describe the procurement experience (this is the call that probably decides things on our side)",
        ),
        ...
        bullet(
          "Move to final decision by Friday EOD if the call goes well (which I expect it will)",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Brightlane (8)",
            value: "Sophia Pereira (VP Eng) + 7 engineers from her three pods",
          },
          {
            label: "VectorMail (4)",
            value: "Aria (CS), Marcus (CTO), Nathan (eng), you (admin)",
          },
          { label: "Channel type", value: "Slack Connect (cross-org)" },
          {
            label: "Visibility",
            value:
              "Private to both organizations · external auditors cannot see",
          },
          {
            label: "Notifications",
            value: "Aria primary · we'll add a daily summary bot at 5 PM PT",
          },
        ]),
        sectionTitle("Channel guidelines (pinned)"),
        bullet(
          "<strong>Use for:</strong> bug reports, feature requests, quick questions, status check-ins",
        ),
        bullet(
          "<strong>Don't use for:</strong> formal customer support tickets (use the support portal), security/compliance (use your AM), contract questions (route to Legal)",
        ),
        bullet(
          "<strong>Response time:</strong> we aim for ~2 business hours during PT business hours; we'll set expectations explicitly",
        ),
        bullet(
          "<strong>Daily summary bot:</strong> we'll send a daily digest at 5 PM PT recapping the day's threads",
        ),
      ...
      body: email([
        ...
        keyValBlock([
          ...
          { label: "Time", value: "May 16, 2026 · 4:42 PM PT" },
          {
            ...
            value: "Category 'software' not on this card's allow list",
          },
          {
            label: "Fraud risk",
            value: "Low (known merchant, in-region, within velocity limits)",
          },
        ]),
        ...
        bullet(
          "<strong>Approve this specific charge</strong> · one-time override · charge gets processed in 30 seconds",
        ),
        bullet(
          "<strong>Add 'software' to the allow list</strong> · permanent, applies to future charges",
        ),
        bullet(
          "<strong>Have Marcus use the ops card instead</strong> · the way it was intended to work",
        ),
        ctaRow([
          ctaButton("Approve this charge", { color: "#0f0f0f" }),
          ctaButton("Adjust card policy", {
            color: "#0f0f0f",
            variant: "outline",
          }),
        ...
        fineprint(
          "Notion will retry the charge automatically every 24 hours for 3 days. After that, your subscription will be flagged as past due.",
        ),
        companyEmailFooter("Brex"),
      ]),
      summary:
        "Brex card declined. Action: adjust allow list or use different card.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "1. Senior Backend Engineer (L5)",
            value:
              "Already in motion · Nathan Wu offer out · target June 9 start",
          },
          {
            label: "2. Senior Backend Engineer (L5)",
            value: "Mei Lin in pipeline · target start: July 1",
          },
          {
            label: "3. Staff Engineer (L6)",
            value: "Sourcing now · target start: August 4",
          },
          {
            label: "4. Senior Backend Engineer (L5)",
            value:
              "Replacement for upcoming maternity leave · target start: July 14",
          },
          {
            label: "5. Customer Success Manager",
            value: "Reports to Aria · target start: July 1",
          },
          {
            label: "6. Customer Success Manager",
            value: "Backfill + capacity · target start: August 1",
          },
          {
            label: "7. Senior Product Designer",
            value: "Reports to Taylor · target start: August 11",
          },
          {
            label: "8. Marketing hire (level TBD)",
            value:
              "Will define with Lina after eng hires close · target start: September 1",
          },
        ]),
        sectionTitle("Comp bands locked"),
        bullet(
          "<strong>Senior Engineer (L5):</strong> $210K-235K base + 0.30-0.45% equity",
        ),
        bullet(
          "<strong>Staff Engineer (L6):</strong> $250K-285K base + 0.50-0.75% equity",
        ),
        bullet(
          "<strong>Senior CS Manager:</strong> $145K-165K base + 0.10-0.15% equity",
        ),
        bullet(
          "<strong>Senior Designer:</strong> $180K-200K base + 0.20-0.30% equity",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          `<strong>Elena Vargas</strong> · 'I'll do the dual-write piece. Plan is to mirror writes to both indexes for 7 days, decide on cutover after.'`,
        ),
        bullet(
          `<strong>Nathan Wu</strong> · 'Kill-switch makes sense. We can flip via env var, no deploy needed.'`,
        ),
        bullet(
          `<strong>Aria Lawson</strong> · 'CS impact looks minimal. I'll have the support runbook ready by 5.'`,
        ),
        bullet(
          `<strong>Marcus Liu</strong> · '+1, then we go at 6 PM. Cool with you @demo?'`,
        ),
        ctaRow([
          ctaButton("Reply in Slack", { color: "#4a154b" }),
          ctaButton("Open rollout doc", {
            color: "#1264a3",
            variant: "outline",
          }),
        ]),
      ...
      body: email([
        ...
        keyValBlock([
          { label: "Square footage", value: "~4,200 sq ft" },
          {
            label: "Layout",
            value:
              "28 dedicated desks · 2 phone rooms · kitchenette · meeting room",
          },
          { label: "Asking", value: "$42,000/month · 24-month lease" },
          {
            label: "Includes",
            value:
              "Furniture, conference room access (shared), high-speed internet, cleaning",
          },
          {
            label: "Does not include",
            value: "Coffee, lunches, mail handling (add-on services)",
          },
          { label: "Available", value: "June 1, 2026" },
          {
            label: "Move-in cost",
            value: "First + last month deposit ($84K) + $5K admin fee",
          },
        ]),
        sectionTitle("Suggested questions to ask during the tour"),
        bullet(
          "HVAC + comfort (4th floor faces south - afternoon sun is real)",
        ),
        bullet(
          "Internet speed + redundancy (most WeWork floors share a single 1Gbps line)",
        ),
        bullet(
          "Noise (Mission Street side has Muni traffic; ask about the kitchenette wall)",
        ),
        bullet("Security after-hours (badge-in, cameras, who has access)"),
        bullet(
          "Move-out provisions (early-termination penalty if you outgrow it before 24 months)",
        ),
        sectionTitle("Comparables I've shown you"),
        bullet(
          "<strong>500 Bryant</strong> · $39K/mo · slightly smaller, similar build · we toured last week",
        ),
        bullet(
          "<strong>600 California</strong> · $48K/mo · bigger but the location is worse for your team",
        ),
        bullet(
          "<strong>This one (535 Mission)</strong> · $42K/mo · best location-to-price · my pick if it shows well",
        ),
        p(
    ...
    },
    {
      ...
      body: email([
        headline(
          "Customer Success Q3 playbook · refreshed · open for comments",
        ),
        p(
        ...
        bullet(
          "New onboarding checklist (60-day version) · used for Northglade and refined",
        ),
        bullet(
          "CS-to-engineering loop · how we close it without bottlenecking either side",
        ),
    ...
    },
    {
      ...
      daysAgo: 9,
      snippet:
        "AI spend in May trending toward $11K. Driver: production embedding throughput.",
      body: email([
        ...
        bigStat("Projected May spend", "$10,840 · 57% over", {
          color: "#f59e0b",
        }),
        sectionTitle("Where it's going"),
        keyValBlock([
          ...
          {
            label: "OpenAI · GPT-4o-mini (Buddy)",
            value: "$2,400 · slightly above plan",
          },
        ...
        bullet(
          "<strong>1. Switch primary embedding model to text-embedding-3-small.</strong> Saves ~$3,500/mo. Quality drop measured at 1.8 pp on our eval set - at the edge of acceptable. Marcus's recommendation.",
        ),
        bullet(
          "<strong>2. Cap free-tier user search volume at 50/day.</strong> Saves ~$2,800/mo. Customer-facing change; needs PM input.",
        ),
        bullet(
          "<strong>3. Raise the AI budget to $12K for the rest of Q2.</strong> No quality impact, but variance bleeds into Q3 model and board narrative.",
        ),
        sectionTitle("My recommendation"),
        p(
        ...
        signature(
          "Finance",
          "VectorMail · Internal finance team",
          "finance@vectormail.app",
        ),
      ]),
      summary:
        "AI spend over budget. Action: decide on lever before month-end.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        fineprint(
          "Notion sends a daily digest of unresolved comments on pages where you're an owner or watcher. Manage frequency in Settings → Notifications.",
        ),
        companyEmailFooter("Notion"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Paused by",
            value: "Brightlane admin (we can't see exactly who)",
          },
          { label: "Paused at", value: "Today · 12:18 PM PT" },
          {
            label: "Messages while paused",
            value: "Queued · delivered when reactivated",
          },
          {
            label: "Our presence",
            value: "Aria + 3 others remain in the channel",
          },
        ]),
        sectionTitle("Common reasons admins pause channels"),
        bullet(
          "<strong>Slack Connect policy update</strong> - they're refreshing their company-wide policy and pausing all connect channels temporarily",
        ),
        bullet(
          "<strong>Security review</strong> - periodic audit of who has external access",
        ),
        bullet(
          "<strong>Internal escalation</strong> - they're cleaning up shared spaces while resolving an internal issue (could be neutral)",
        ),
        bullet(
          "<strong>Relationship signal</strong> - they're consciously pulling back · the rarest reason in our experience",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Message Sophia directly", {
            color: "#4a154b",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Channel will resume normal function the moment Brightlane reactivates it. Queued messages will deliver in order.",
        ),
        companyEmailFooter("Slack"),
      ]),
      summary:
        "Customer Slack channel paused. Action: check in with Sophia about why.",
      labels: [labelImportant],
      read: false,
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Permission offered",
            value:
              "Maintainer · can manage settings, push to all branches, manage collaborators",
          },
          ...
          { label: "Invitation expires", value: "May 24, 2026 (in 5 days)" },
          {
            ...
            value: "Marcus, Elena, Nathan (+ you when accepted)",
          },
        ]),
        ...
        fineprint(
          "This invitation expires in 5 days. If you accept, you'll have full Maintainer access immediately. Decline if you'd prefer not to be in the loop on research work.",
        ),
        companyEmailFooter("GitHub"),
      ]),
    ...
    },
    {
      ...
      body: email([
        headline(
          "Draft: 'How and why we replaced Pinecone with pgvector' · ready for review",
        ),
        p(
        ...
        bullet(
          "<strong>Intro · why we moved.</strong> 350 words. Not anti-Pinecone - we just outgrew the trade-offs they're optimized for.",
        ),
        bullet(
          "<strong>Decision framework.</strong> 500 words. The 6 questions we asked. Honest about where Pinecone would still be the right answer.",
        ),
        bullet(
          "<strong>Migration architecture.</strong> 600 words. Dual-write window, the canary cutover, the kill-switch we kept for 48 hours.",
        ),
        bullet(
          "<strong>Recall benchmarks at our scale.</strong> 400 words + 3 charts. HNSW vs IVFFlat vs Pinecone. Real numbers.",
        ),
        bullet(
          "<strong>Cost outcome.</strong> 200 words. The 70% reduction story.",
        ),
        bullet(
          "<strong>What we'd do differently.</strong> 150 words. Two specific mistakes.",
        ),
        sectionTitle("Why publish this"),
        bullet(
          "Recruiting · senior engineers respond well to 'they ship hard things' content",
        ),
        bullet(
          "Sales · enterprise customers are evaluating us on technical credibility",
        ),
        bullet(
          "Partnership conversations (e.g., the Linear one) come from technical credibility content",
        ),
        bullet(
          "Honest community-building · this conversation needed someone to do it well",
        ),
        sectionTitle("Timing"),
        p(
        ...
        sectionTitle("What I need from you"),
        bullet(
          "Read by <strong>Sunday EOD</strong> · don't edit yet, just react",
        ),
        bullet(
          "Sharp pushback on framing if you have it - easier to revise the argument now than later",
        ),
        bullet(
          "Note any specifics that would be too revealing (we name-check OpenRouter and Aurinko; thought about it, but think it's fine)",
        ),
        ctaRow([
    ...
    },
    {
      ...
      body: email([
        ...
        headline(
          "search.latency.p95 burned through 73% of error budget in 12 minutes",
        ),
        p(
          "An SLO monitor on the <strong>vectormail-api</strong> service crossed its threshold and burned through a large portion of this month's error budget. The breach has self-resolved, but the burn rate spiked to 14.2x normal - well above the 6x page threshold - so this is recorded as a P1 incident.",
        ),
        metricGrid([
          {
            label: "Service",
            value: "vectormail-api",
            sub: "us-west-2 · prod",
          },
        ...
        sectionTitle("Timeline (PT)"),
        logRow("17:48:21", "search.latency.p95 crossed 400ms threshold", {
          tone: "warn",
        }),
        logRow("17:48:52", "Auto-paged primary on-call (Marcus Liu)", {
          tone: "warn",
        }),
        logRow("17:51:08", "Marcus acknowledged the page", { tone: "info" }),
        logRow(
          "17:53:40",
          "Correlated with deploy build #2247 (5 min earlier)",
          { tone: "info" },
        ),
        logRow("17:57:15", "Rollback initiated for build #2247", {
          tone: "info",
        }),
        logRow("18:00:22", "Latency recovered to baseline (p95 = 312ms)", {
          tone: "ok",
        }),
        ...
        bullet(
          "Re-land with a concurrency limiter (Marcus already has a draft in #search-perf).",
        ),
        bullet(
          "Add an SLO alarm on embedding-pool saturation as a leading indicator.",
        ),
        ...
        ctaRow([
          ...
          ctaButton("Acknowledge in PagerDuty", {
            color: "#06ac38",
            variant: "outline",
          }),
        ]),
    ...
    },
    {
      ...
      body: email([
        p("Hi,"),
        p(
          "Locking in Tuesday 4 PM at Sightglass (4th & Folsom). See you then.",
        ),
        hr(),
        signature("Hana"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          ...
          {
            label: "Designation",
            value: "Unrestricted (most flexible - what we recommend)",
          },
          {
            label: "Tax-deductible",
            value:
              "Yes · 100% of donation (we don't take overhead from individual gifts)",
          },
        ...
        bullet(
          "<strong>91% direct cash transfer</strong> to families in Kenya, Uganda, or Liberia (recipient's choice)",
        ),
        bullet(
          "<strong>5% mobile money + delivery fees</strong> · we publish this transparently",
        ),
        bullet(
          "<strong>4% operational costs</strong> · staff, M&E, recipient services",
        ),
        ...
        ctaRow([
          ...
          ctaButton("View impact dashboard", {
            color: "#0a3d2a",
            variant: "outline",
          }),
        ]),
        fineprint(
          "GiveDirectly · 80 Broad St, Suite 403, New York, NY 10004 · 501(c)(3) public charity · EIN 27-1661997 · GuideStar Platinum certified · Top-rated by Charity Navigator and GiveWell",
        ),
    ...
    },
    {
      ...
      daysAgo: 4,
      snippet:
        "May books closing on schedule. One question about a $4,200 vendor charge.",
      body: email([
        p("Hi,"),
        p(
        ...
        bullet(
          "<strong>Cobalt Q2</strong> · $4,200 · default 'Professional Services' · proposed 'Security Ops' - needs your confirm",
        ),
        bullet(
          "<strong>20VC honorarium</strong> · $0 (no charge, but recorded as income for Q3) · should record as Marketing income vs Other",
        ),
        bullet(
          "<strong>Backstage Capital community fees</strong> · $0 (free) · no journal entry needed unless you want to track the value",
        ),
        ...
        bullet(
          "Saturday May 31 · Books locked · monthly reports auto-generated",
        ),
        bullet(
          "Monday June 2 · Financial package emailed to you, the board, and counsel",
        ),
        p(
          "If you have 30 seconds to confirm the Cobalt categorization, I can finalize without needing further input from you on this month.",
        ),
        hr(),
        signature(
          "Pilot Bookkeeping",
          "Pilot · Your accounting team",
          "books@pilot.com",
        ),
      ]),
      summary:
        "Pilot bookkeeping question. Action: confirm category for $4,200 charge.",
      labels: [labelUpdates],
      read: false,
    },
    {
      ...
      body: email([
        ...
        logRow("May 04", "Read 'AI Inbox for SaaS Ops' blog post · 3 min", {
          tone: "info",
        }),
        logRow("May 06", "Visited /pricing · scrolled to Enterprise tier", {
          tone: "info",
        }),
        logRow("May 09", "Returned to /pricing · spent 4 min · viewed FAQ", {
          tone: "info",
        }),
        logRow("May 12", "Watched 80% of homepage walkthrough video", {
          tone: "info",
        }),
        logRow("May 15", "Visited /security · downloaded SOC 2 report", {
          tone: "info",
        }),
        logRow(
          "May 16",
          "Filled out demo request form · 47 min on /pricing first",
          { tone: "ok" },
        ),
        ...
        bullet(
          "Tech stack: Notion, Slack, Stripe - overlaps with 80% of customers",
        ),
    ...
    },
    {
      ...
      body: email([
        ...
        bullet(
          "Context: scored Hot in HubSpot two days ago · pricing page visits, watched walkthrough, downloaded SOC 2",
        ),
        bullet(
          "Prep: lean on the customer story (Brightlane is the closest match)",
        ),
        ...
        bullet(
          "Context: cold inbound · interested in the design partnership of the API",
        ),
        bullet(
          "Prep: he's pre-PMF · likely value is qualitative (advice, intros) more than revenue",
        ),
        ...
        bullet(
          "Prep: she's lining up for expansion - Aria thinks 30-50 seats by Q3",
        ),
        ...
        bullet(
          "Context: just emailed last week about the round · we don't have room currently",
        ),
        bullet(
          "Prep: be direct - no room in Series A, hold for Series B conversation",
        ),
        ctaRow([
          ctaButton("View calendar week", { color: "#1F3A2E" }),
          ctaButton("Block off another office-hours slot next week", {
            color: "#1F3A2E",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Founder office hours · Wednesdays + select weeks · open via your Calendly link. Auto-confirms; you can decline/reschedule from your dashboard.",
        ),
        companyEmailFooter("VectorMail"),
      ]),
    ...
    },
    {
      ...
      body: email([
        ...
        keyValBlock([
          {
            label: "Marcus Liu",
            value: "12 issues · 12 points · 90% capacity",
          },
          {
            label: "Elena Vargas",
            value: "10 issues · 10 points · 82% capacity",
          },
          { label: "Nathan Wu", value: "11 issues · 11 points · 85% capacity" },
          {
            label: "Dana Howe (limited contribution)",
            value: "8 issues · 6 points · 50% capacity (planning focus)",
          },
          { label: "Carryover from C9", value: "6 issues · 3 points" },
        ]),
        sectionTitle("Top items by priority"),
        bullet(
          "<strong>VM-208</strong> · pgvector migration · cutover this cycle · Marcus",
        ),
        bullet("<strong>VM-211</strong> · Inbox v3 triage column · Elena"),
        bullet(
          "<strong>VM-214</strong> · Buddy v2.1 streaming tool-use · Nathan",
        ),
        bullet(
          "<strong>VM-219</strong> · SOC 2 evidence collection automation · Marcus + Aria",
        ),
        bullet("<strong>VM-228</strong> · Q3 OKR finalization · Dana"),
        sectionTitle("Risks"),
        bullet(
          "<strong>VM-208 (pgvector)</strong> is high-risk: 5-point estimate but real-world variance could double it. We have a kill-switch but cutover is still cycle-critical.",
        ),
        bullet(
          "<strong>VM-211 (Inbox v3)</strong> is blocked on design until Tuesday; if design slips, ship pushes to Cycle 11.",
        ),
        ctaRow([
          ctaButton("Open cycle in Linear", { color: "#5e6ad2" }),
          ctaButton("Start cycle", { color: "#5e6ad2", variant: "outline" }),
          ctaButton("View capacity heatmap", {
            color: "#5e6ad2",
            variant: "outline",
          }),
        ]),
        fineprint(
          "Team: vectormail-ai · Cycle 10: May 19 (Monday 9 AM PT) - May 30 (Friday 5 PM PT) · 11 working days",
        ),
        companyEmailFooter("Linear"),
      ]),
  ...
  for (const spec of threadSpecs) {
    const fromAddr = makeAddr(
      `demo-from-${spec.id}`,
      spec.senderName,
      spec.senderEmail,
    );
    const toAddr = makeAddr(
      `demo-to-${spec.id}`,
      "Demo User",
      "demo@vectormail.app",
    );
    ...
    if (spec.messageCount === 3) {
      ...
      emails.push({
        ...
        bodySnippet:
          "Sounds good - I'll hold the slot on my side. Looking forward to the follow-up.",
...
function buildDemoSentThreads(): DemoThread[] {
  ...
  const sentSpecs: Array<{
    ...
    {
      id: "demo-sent-1",
      subject: "Re: Quick intro - AI inbox automation",
      toName: "Alex Rivera",
      toEmail: "alex@founderloop.com",
      daysAgo: 1,
    ...
    {
      id: "demo-sent-2",
      subject: "Re: Product feedback - search UX",
      toName: "Jordan Kim",
      toEmail: "jordan@startup.io",
      daysAgo: 3,
    ...
    },
    {
      ...
      subject: "Re: Partnership discussion",
      toName: "Casey Park",
      toEmail: "casey@partnerco.com",
      daysAgo: 2,
      body: "Thanks Casey. I'll review the deck and send over some times for next week.\n\nBest,",
    },
    {
      id: "demo-sent-4",
      subject: "Re: Pricing question",
      toName: "Riley Adams",
      toEmail: "riley@startup.co",
      daysAgo: 4,
  ...
  const threads: DemoThread[] = sentSpecs.map((spec) => {
    ...
    const recipient = makeAddr(
      `demo-recipient-${spec.id}`,
      spec.toName,
      spec.toEmail,
    );
...
function buildDemoTrashThreads(): DemoThread[] {
  ...
  const trashSpecs: Array<{
    ...
    {
      id: "demo-trash-1",
      subject: "Your weekly digest (archived)",
      daysAgo: 14,
      snippet: "You have 0 new updates this week.",
    },
    {
      id: "demo-trash-2",
      subject: "Promotion - Expired offer",
      daysAgo: 10,
      snippet: "This offer has expired.",
    },
    {
      id: "demo-trash-3",
      subject: "Re: Old thread you deleted",
      daysAgo: 7,
      snippet: "Previous conversation removed.",
    },
  ];
...
export function getDemoThreads(opts: {
  ...
  const start = opts.cursor
    ? sorted.findIndex((t) => t.id === opts.cursor) + 1
    : 0;
...
function textMatchesTerm(
  ...
  for (const word of words) {
    if (
      ...
      word.length <= term.length + 1 &&
      editDistance(term, word.toLowerCase()) <= 1
    ) {
      return true;
    }
  }
...
export function getDemoEmailBody(
  emailId: string,
): { body: string | null; bodySnippet: string | null } | null {
  const all = getAllDemoThreads();
  for (const t of all) {
  ...
  const needsReply: DemoDailyBriefItem[] = [
    {
      ...
      reason:
        "Pilot ask is in the latest message; you committed to a Tuesday reply",
      confidence: "High",
    },
    {
      threadId: "demo-thread-19",
    ...
    },
    {
      ...
      reason:
        "Partnership lead has been waiting 4 days; their quarter locks Friday",
      confidence: "High",
    },
    {
    ...
    },
    {
      ...
      lastMessageDate: daysAgo(3),
      reason:
        "Customer asked for the roadmap; they upgrade or churn this month",
      confidence: "Medium",
    },
  ];
...
export function getDemoThreadBrain(threadId: string): {
  ...
  > = {
    "demo-thread-1": {
      ...
      expectedReason:
        "A real person is waiting on a reply with specific next steps.",
      expectedPriority: "High",
    },
    "demo-thread-4": {
      about:
        "Product feedback on search UX and interest in what’s on the roadmap.",
      expectedFromMe:
        "Acknowledge the feedback and clarify whether search improvements are planned.",
      expectedReason:
        "External sender asked roadmap questions awaiting your answer.",
      expectedPriority: "High",
    },
    "demo-thread-8": {
      ...
      expectedReason:
        "Newsletter-like content with no direct ask - nothing to reply to.",
  ...
  return [
    {
      id: importantId,
      name: "Important",
      color: DEMO_LABEL_COLORS.important,
      createdAt: now,
    ...
    },
    {
      id: promotionsId,
      name: "Promotions",
      color: DEMO_LABEL_COLORS.promotions,
      createdAt: now,
      threadCount: promotionsCount,
    },
    {
      id: updatesId,
      name: "Updates",
      color: DEMO_LABEL_COLORS.updates,
      createdAt: now,
      threadCount: updatesCount,
    },
  ];
}
